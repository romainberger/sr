(window.webpackJsonp=window.webpackJsonp||[]).push([[0],{225:function(e,t,r){"use strict";r.r(t);var n=r(0),a=r.n(n),o=r(8),s=r(4),c=r(51),l=r.n(c),i=r(72),u=r(38),p=r(3);const m=s.default.div`
    a {
        color: ${p.colors._white};
        text-decoration: none;
    }
`;class d extends n.Component{render(){const{project:e}=this.props;return n.createElement(m,null,n.createElement(u.Link,{to:`/project/${e.id}`},e.name))}}var h=r(36),j=r.n(h),P=r(7);function w(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}const f=r(138),E=r(59),v=r(12),{selectUser:g}=r(29),y=s.default.div`
    width: 100%;
    display: flex;
