(window.webpackJsonp=window.webpackJsonp||[]).push([[0],{236:function(e,t,r){"use strict";r.r(t);var n=r(0),a=r.n(n),o=r(7),s=r(2),c=r(36),l=r.n(c),i=r(47),u=r(25),p=r(1);const m=s.default.div`
    a {
        color: ${p.colors._white};
        text-decoration: none;
    }
`;class d extends n.Component{render(){const{project:e}=this.props;return n.createElement(m,null,n.createElement(u.Link,{to:`/project/${e.id}`},e.name))}}var h,j=r(35),P=r.n(j),f=r(6);function w(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}r.d(t,"default",function(){return N});const E=r(87),v=r(42),g=r(10),{selectUser:y}=r(28),x=s.default.div`
    width: 100%;
    display: flex;
