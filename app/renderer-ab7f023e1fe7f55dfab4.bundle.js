...
`,w=o.video`
    width: 50%;
`;class A extends s.Component{constructor(...e){super(...e),i(this,"clickUpdate",()=>{c.trackEvent("app","download-update"),p("Download update from app")})}componentDidMount(){c.trackScreen("modalUpdate")}render(){const{changelog:e,mandatory:t,url:n}=this.props,i=t?"Your app is too old!":"Update version available";return s.createElement(u,null,s.createElement(m,null,s.createElement(g,null,i),t?s.createElement(l,null,s.createElement(f,null,"Please download and install the latest version to keep using SongRiffer")):null,s.createElement(E,{href:n,onClick:this.clickUpdate},"Download the update"),s.createElement(v,null,"Or visit ",s.createElement(r,{onClick:()=>d(h.landingUrl)},h.landingUrl)," to download and install the latest version.")),Array.isArray(e.sections)&&e.sections.length?s.createElement(y,null,s.createElement(T,null,e.title?e.title:"What's new in this update:"),e.description?s.createElement(b,null,e.description):null,s.createElement("div",null,e.sections.map(e=>s.createElement(S,{key:e.title},s.createElement(_,null,s.createElement(x,null,e.title),s.createElement(C,{hasVideo:e.video},e.message)),e.video?s.createElement(w,{autoPlay:!0,playsInline:!0,muted:!0,loop:!0,src:e.video}):null)))):null)}}i(A,"propTypes",{changelog:a.object,mandatory:a.bool,url:a.string}),e.exports=A,e.exports.rootStyle="\n    max-height: 90vh;\n    padding: 0;\n    overflow-y: auto;\n"},function(e,t,n){var i;function s(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const a=n(0),o=n(2).default,{connect:r}=n(6),{removeNotification:l}=n(44),{colors:c}=n(1),p=o.div`
    position: fixed;
    padding: 10px 25px;
...
`,g=a.default.div`
    ...
    z-index: 2;
    font-size: 25px;
`;class f extends i.Component{constructor(...e){var t,n,i;super(...e),i={fakeFiles:[]},(n="state")in(t=this)?Object.defineProperty(t,n,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[n]=i}async getFakeFiles(){const e=(await l.a.getRemoteConfigValue("FILES_EMPTY_DATA",[])).map(e=>new o.a(e));this.setState({fakeFiles:e})}componentDidMount(){this.getFakeFiles()}render(){return i.createElement(u,null,i.createElement(m,null,i.createElement(p,{items:this.state.fakeFiles,keys:e=>e.path,from:{transform:"translate3d(0, 40px, 0)",opacity:0},to:{transform:"translate3d(0, 0, 0)",opacity:1}},(e,t)=>n=>{const s=Math.max(Math.min(1-t/this.state.fakeFiles.length,n.opacity),0);return i.createElement("div",{key:`fake-${e.path}`,style:{...n,opacity:s}},i.createElement(h,{file:e}))})),i.createElement(g,null,"Drag and drop files to start building your library"))}}var E,v,y,T=n(39),b=n(8);function S(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const _=n(0),{connect:x}=n(6),C=n(5),w=n(2).default,A=n(103),R=n(62),k=n(63),L=n(32),{selectUser:F}=n(21),{addFiles:D,disableNewImports:P,migrateLegacyData:I,setSortRule:M}=n(12),{searchTag:O}=n(31),{setAllowFileDragging:U}=n(25),N=n(61),$=n(7),H=n(10),{checkFiles:B}=n(9),{colors:j,sortRules:G}=n(1),V=w.div`
    margin-top: 50px;
    color: #555;
`,z=w.div`
    position: sticky;
...
`,X=w(Y)`
    justify-content: center;
`;let q=x((e,t)=>({_dataToMigrate:e.files._dataToMigrate,_winBackup:e.files._winBackup,files:Object(b.selectFiles)(e),filesCount:Object(b.selectFilesCount)(e),location:t.location,pending:e.files.pending,selectedFile:Object(b.selectSelectedFile)(e),sortRule:Object(b.selectSortRule)(e),user:F(e)}))((y=v=class extends _.PureComponent{constructor(...e){super(...e),S(this,"listRef",_.createRef()),S(this,"onTagClick",e=>{this.props.dispatch(O(e))}),S(this,"sortByName",()=>{this._sort(G.NAME_ASC,G.NAME_DESC)}),S(this,"sortByDuration",()=>{this._sort(G.DURATION_ASC,G.DURATION_DESC)}),S(this,"sortByBPM",()=>{this._sort(G.BPM_ASC,G.BPM_DESC)}),S(this,"sortByRating",()=>{this._sort(G.RATING_DESC,G.RATING_ASC)})}_sort(e,t){return this.props.sortRule!==e&&this.props.sortRule!==t?this.props.dispatch(M(e)):this.props.sortRule===e?this.props.dispatch(M(t)):void this.props.dispatch(M(null))}scrollToFile(e){if(this.listRef.current)try{const t=document.querySelector(e);t&&(this.listRef.current.scrollTop=t.offsetTop-75)}catch(e){}}listenFilesUpdate(){this.removeFileListener=H.listenForFilesUpdate(this.props.user.uid,e=>{this.props.dispatch(D(e)),B(e)})}renderStickyHeader(){const{files:e,filesCount:t,sortRule:n}=this.props;return _.createElement(z,null,t?_.createElement("div",null,"Showing ",e.length," of ",t," riffs"):_.createElement("div",null," "),_.createElement(W,null,_.createElement(Y,{onClick:this.sortByName},"Name",n===G.NAME_ASC?_.createElement(A,{rotate:!0}):null,n===G.NAME_DESC?_.createElement(A,null):null),_.createElement(X,{onClick:this.sortByDuration},"Duration",n===G.DURATION_ASC?_.createElement(A,{rotate:!0}):null,n===G.DURATION_DESC?_.createElement(A,null):null),_.createElement(Y,null,"Tags"),_.createElement(X,{onClick:this.sortByBPM},"BPM",n===G.BPM_ASC?_.createElement(A,{rotate:!0}):null,n===G.BPM_DESC?_.createElement(A,null):null),_.createElement(X,null,"Time Signature"),_.createElement(Y,{onClick:this.sortByRating},"Rating",n===G.RATING_ASC?_.createElement(A,{rotate:!0}):null,n===G.RATING_DESC?_.createElement(A,null):null),_.createElement(Y,null)))}componentDidMount(){$.trackScreen("home"),null!==this.props._dataToMigrate&&this.props.dispatch(I(this.props._dataToMigrate,this.props._winBackup)),this.listenFilesUpdate(),this.props.dispatch(U(!0)),this.props.location.hash&&this.scrollToFile(this.props.location.hash)}componentDidUpdate(e){e.files!==this.props.files&&N.end("search"),e.location.hash!==this.props.location.hash&&this.scrollToFile(this.props.location.hash)}componentWillUnmount(){this.props.dispatch(U(!1)),this.props.dispatch(P()),this.removeFileListener()}render(){const{files:e,filesCount:t,pending:n,selectedFile:i}=this.props,s=`\n            padding-bottom: ${i?"70px":0};\n        `;return _.createElement(L,{stickyHeader:this.renderStickyHeader(),wrapperStyle:s,scrollElementRef:this.listRef},n?_.createElement(T.a,null):_.createElement(_.Fragment,null,t?_.createElement(_.Fragment,null,e.length?e.map(e=>_.createElement(R,{file:e,key:e.hashPath,onTagClick:this.onTagClick,selected:i&&i.hashPath===e.hashPath})):_.createElement(K,null,"No files are matching your search"),_.createElement(V,null,"+ Drag and drop a file to add it to your library")):_.createElement(f,null)))}},S(v,"propTypes",{_dataToMigrate:C.object,dispatch:C.func,files:C.array,filesCount:C.number,selectedFile:C.any,sortRule:C.string}),E=y))||E;var J;function Z(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Q=n(0),{connect:ee}=n(6),te=n(2).default,ne=n(58),ie=n(47),{removeFile:se,replaceFile:ae}=n(12),{addNotification:oe}=n(44),{importFiles:re}=n(48),le=n(7),{checkFiles:ce}=n(9),pe=n(1),de=te.div`
    margin-top: 20px;
    padding: 50px;
    text-align: center;
...
`,he=te.div`
    margin-bottom: 20px;
    font-weight: 600;
`;let ue=ee((e,t)=>({file:Object(b.selectFileByHashPath)(e,{fileHashPath:t.fileHashPath}),files:Object(b._selectFiles)(e)}))(J=class extends Q.Component{constructor(...e){super(...e),Z(this,"dropRef",Q.createRef()),Z(this,"state",{dragging:!1,replace:!1}),Z(this,"checkFileAccess",()=>{ce(this.props.files)}),Z(this,"onClickReplace",()=>{this.setState({replace:!0})}),Z(this,"removeFile",()=>{this.props.close(),this.props.dispatch(se(this.props.file.hashPath))}),Z(this,"replaceFile",e=>{re(this.props.dispatch,e.slice(0,1),e=>{const t=e[Object.keys(e)[0]];t&&(this.props.close(),this.props.dispatch(ae(this.props.file.hashPath,t)))})})}componentDidMount(){le.trackScreen("modalFileMissing")}componentDidUpdate(e,t){!t.replace&&this.state.replace&&(this.removeDrag=ne(this.dropRef.current,{onDrop:this.replaceFile,onDragOver:()=>{this.setState({dragging:!0})},onDragLeave:()=>{this.setState({dragging:!1})}})),e.file.missing&&!this.props.file.missing&&(this.props.dispatch(oe("File successfully located")),this.props.close())}componentWillUmount(){this.removeDrag&&this.removeDrag()}render(){const{file:e}=this.props,{dragging:t,replace:n}=this.state;return Q.createElement("div",null,Q.createElement(he,null,"We could not locate the file ",e.name),n?Q.createElement(de,{ref:this.dropRef,dragging:t},"Drag and drop the file here to replace it"):Q.createElement("div",null,Q.createElement(ie,{onClick:this.checkFileAccess},"Check again"),Q.createElement(ie,{onClick:this.onClickReplace},"Replace it"),Q.createElement(ie,{onClick:this.removeFile,last:!0},"Remove it from my riff library")))}})||J;var me;function ge(){return(ge=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e}).apply(this,arguments)}function fe(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Ee=n(0),ve=n(2).default,{connect:ye}=n(6),Te=n(128),be=n(129),Se=n(130),_e=n(131),xe=n(132),Ce=n(134),we=n(135),Ae=n(136),{closeModal:Re}=n(18),ke=n(1),Le=ve.div`
    display: flex;
    position: fixed;
    top: 0;
    left: 0;
...
`,Fe=ve.div`
    ...
    background: ${ke.colors._greyDark};
    border-radius: 3px;
...
`;let Pe=ye(e=>({modal:e.modal}))(me=class extends Ee.Component{constructor(...e){super(...e),fe(this,"dimmerRef",Ee.createRef()),fe(this,"onDimmerClick",e=>{e.target===this.dimmerRef.current&&this.props.dispatch(Re())}),fe(this,"close",()=>{this.props.dispatch(Re())})}getModal(){const{name:e}=this.props.modal,t={[ke.modals.comment]:Te,[ke.modals.fileMissing]:ue,[ke.modals.fileOptions]:be,[ke.modals.invalidFile]:Se,[ke.modals.removeFile]:_e,[ke.modals.tabs]:xe,[ke.modals.tags]:Ce,[ke.modals.text]:we,[ke.modals.updateAvailable]:Ae};if(!t[e])return null;const n=t[e];return Ee.createElement(n,ge({},this.props.modal.props,{close:this.close}))}getRootStyle(){const{name:e}=this.props.modal;switch(e){case ke.modals.updateAvailable:return Ae.rootStyle;default:return""}}render(){const{modal:e}=this.props;if(!e.name)return null;const t=e.name===ke.modals.updateAvailable&&e.props.mandatory;return Ee.createElement(Le,{onClick:this.onDimmerClick,ref:this.dimmerRef,darker:t},Ee.createElement(Fe,{additionalStyle:this.getRootStyle()},this.getModal(),t?null:Ee.createElement(De,{onClick:this.close},"X")))}})||me;var Ie=n(26),Me=n(45),Oe=n.n(Me),Ue=n(77);const Ne=a.default.div`
    display: flex;
    align-items: center;
    height: 35px;
...
`,He=a.default.div`
    ...
    margin-left: 10px;
    padding: 7px;
`;class Be extends i.Component{render(){const{song:e}=this.props;return i.createElement(Ne,null,i.createElement($e,null,e.position),i.createElement(He,null,e.name))}}function je(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Ge=n(32),Ve=n(10),ze=a.default.div`
    display: flex;
    position: sticky;
    top: 0;
...
`,Ye=a.default.div`
    width: 50%;
    height: 100%;
`;class Xe extends i.Component{constructor(...e){super(...e),je(this,"removeListener",void 0),je(this,"state",{newSongName:"",project:null}),je(this,"onChangeNewSongName",e=>{this.setState({newSongName:e.target.value})}),je(this,"addNewSong",e=>{if(e.preventDefault(),!this.state.newSongName.length)return;const t=Oe()(this.state.project,"songs",[]).length;Ve.addSongToProject(this.state.project.id,{position:t,name:this.state.newSongName}),this.setState({newSongName:""})})}listenProjectUpdate(){console.log(this.props),this.removeListener=Ve.listenForProjectUpdate(this.props.match.params.projectId,e=>{this.setState({project:e})})}componentDidMount(){this.listenProjectUpdate()}componentWillUnmount(){"function"==typeof this.removeListener&&this.removeListener()}renderHeader(){const{project:e}=this.state;return i.createElement(ze,null,i.createElement("div",null,i.createElement(Ie.Link,{to:c.routes.projects},"List of projects")),i.createElement(We,null,e.name))}render(){const{project:e}=this.state;return e?(console.log(e),i.createElement(Ge,{stickyHeader:this.renderHeader()},i.createElement(Ke,null,i.createElement(Ye,null,i.createElement("div",null,"image here"),i.createElement("div",null,"Last updated: ",Object(Ue.a)(e.updatedAt,{addSuffix:!0}))),i.createElement(Ye,null,i.createElement(We,null,"Songs"),e.songs&&e.songs.length?i.createElement("div",null,e.songs.map(e=>i.createElement(Be,{song:e,key:`song-${e.position}`}))):i.createElement("div",null,"Add the first song to your project:"),i.createElement("form",{onSubmit:this.addNewSong},i.createElement("input",{type:"text",value:this.state.newSongName,onChange:this.onChangeNewSongName})))))):i.createElement(Ge,null,i.createElement(T.a,null))}}var qe,Je,Ze,Qe=n(13);function et(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const tt=n(23),nt=n(0),it=n(2).default,{connect:st}=n(6),at=n(5),ot=n(138),{Link:rt}=n(26),lt=n(29),ct=n(80),pt=n(30),dt=n(32),ht=n(66),ut=n(67),{addFiles:mt}=(n(28),n(12)),{reset:gt}=n(68),{pausePlayer:ft}=n(36),Et=n(7),{getFilesDurationAndBPM:vt}=n(48),{checkFileExists:yt,saveMedia:Tt}=n(9),bt=n(1),St=it.div`
    display: flex;
    position: absolute;
    width: 100%;
    height: 100%;
...
`,xt=it.div`
    ...
    width: 200px;
    height: 200px;
    background: ${e=>e.recording?bt.colors.redLight:bt.colors.red};
    border-radius: 100%;
    transition: background ease 0.2s;
    cursor: pointer;
    text-align: center;
...
`,Rt=it(pt)`
    ...
    text-align: center;
    border: 0;
    border-bottom: 1px solid ${e=>e.error?bt.colors.red:"rgba(255, 255, 255, 0.3)"};
    border-radius: 0;
`,kt=it.div`
    margin-bottom: 15px;
    color: ${bt.colors.red};
...
`,Pt=it.div`
    ...
    width: 100%;
    justify-content: center;
`;function It(e){for(var t,n=e.inputBuffer.getChannelData(0),i=n.length,s=0,a=0;a<i;a++)t=n[a],Math.abs(t)>=this.clipLevel&&(this.clipping=!0,this.lastClip=window.performance.now()),s+=t*t;var o=Math.sqrt(s/i);this.volume=Math.max(o,this.volume*this.averaging)}let Mt=st(e=>({recorder:e.recorder}))((Ze=Je=class extends nt.Component{constructor(...e){super(...e),et(this,"state",{audio:null,fileSize:0,name:"",playing:!1,recording:!1}),et(this,"recorder",null),et(this,"inputRef",nt.createRef()),et(this,"player",nt.createRef()),et(this,"recordButton",nt.createRef()),et(this,"toggleRecording",()=>{this.state.recording?this.stopRecording():this.startRecording()}),et(this,"startRecording",()=>{this.props.dispatch(ft(!0)),Et.trackEvent("recorder","start-recording"),this.setState({recording:!0}),this.getAudio()}),et(this,"pad",e=>1===`${e}`.length?`0${e}`:`${e}`),et(this,"stopRecording",()=>{Et.trackEvent("recorder","stop-recording");const{day:e,hours:t,minutes:n,month:i,seconds:s,year:a}=this.getDate();this.setState({name:`SongRiffer-idea-${a}-${i}-${e}-${t}${n}${s}`}),null!==this.recorder&&this.recorder.stop()}),et(this,"onDataAvailable",e=>{this.chunks.push(e.data)}),et(this,"onRecorderStop",()=>{const e=new Blob(this.chunks,{type:"audio/webm;codecs=opus"});this.setState({audio:URL.createObjectURL(e),recording:!1}),this.inputRef.current.focus(),cancelAnimationFrame(this.raf),this.recordButton.current.style.boxShadow=""}),et(this,"drawVolume",()=>{const e=Math.max(0,1e3*this.volumeMeter.volume);this.recordButton.current.style.boxShadow=`\n            10px 10px ${e+40}px 3px ${bt.colors.bluePastel},\n            -10px -10px ${e+40}px 3px ${bt.colors._purpleLight}\n        `,this.raf=requestAnimationFrame(this.drawVolume)}),et(this,"onNameChange",e=>{this.setState({name:e.target.value}),yt(`${e.target.value}.wav`)}),et(this,"onNameKeyDown",e=>{"Enter"===e.key&&this.save()}),et(this,"save",()=>{const e=new AudioContext,t=new Blob(this.chunks,{type:"audio/webm"}),n=new FileReader;this.state.name;n.onload=()=>{e.decodeAudioData(n.result,e=>{const t=ot(e);this.setState({fileSize:t.byteLength}),Tt(bt.saveTypes.RECORDER,`${this.state.name}.wav`,new Uint8Array(t))})},n.readAsArrayBuffer(t)}),et(this,"importFile",()=>{Et.trackEvent("recorder","save",this.state.name),Et.trackEvent("file","file-import","recorder",1);const e=`${this.state.name}.wav`,t=this.props.recorder.filePath,n={name:e,path:t,size:this.state.fileSize,source:bt.SOURCES.RECORD,type:"audio/wav"},i=new o.a(n);this.props.dispatch(mt({[Object(Qe.getFilePathHash)(t)]:i.toJSON()},!0)),vt(this.props.dispatch,[i])}),et(this,"reset",()=>{this.chunks=[],this.setState({audio:null,playing:!1}),this.pausePlayer(),Et.trackEvent("recorder","discard")}),et(this,"togglePlay",()=>{this.setState({playing:!this.state.playing},()=>{this.state.playing?this.playPlayer():this.pausePlayer()})})}getDate(){const e=new Date;return{day:this.pad(e.getDate()),hours:e.getHours(),minutes:e.getMinutes(),month:this.pad(e.getMonth()+1),seconds:e.getSeconds(),year:e.getFullYear()}}getAudio(){navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(e=>{this.watchVolume(e),this.recordAudio(e)})}watchVolume(e){if(null===e)return;this.stream=e;const t=new AudioContext,n=t.createMediaStreamSource(this.stream);var i,s,a,o,r;this.volumeMeter=((r=(i=t).createScriptProcessor(512)).onaudioprocess=It,r.clipping=!1,r.lastClip=0,r.volume=0,r.clipLevel=s||.98,r.averaging=a||.95,r.clipLag=o||750,r.connect(i.destination),r.checkClipping=function(){return!!this.clipping&&(this.lastClip+this.clipLag<window.performance.now()&&(this.clipping=!1),this.clipping)},r.shutdown=function(){this.disconnect(),this.onaudioprocess=null},r),n.connect(this.volumeMeter),this.drawVolume()}recordAudio(e){this.recorder=new MediaRecorder(e),this.chunks=[],this.recorder.ondataavailable=this.onDataAvailable,this.recorder.onstop=this.onRecorderStop,this.recorder.start()}playPlayer(){this.player.current.play()}pausePlayer(){this.player.current.pause()}componentDidMount(){Et.trackScreen("record")}componentDidUpdate(e){!e.recorder.saveSuccess&&this.props.recorder.saveSuccess&&this.importFile()}componentWillUnmount(){cancelAnimationFrame(this.raf),this.props.dispatch(gt())}render(){const{recorder:e}=this.props,{audio:t,name:n,playing:i,recording:s}=this.state,a=!!e.fileAlreadyExists&&tt.basename(e.fileAlreadyExists,tt.extname(e.fileAlreadyExists))===n;return nt.createElement(dt,{wrapperStyle:"\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    align-items: center;\n    height: 100%;\n    padding: 50px;\n    overflow: hidden;\n"},nt.createElement(St,{recording:s||!t},nt.createElement(_t,null,nt.createElement(xt,{onClick:this.toggleRecording,recording:s,ref:this.recordButton},s?"STOP":"START"))),nt.createElement(Ct,{recording:s||!t},e.saveSuccess?nt.createElement(Ft,null,nt.createElement(ct,{width:"50"}),nt.createElement(Dt,null,n," was successfully added to your library!"),nt.createElement(Pt,null,nt.createElement(rt,{to:bt.routes.home},nt.createElement(Lt,null,"Go back to your file list")))):nt.createElement(nt.Fragment,null,nt.createElement("div",null,nt.createElement("audio",{src:t,ref:this.player}),nt.createElement("div",{onClick:this.togglePlay},i?nt.createElement(ht,null):nt.createElement(ut,null))),nt.createElement(wt,null,nt.createElement(Rt,{onChange:this.onNameChange,onKeyDown:this.onNameKeyDown,ref:this.inputRef,type:"text",value:n,error:a}),nt.createElement(kt,null,a?"This file already exists, please choose another name":nt.createElement("span",null," ")),nt.createElement(At,null,nt.createElement(Lt,{onClick:this.reset,background:bt.colors._grey},"Discard"),nt.createElement(Lt,{onClick:this.save,disabled:a},"Save"))))))}},et(Je,"propTypes",{dispatch:at.func,recorder:at.object}),qe=Ze))||qe;const Ot={margin:"auto",background:"none",display:"block"},Ut=({size:e=100})=>s.a.createElement("svg",{style:Ot,width:`${e}px`,height:`${e}px`,viewBox:"0 0 100 100",preserveAspectRatio:"xMidYMid"},s.a.createElement("circle",{cx:"50",cy:"50",fill:"none",stroke:c.colors.blueLight,strokeWidth:"3",r:"29",strokeDasharray:"136.659280431156 47.553093477052",transform:"rotate(194.885 50 50)"},s.a.createElement("animateTransform",{attributeName:"transform",type:"rotate",repeatCount:"indefinite",dur:"1.1235955056179776s",values:"0 50 50;360 50 50",keyTimes:"0;1"}))),Nt=a.default.div`
    height: 10px;
    border-radius: 10px;
...
`,$t=a.default.div`
    width: ${e=>e.width}%;
    height: 10px;
`,Ht=({percentage:e})=>s.a.createElement(Nt,null,s.a.createElement($t,{width:e,style:{background:e>=90?c.colors.redLight:c.colors.bluePastel}}));var Bt,jt,Gt;function Vt(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const zt=n(0),{connect:Wt}=n(6),Kt=n(2).default,Yt=n(5),Xt=n(47),qt=n(32),Jt=n(28),{checkUpdate:Zt}=n(25),{openModal:Qt}=n(18),{signOut:en}=n(69),{selectUser:tn}=n(21),nn=n(7),sn=n(10),{hasUpload:an}=n(46),{formatFileSize:on}=n(33),{openLink:rn,toggleDevTools:ln}=n(9),cn=n(1),pn=Kt.div`
    width: 50%;
    padding: 0 40px;
`,dn=Kt.div`
    margin-bottom: 25px;
...
`,hn=Kt(Xt)`
    text-align: center;
`,un=Kt.span`
    color: ${cn.colors.redLight};
`,mn=Kt(Xt.ModalLink)`
    text-align: center;
`,gn=Kt.div`
    margin-top: 30px;
`;var fn,En,vn,yn=Wt(e=>({enableExperimental:e.application.enableExperimental,updateAvailable:e.application.updateAvailable,user:tn(e)}))((Gt=jt=class extends zt.Component{constructor(...e){super(...e),Vt(this,"state",{storageSize:0,storageSizeLimit:0,storageSizeLoaded:!1}),Vt(this,"signOut",()=>{this.props.dispatch(en())}),Vt(this,"checkUpdates",()=>{this.props.dispatch(Zt(!0))})}renderDevMenu(){return zt.createElement(gn,null,zt.createElement(dn,null,"Experimental Menu"),zt.createElement(hn,{onClick:ln,first:!0},"Toggle dev tools"))}getCloudStorageLimit(){return new Promise(async e=>{const{user:t}=this.props;if(void 0!==t.data.cloudStorageLimit)return e(t.data.cloudStorageLimit);e(await sn.getRemoteConfigValue(`STORAGE_LIMIT_LEVEL_${t.data.cloudLevel}`,0))})}getUserStorageSize(){return new Promise(async e=>{const{user:t}=this.props;if(void 0!==t.data.storageSize)return e(t.data.storageSize);e(await sn.getUserStorageSize(t.uid))})}async fetchStorageSize(){const{user:e}=this.props;if(an(e)){const e=await this.getUserStorageSize(),t=await this.getCloudStorageLimit();this.setState({storageSizeLoaded:!0,storageSize:e,storageSizeLimit:t})}}renderAccount(){if(an(this.props.user)){const{storageSize:e,storageSizeLimit:t,storageSizeLoaded:n}=this.state;if(!n)return zt.createElement(Jt,null,zt.createElement(Ut,{size:40}));const i=100*e/t,s=isNaN(i)?0:i.toFixed(2);return zt.createElement(Jt,null,zt.createElement(Jt,{size:"xs"},"Total storage size used:"),zt.createElement(Jt,{size:"xs"},on(e)," / ",on(t)," (",s,"%)"),zt.createElement(Jt,{size:"s"},zt.createElement(Ht,{percentage:s})),this.renderStorageFullMessage(s))}return null}renderStorageFullMessage(e){if(e<90)return null;const t=e>=100?"Your storage space is full!":"Your storage space is almost full!";return zt.createElement(Jt,null,t," Visit ",zt.createElement("a",{href:"https://songriffer.com"},"to increase your plan and be able to add more files"))}componentDidMount(){nn.trackScreen("settings"),this.fetchStorageSize()}render(){const{enableExperimental:e,updateAvailable:t,user:n}=this.props;return zt.createElement(qt,{wrapperStyle:"\n    display: flex;\n    height: 100%;\n    justify-content: space-between;\n    align-items: center;\n"},zt.createElement(pn,null,zt.createElement(hn,{onClick:this.checkUpdates,first:!0},"Check for updates ",t?zt.createElement(un,null,"•"):null),zt.createElement(mn,{href:`mailto:${cn.email}`},"Contact Us"),zt.createElement(hn,{onClick:()=>rn(cn.facebookUrl)},"Follow us on Facebook"),zt.createElement(hn,{onClick:()=>rn(cn.instagramUrl)},"Follow us on Instagram"),zt.createElement(hn,{onClick:()=>rn(cn.landingUrl)},"Visit us songriffer.com"),e&&this.renderDevMenu()),zt.createElement(pn,null,zt.createElement(dn,null,"Hello ",n.email,"!"),this.renderAccount(),zt.createElement(hn,{onClick:this.signOut,first:!0},"Sign out")))}},Vt(jt,"propTypes",{dispatch:Yt.func,enableExperimental:Yt.bool,updateAvailable:Yt.bool,user:Yt.object}),Bt=Gt))||Bt;function Tn(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const bn=n(0),{connect:Sn}=n(6),_n=n(5),xn=n(58),Cn=n(2).default,{MemoryRouter:wn,Route:An,Switch:Rn}=n(26),kn=n(95),Ln=n(101),Fn=n(102),Dn=n(126),Pn=n(127),In=n(137),Mn=n(139),On=n(141),Un=n(143),Nn=n(148),$n=n(150),{addFiles:Hn,setMissingFiles:Bn}=n(12),{toggleAdvanced:jn}=n(31),{closeModalEsc:Gn}=n(18),{notLogged:Vn,setFullUserData:zn,signIn:Wn}=n(69),{checkUpdate:Kn,closeContextMenu:Yn,resize:Xn}=n(25),{togglePlay:qn}=n(36),{recorderFileAlreadyExists:Jn,recorderSaveSuccess:Zn}=n(68),{transferSaveSuccess:Qn}=n(83),{setMXML:ei}=n(151),{getFilesDurationAndBPM:ti,importFiles:ni}=n(48),ii=n(10),si=n(7),ai=n(22),oi=n(24),{isAuthenticated:ri,isUserFullyLoaded:li,selectUser:ci}=n(21),{checkFilesDBExists:pi,getAppConfig:di,onMissingFiles:hi,setCallback:ui}=n(9),mi=n(1),gi=(Cn.div`
    height: 100%;
    min-height: 100%;
    display: flex;
    flex-direction: column;
...
`,vi=Cn.div`
    ...
    height: 100%;
    pointer-events: none;
    color: ${mi.colors.blueLight};
    border: 20px dashed ${mi.colors.blueLight};
    font-size: 200px;
    justify-content: center;
    align-items: center;
    z-index: 100;
...
`,Ti=Cn.div`
    ...
    display: flex;
    align-items: center;
`,bi=bn.lazy(()=>n.e(2).then(n.bind(null,232))),Si=()=>bn.createElement(bn.Suspense,{fallback:null},bn.createElement(bi,null)),_i=bn.lazy(()=>n.e(1).then(n.t.bind(null,233,7))),xi=()=>bn.createElement(bn.Suspense,{fallback:null},bn.createElement(_i,null)),Ci=bn.lazy(()=>n.e(0).then(n.bind(null,234))),wi=()=>bn.createElement(bn.Suspense,{fallback:null},bn.createElement(Ci,null));let Ai=Sn(e=>({advancedSearchVisible:oi(e).displayAdvanced,allowFileDragging:e.application.allowFileDragging,appReady:li(e),appWidth:e.application.appWidth,authLoading:e.auth.authLoading,contextMenu:e.application.contextMenu,enableExperimental:e.application.enableExperimental,isAuthenticated:ri(e),modalOpen:!!e.modal.name,user:ci(e)}))((vn=En=class extends bn.Component{constructor(...e){super(...e),Tn(this,"state",{dragging:!1,hasError:!1,splashAnimationDone:!1}),Tn(this,"onSplashAnimationDone",()=>{this.setState({splashAnimationDone:!0})}),Tn(this,"importFiles",e=>{this.props.isAuthenticated&&ni(this.props.dispatch,e,e=>{for(let t in e)e[t].newImport=!0;this.props.dispatch(Hn(e,!0))})}),Tn(this,"getDataFromMain",(e,t)=>{switch(e){case mi.mainConsts.events.CHECK_FILES_DB:t.exists&&this.props.dispatch({type:mi.actionTypes.SET_MIGRATION_DATA,data:t.data,_winBackup:t._winBackup});break;case mi.mainConsts.events.DATA_FETCHED:if(t.db===mi.db.files){this.props.dispatch(Hn(t.data));const e=Object.values(t.data).reduce((e,t)=>(t.bpm&&t.duration||e.push(t),e),[]);return void(e.length&&ti(this.props.dispatch,e))}t.db===mi.db.app&&t.data.displayAdvanced&&this.props.dispatch(jn());break;case mi.mainConsts.events.FILE_ALREADY_EXISTS:this.props.dispatch(Jn(t));break;case mi.mainConsts.events.FILE_SYSTEM_ERROR:console.log(t);break;case mi.mainConsts.events.FILE_SAVE_SUCCESS:t.saveType===mi.saveTypes.RECORDER?this.props.dispatch(Zn(t.filePath)):t.saveType===mi.saveTypes.TRANSFER&&this.props.dispatch(Qn(t.fileName,t.filePath));break;case mi.mainConsts.events.GET_MXLM_SUCCESS:this.props.dispatch(ei(t.filePath,t.mxml));break;case mi.mainConsts.events.OPEN_DEEPLINK:this.handleDeeplink(t.url)}}),Tn(this,"handleDeeplink",e=>{try{const t=e.replace("songriffer://songriffer.com?deeplink=",""),n=JSON.parse(decodeURIComponent(t));switch(n.type){case mi.deeplinkTypes.LOGIN_FACEBOOK:ii.signInWithFacebookToken(n.params.token);break;case mi.deeplinkTypes.LOGIN_GOOGLE:ii.signInWithGoogleToken(n.params.token);break;default:ai(`Unsupported deeplink type ${n.type} - raw deeplink: ${t}`)}}catch(t){const n=`Could not parse deeplink args: ${e}`;console.error(n),si.exception(n),ai(`*Error* ${n}`)}}),Tn(this,"onMissingFiles",e=>{this.props.dispatch(Bn(e.files))}),Tn(this,"onKeyDown",e=>{if("Escape"===e.key&&this.props.dispatch(Gn()),32===e.keyCode&&e.target===document.body&&(this.props.dispatch(qn()),e.preventDefault()),!this.props.modalOpen&&e.target&&"INPUT"!==e.target.tagName&&/^[a-zA-Z]{1}$/.test(e.key)){let e=null;e=this.props.advancedSearchVisible?"#advanced-search-input":"#basic-search-input";const t=document.querySelector(e);t&&t.focus()}}),Tn(this,"onResize",()=>{window.innerWidth!==this.props.appWidth&&this.props.dispatch(Xn(window.innerWidth))}),Tn(this,"setFullUser",e=>{this.props.dispatch(zn(e))}),Tn(this,"onAuthChange",e=>{e?(this.props.dispatch(Wn(e)),ii.getFullUser(e.uid).then(this.setFullUser)):this.props.dispatch(Vn())}),Tn(this,"closeContextMenu",()=>{this.props.dispatch(Yn())}),Tn(this,"catchError",e=>{this.setState({hasError:!0});try{const t=`${e.message} \n \`\`\`${e.error.stack}\`\`\``;si.exception(e.message),ai(`*Error* ${t}`)}catch(e){ai("*Error* unavailable message"),si.exception("Error - unavailable message")}})}detectDragDrop(){this.dragDropActivated=!0,this.removeDragDrop=xn(document.body,{onDrop:this.importFiles,onDragOver:()=>{this.setState({dragging:!0})},onDragLeave:()=>{this.setState({dragging:!1})}})}listenForFullUserUpdate(){ii.listenForFullUserUpdate(this.props.user.uid,this.setFullUser).then(e=>{this.fullUserListener=e})}removeFullUserListener(){"function"==typeof this.fullUserListener&&this.fullUserListener()}checkUpdate(){clearTimeout(this.updateTimeout),this.props.dispatch(Kn(!1)),this.updateTimeout=setTimeout(()=>{this.checkUpdate()},mi.updateInterval)}componentDidCatch(){this.setState({hasError:!0})}componentDidMount(){pi(),window.addEventListener("error",this.catchError,{passive:!0}),this.detectDragDrop(),hi(this.onMissingFiles),ui(this.getDataFromMain),ii.onAuthChange(this.onAuthChange),si.trackEvent("app","app-start",window.__songRiffer.platform),si.trackEvent("app",`platform-${window.__songRiffer.platform}`,window.__songRiffer.release),si.trackEvent("app","appVersion","1.3.0"),document.addEventListener("keydown",this.onKeyDown),window.addEventListener("resize",this.onResize,{passive:!0}),this.onResize(),this.updateTimeout=setTimeout(()=>{this.checkUpdate()},3e3)}componentDidUpdate(e){!this.props.modalOpen&&this.props.allowFileDragging||!this.dragDropActivated||(this.removeDragDrop(),this.dragDropActivated=!1),this.props.modalOpen||!this.props.allowFileDragging||this.dragDropActivated||this.detectDragDrop(),!e.appReady&&this.props.appReady&&di(),!e.isAuthenticated&&this.props.isAuthenticated?this.listenForFullUserUpdate():e.isAuthenticated&&!this.props.isAuthenticated&&this.removeFullUserListener()}componentWillUnmount(){clearTimeout(this.updateTimeout),this.removeFullUserListener()}render(){const{appReady:e,authLoading:t,contextMenu:n,enableExperimental:i,isAuthenticated:s}=this.props,{dragging:a,hasError:o,splashAnimationDone:r}=this.state;return e&&r?o?bn.createElement(Fn,null):bn.createElement(wn,null,bn.createElement(yi,null,bn.createElement(Ln,null),bn.createElement(Dn,null),bn.createElement(gi,null,bn.createElement(Ti,null,bn.createElement(Pn,{style:"margin-left: 3px;"})),bn.createElement(Rn,null,bn.createElement(An,{exact:!0,path:mi.routes.home,component:On}))),bn.createElement(fi,null,bn.createElement(Un,null),bn.createElement(vi,{dragging:a},"+"),bn.createElement(Ei,{dragging:a},bn.createElement(Rn,null,bn.createElement(An,{path:mi.routes.project,component:Xe}),bn.createElement(An,{path:mi.routes.projects,component:wi}),bn.createElement(An,{path:mi.routes.recorder,component:Mt}),bn.createElement(An,{path:mi.routes.settings,component:yn}),bn.createElement(An,{path:mi.routes.stats,component:xi}),bn.createElement(An,{path:mi.routes.transfer,component:Si}),bn.createElement(An,{exact:!0,path:mi.routes.home,component:q}))),bn.createElement(kn,null),bn.createElement(Pe,null),bn.createElement(In,null),bn.createElement(Mn,null)),n.active?bn.createElement($n,{close:this.closeContextMenu,positionX:n.positionX,positionY:n.positionY,props:n.props}):null)):bn.createElement(Nn,{authLoading:t,isAuthenticated:s,onAnimationDone:this.onSplashAnimationDone})}},Tn(En,"propTypes",{advancedSearchVisible:_n.bool,allowFileDragging:_n.bool,appReady:_n.bool,appStartTime:_n.number,appWidth:_n.number,authLoading:_n.bool,contextMenu:_n.object,dispatch:_n.func,isAuthenticated:_n.bool,modalOpen:_n.bool}),fn=vn))||fn;const Ri={allowFileDragging:!1,appWidth:0,contextMenu:{},dbLoaded:!1,enableExperimental:!1,updateAvailable:!1},ki={authLoading:!0,data:{cloudLevel:0},user:null},Li=e=>({email:e.email,emailVerified:e.emailVerified,uid:e.uid}),{getFilePathHash:Fi}=n(13),Di={_dataToMigrate:null,_winBackup:!1,files:{},pending:!0,sortRule:null,selectedFile:null},Pi=(e,t)=>{const n={...e};for(let e in t)n[e]?n[e]={...n[e],added:t[e].added,size:t[e].size}:n[e]=t[e];return n},Ii=(e,t)=>{if(!t.length)return e;const n={...e};return Object.keys(n).forEach(e=>{t.includes(e)?n[e]={...n[e],missing:!0}:n[e].missing&&(n[e]={...n[e],missing:!1})}),n},Mi=(e,t,n)=>{const i={...e};return delete i[t],i[Fi(n.path)]=n,i},Oi=(e,t,n)=>{if(!e[t])return e;const i=e[t];return Object.keys(i.tags).map(e=>e.toLowerCase()).includes(n.toLowerCase())?e:{...e,[t]:{...i,tags:{...e[t].tags,[n]:!0}}}},Ui={name:null,props:null},Ni={filePath:null,mxml:null},$i={fileAlreadyExists:"",filePath:null,saveSuccess:!1},Hi={advancedTransitionDone:!0,archived:c.searchArchived.NON_ARCHIVED,basicTerm:"",bpm:"",bpmDelta:10,displayAdvanced:!1,tags:{},term:""},{combineReducers:Bi}=n(38),ji=Bi({application:(e=Ri,t)=>{switch(t.type){case c.actionTypes.ADD_FILES:return{...e,dbLoaded:!0};case c.actionTypes.UPDATE_AVAILABLE:return{...e,updateAvailable:!0};case c.actionTypes.APP_RESIZE:return{...e,appWidth:t.width};case c.actionTypes.DISPLAY_TAG_CONTEXT_MENU:return{...e,contextMenu:{active:!0,positionX:t.positionX,positionY:t.positionY,props:t.props}};case c.actionTypes.CLOSE_CONTEXT_MENU:return{...e,contextMenu:Ri.contextMenu};case c.actionTypes.SEARCH_BASIC:return t.term.toLowerCase()===c.DEBUG_KEY_SEQUENCE?{...e,enableExperimental:!0}:e;case c.actionTypes.SET_ALLOW_FILE_DRAGGING:return{...e,allowFileDragging:t.allowFileDragging};default:return e}},auth:(e=ki,t)=>{switch(t.type){case c.actionTypes.AUTH_SET_USER:return{...e,authLoading:!1,user:Li(t.user)};case c.actionTypes.AUTH_SIGN_OUT:return ki;case c.actionTypes.AUTH_SET_FULL_USER_DATA:return{...e,...t.data};case c.actionTypes.AUTH_NOT_LOGGED:return{...e,authLoading:!1};default:return e}},files:(e=Di,t)=>{switch(t.type){case c.actionTypes.SET_MIGRATION_DATA:return{...e,_dataToMigrate:t.data,_winBackup:t._winBackup};case c.actionTypes.ADD_TAG:return{...e,files:Oi(e.files,t.hashPath,t.tag)};case c.actionTypes.REMOVE_TAG:const n=e.files[t.hashPath],i={...n.tags};return delete i[t.tag],{...e,files:{...e.files,[t.hashPath]:{...n,tags:i}}};case c.actionTypes.EDIT_FILE:let s;return s=!t.automaticEdit&&t.edit.bpm||t.automaticEdit&&t.edit.bpm&&!e.files[t.hashPath].bpm?t.edit.bpm:e.files[t.hashPath].bpm,{...e,files:{...e.files,[t.hashPath]:{...e.files[t.hashPath],...t.edit,bpm:s}}};case c.actionTypes.ADD_FILES:return{...e,_dataToMigrate:null,files:Pi(e.files,t.files),pending:!1};case c.actionTypes.REMOVE_FILE:const a={...e.files};return delete a[t.hashPath],{...e,files:a,selectedFile:e.selectedFile===t.hashPath?null:e.selectedFile};case c.actionTypes.SET_FILE_ARCHIVE:return t.hashPath===e.selectedFile?{...e,selectedFile:null}:e;case c.actionTypes.PLAY_FILE:return{...e,selectedFile:t.hashPath};case c.actionTypes.REPLACE_FILE:return{...e,files:Mi(e.files,t.oldFileHashPath,t.newFile)};case c.actionTypes.SET_MISSING_FILES:return{...e,files:Ii(e.files,t.filesHashPath)};case c.actionTypes.SET_SORT_RULE:return{...e,sortRule:t.sortRule};case c.actionTypes.PAUSE_PLAYER:return t.unsetSelectedFile?{...e,selectedFile:null}:e;case c.actionTypes.DISABLE_NEW_IMPORTS:const o={...e.files};for(const e of t.files)o[e]={...o[e],newImport:!1};return{...e,files:o};case c.actionTypes.SET_FILE_UPLOAD_STATUS:return{...e,files:{...e.files,[t.hashPath]:{...e.files[t.hashPath],uploaded:t.uploaded}}};case c.actionTypes.AUTH_SIGN_OUT:return Di;default:return e}},modal:(e=Ui,t)=>{switch(t.type){case c.actionTypes.OPEN_MODAL:return{name:t.name,props:t.props};case c.actionTypes.CLOSE_MODAL:return Ui;default:return e}},mxml:(e=Ni,t)=>{switch(t.type){case c.actionTypes.SET_MXML:return{...e,filePath:t.filePath,mxml:t.mxml};default:return e}},notifications:n(153),player:n(154),recorder:(e=$i,t)=>{switch(t.type){case c.actionTypes.RECORDER_FILE_ALREADY_EXISTS:return{...e,fileAlreadyExists:t.fileName};case c.actionTypes.RECORDER_SAVE_SUCCESS:return{...e,filePath:t.filePath,saveSuccess:!0};case c.actionTypes.RECORDER_RESET:return $i;default:return e}},search:(e=Hi,t)=>{switch(t.type){case c.actionTypes.SEARCH_BASIC:return{...e,basicTerm:t.term};case c.actionTypes.SET_SEARCH:return{...e,term:t.term,basicTerm:""};case c.actionTypes.TOGGLE_ADVANCED_SEARCH:return{...Hi,displayAdvanced:!e.displayAdvanced,advancedTransitionDone:!1};case c.actionTypes.ADVANCED_TRANSITION_DONE:return{...e,advancedTransitionDone:!0};case c.actionTypes.SEARCH_TAG:return{...e,advancedTransitionDone:!1,displayAdvanced:!0,basicTerm:"",tags:{...e.tags,[t.tag]:!0}};case c.actionTypes.REMOVE_SEARCH_TAG:const n={...e.tags};return delete n[t.tag],{...e,basicTerm:"",tags:n};case c.actionTypes.SEARCH_BPM:return{...e,basicTerm:"",bpm:isNaN(parseInt(t.bpm,10))?"":parseInt(t.bpm,10)};case c.actionTypes.SEARCH_BPM_DELTA:return{...e,bpmDelta:isNaN(parseInt(t.bpmDelta,10))?10:parseInt(t.bpmDelta,10)};case c.actionTypes.CLEAR_SEARCH:return{...Hi,displayAdvanced:e.displayAdvanced};case c.actionTypes.SET_SEARCH_ARCHIVED:return{...e,archived:t.archived};default:return e}},transfer:n(155)}),{createStore:Gi,applyMiddleware:Vi}=n(38),zi=Gi(ji,Vi(n(152).default,n(156),n(157))),Wi=n(0),{Provider:Ki}=n(6),{render:Yi}=n(34);Yi(Wi.createElement(Ki,{store:zi},Wi.createElement(Ai,null)),document.querySelector("#root"))}],[[159,3,5]]]);