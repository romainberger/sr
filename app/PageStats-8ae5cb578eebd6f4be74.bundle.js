(window.webpackJsonp=window.webpackJsonp||[]).push([[1],{223:function(e,t,n){const l=n(73),{_selectFiles:r,selectTags:a}=n(13);e.exports=l([r,a],(e,t)=>{const n=Object.values(e).filter(e=>!e.archived),l=n.reduce((e,t)=>(e.totalDuration+=t.duration,Object.keys(t.tags).forEach(n=>{const l=n.toLowerCase();e.tags[l]?(e.tags[l].rating+=t.rating+1,e.tags[l].occurence+=1,e.tags[l].average=e.tags[l].rating/e.tags[l].occurence):e.tags[l]={rating:t.rating+1,occurence:1,average:t.rating+1,tag:l}}),e),{totalDuration:0,tags:{}}),r=Object.values(l.tags).sort((e,t)=>t.occurence-e.occurence),a=Object.values(l.tags).sort((e,t)=>t.average-e.average);return{tagsSortedByAverageRating:a,tagsSortedByOccurence:r,topTagAverage:a.length?a[0]:0,topTagOccurence:r.length?r[0]:0,totalDuration:l.totalDuration,totalFiles:n.length,totalTags:t.length}},"selectStats")},225:function(e,t,n){"use strict";n.r(t);var l,r,a,o=n(46);n(8);function c(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const i=n(0),s=n(4).default,{connect:u}=n(7),g=n(10),{config:d,Spring:m}=n(20),p=n(59),E=n(38),b=n(223),{selectUser:f}=n(30),{formatDuration:h}=n(74),v=n(12),x=n(3),w=s(s.div`
    margin-bottom: 15px;
`)`
    display: flex;
