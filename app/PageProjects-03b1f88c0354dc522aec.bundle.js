(window.webpackJsonp=window.webpackJsonp||[]).push([[0],{234:function(e,t,r){"use strict";r.r(t);var n=r(2),a=r.n(n),o=r(9),s=r(4),c=r(46),l=r.n(c),i=r(61),u=r(33),p=r(3);const m=s.default.div`
    a {
        color: ${p.colors._white};
        text-decoration: none;
    }
`;class d extends n.Component{render(){const{project:e}=this.props;return n.createElement(m,null,n.createElement(u.Link,{to:`/project/${e.id}`},e.name))}}var h,j=r(30),P=r.n(j),f=r(7);function w(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}r.d(t,"default",function(){return N});const E=r(96),v=r(53),g=r(11),{selectUser:y}=r(26),x=s.default.div`
    width: 100%;
    display: flex;
