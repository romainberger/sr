(window.webpackJsonp=window.webpackJsonp||[]).push([[2],{225:function(e,t,r){"use strict";r.r(t),function(e){r.d(t,"default",function(){return P});r(31);var n,s,i,o=r(13);function a(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}r(34);const l=r(0),c=r(2).default,d=r(6),{connect:p}=r(7),f=r(67),h=r(43),u=r(27),m=r(86),{selectUser:g}=r(23),{copyToClipboard:y,saveMedia:b}=r(15),{addFiles:v}=r(12),{reset:E,setFileList:k,startTansfer:x}=r(88),w=r(9),S=r(1),R=c.div`
    display: flex;
    flex: 1;
