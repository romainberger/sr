(window.webpackJsonp=window.webpackJsonp||[]).push([[2],{239:function(e,t,r){"use strict";r.r(t),function(e){r.d(t,"default",function(){return P});r(41);var n,s,i,o=r(18);function a(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}const l=r(0),c=r(4).default,d=r(12),{connect:p}=r(9),f=r(109),h=r(62),u=r(39),m=r(149),{selectUser:g}=r(28),{copyToClipboard:y,saveMedia:b}=r(20),{addFiles:v}=r(19),{reset:E,setFileList:k,startTansfer:x}=r(150),w=r(13),S=r(3),R=c.div`
    display: flex;
    flex: 1;
