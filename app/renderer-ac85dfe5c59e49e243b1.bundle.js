...
`;e.exports=s},function(e,t,n){const i=n(1),a=n(71);e.exports.clearSearch=()=>({type:i.actionTypes.CLEAR_SEARCH}),e.exports.searchBasic=e=>(a.start("search"),{type:i.actionTypes.SEARCH_BASIC,term:e}),e.exports.searchTerm=e=>(a.start("search"),{type:i.actionTypes.SET_SEARCH,term:e}),e.exports.toggleAdvanced=()=>({type:i.actionTypes.TOGGLE_ADVANCED_SEARCH,__saveToDB__:!0,__db:i.db.app}),e.exports.searchTag=e=>(a.start("search"),{type:i.actionTypes.SEARCH_TAG,tag:e.trim()}),e.exports.removeSearchTag=e=>(a.start("search"),{type:i.actionTypes.REMOVE_SEARCH_TAG,tag:e}),e.exports.searchBPM=e=>(a.start("search"),{type:i.actionTypes.SEARCH_BPM,bpm:e}),e.exports.searchBPMDelta=e=>(a.start("search"),{type:i.actionTypes.SEARCH_BPM_DELTA,bpmDelta:e}),e.exports.transitionDone=()=>({type:i.actionTypes.ADVANCED_TRANSITION_DONE}),e.exports.setSearchArchived=e=>({type:i.actionTypes.SET_SEARCH_ARCHIVED,archived:e})},function(e,t,n){"use strict";n.r(t),n.d(t,"playFile",function(){return a}),n.d(t,"togglePlay",function(){return s}),n.d(t,"pausePlayer",function(){return r});var i=n(1);const a=e=>({type:i.actionTypes.PLAY_FILE,hashPath:e}),s=()=>({type:i.actionTypes.TOGGLE_PLAY}),r=(e=!1)=>({type:i.actionTypes.PAUSE_PLAYER,unsetSelectedFile:!0})},function(e,t,n){"use strict";n.r(t),n.d(t,"hasCorrectCloudLevel",function(){return c}),n.d(t,"hasUpload",function(){return p}),n.d(t,"canUpload",function(){return d}),n.d(t,"canDownload",function(){return h}),n.d(t,"canRead",function(){return u});var i=n(159),a=n(160),s=n(32),r=n.n(s),o=n(50),l=n(1);const c=(e,t)=>e.data.cloudLevel>=t,p=e=>c(e,o.a.LEVEL_3),d=e=>r()(e.data,"storageSize",0)<l.STORAGE_LIMITS[`CLOUD_LEVEL_${e.data.cloudLevel}`],h=d,u=e=>{const t=l.STORAGE_LIMITS[`CLOUD_LEVEL_${e.data.cloudLevel}`],n=r()(e.data,"storageSize",0);if(n<t)return!0;const s=n>t+l.STORAGE_BLOCK_MARGIN,o=e.data.updatedAt||e.data.createdAt,c=Object(i.a)(new Date,Object(a.a)(o,2));return!s&&!c}},function(e,t,n){"use strict";n.r(t),n.d(t,"signIn",function(){return r}),n.d(t,"setFullUserData",function(){return o}),n.d(t,"signOut",function(){return l}),n.d(t,"notLogged",function(){return c});var i=n(6);const a=n(1),s=n(25),r=e=>(s(`User sign in - ${e.email}`),{type:a.actionTypes.AUTH_SET_USER,user:e}),o=e=>({type:a.actionTypes.AUTH_SET_FULL_USER_DATA,data:e}),l=()=>(i.a.signOut(),{type:a.actionTypes.AUTH_SIGN_OUT}),c=()=>({type:a.actionTypes.AUTH_NOT_LOGGED})},function(e,t,n){const i=n(0),a=n(2).default,s=a.div`
    display: flex;
...
`;e.exports=({children:e,scrollElementRef:t=null,stickyHeader:n=null,wrapperStyle:a=""})=>i.createElement(s,null,n,i.createElement(r,{s:a,ref:t},e))},,function(e,t,n){const i=n(2).default,{colors:a}=n(1);e.exports=i.a`
    ...
    cursor: pointer;
`},,function(e,t,n){const i=n(2).default,{colors:a}=n(1),s=`1px solid ${a._grey}`,r=`\n    padding: 7px;\n    cursor: pointer;\n    background: transparent;\n    transition: background ease 0.1s;\n    color: ${a._white};\n    border-bottom: ${s};\n\n    :hover {\n        background: ${a._blue};\n    }\n`,o=i.div`
    ${r}
...
`;e.exports=({checked:e,onChange:t})=>i.createElement(i.Fragment,null,i.createElement(r,{checked:e},i.createElement("input",{type:"checkbox",style:{display:"none"},onChange:t,checked:e})))},function(e,t,n){var i;const a=n(0),{connect:s}=n(7),r=n(2).default.div`
    ...
    top: 0;
    left: 0;
`;let o=s(e=>({notification:e.notifications.notification}))(i=class extends a.Component{render(){const{notification:e}=this.props;return a.createElement(r,{hasNotification:e.active})}})||i;e.exports=o},function(e,t,n){const i=n(0),a=n(2).default,s=n(37),r=n(45),o=n(31),{openLink:l,reload:c}=n(15),p=n(1),d=a.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`;e.exports=()=>i.createElement(r,{viewBox:"0 0 32 32"},i.createElement("use",{xlinkHref:"#playIcon"}))},function(e,t,n){function i(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const a=n(0),s=n(5),r=n(2).default,o=n(115),l=r.div`
    cursor: pointer;
...
`,g=i.default.div`
    ...
    z-index: 2;
    font-size: 25px;
`;class f extends s.Component{constructor(...e){var t,n,i;super(...e),i={fakeFiles:[]},(n="state")in(t=this)?Object.defineProperty(t,n,{value:i,enumerable:!0,configurable:!0,writable:!0}):t[n]=i}async getFakeFiles(){const e=(await l.a.getRemoteConfigValue("FILES_EMPTY_DATA",[])).map(e=>new o.a(e));this.setState({fakeFiles:e})}componentDidMount(){this.getFakeFiles()}render(){return s.createElement(u,null,s.createElement(m,null,s.createElement(p,{items:this.state.fakeFiles,keys:e=>e.path,from:{transform:"translate3d(0, 40px, 0)",opacity:0},to:{transform:"translate3d(0, 0, 0)",opacity:1}},(e,t)=>n=>{const i=Math.max(Math.min(1-t/this.state.fakeFiles.length,n.opacity),0);return s.createElement("div",{key:`fake-${e.path}`,style:{...n,opacity:i}},s.createElement(h,{file:e}))})),s.createElement(g,null,"Drag and drop files to start building your library"))}}var E,v,b,y=n(49),T=n(11);function S(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const _=n(0),{connect:C}=n(7),x=n(5),w=n(2).default,A=n(108),R=n(72),L=n(73),k=n(43),{selectUser:F}=n(24),{addFiles:D,disableNewImports:P,migrateLegacyData:I,setSortRule:M,setFiles:O}=n(12),{searchTag:U}=n(39),{setAllowFileDragging:N}=n(35),$=n(71),H=n(9),{checkFiles:j}=n(15),{colors:B,sortRules:G}=n(1),V=w.div`
    margin-top: 50px;
    color: #555;
`,z=w.div`
    position: sticky;
...
`,X=w(Y)`
    justify-content: center;
`;let q=C((e,t)=>({_dataToMigrate:e.files._dataToMigrate,_winBackup:e.files._winBackup,files:Object(T.selectFiles)(e),filesCount:Object(T.selectFilesCount)(e),location:t.location,pending:e.files.pending,selectedFile:Object(T.selectSelectedFile)(e),sortRule:Object(T.selectSortRule)(e),user:F(e)}))((b=v=class extends _.PureComponent{constructor(...e){super(...e),S(this,"listRef",_.createRef()),S(this,"onTagClick",e=>{this.props.dispatch(U(e))}),S(this,"sortByName",()=>{this._sort(G.NAME_ASC,G.NAME_DESC)}),S(this,"sortByDuration",()=>{this._sort(G.DURATION_ASC,G.DURATION_DESC)}),S(this,"sortByBPM",()=>{this._sort(G.BPM_ASC,G.BPM_DESC)}),S(this,"sortByRating",()=>{this._sort(G.RATING_DESC,G.RATING_ASC)})}_sort(e,t){return this.props.sortRule!==e&&this.props.sortRule!==t?this.props.dispatch(M(e)):this.props.sortRule===e?this.props.dispatch(M(t)):void this.props.dispatch(M(null))}scrollToFile(e){if(this.listRef.current)try{const t=document.querySelector(e);t&&(this.listRef.current.scrollTop=t.offsetTop-75)}catch(e){}}listenFilesUpdate(){this.removeFileListener=l.a.listenForFilesUpdate(this.props.user.uid,e=>{this.props.dispatch(O(e)),j(e)})}renderStickyHeader(){const{files:e,filesCount:t,sortRule:n}=this.props;return _.createElement(z,null,t?_.createElement("div",null,"Showing ",e.length," of ",t," riffs"):_.createElement("div",null," "),_.createElement(W,null,_.createElement(Y,{onClick:this.sortByName},"Name",n===G.NAME_ASC?_.createElement(A,{rotate:!0}):null,n===G.NAME_DESC?_.createElement(A,null):null),_.createElement(X,{onClick:this.sortByDuration},"Duration",n===G.DURATION_ASC?_.createElement(A,{rotate:!0}):null,n===G.DURATION_DESC?_.createElement(A,null):null),_.createElement(Y,null,"Tags"),_.createElement(X,{onClick:this.sortByBPM},"BPM",n===G.BPM_ASC?_.createElement(A,{rotate:!0}):null,n===G.BPM_DESC?_.createElement(A,null):null),_.createElement(X,null,"Time Signature"),_.createElement(Y,{onClick:this.sortByRating},"Rating",n===G.RATING_ASC?_.createElement(A,{rotate:!0}):null,n===G.RATING_DESC?_.createElement(A,null):null),_.createElement(Y,null)))}componentDidMount(){H.trackScreen("home"),null!==this.props._dataToMigrate&&this.props.dispatch(I(this.props._dataToMigrate,this.props._winBackup)),this.listenFilesUpdate(),this.props.dispatch(N(!0)),this.props.location.hash&&this.scrollToFile(this.props.location.hash)}componentDidUpdate(e){e.files!==this.props.files&&$.end("search"),e.location.hash!==this.props.location.hash&&this.scrollToFile(this.props.location.hash)}componentWillUnmount(){this.props.dispatch(N(!1)),this.props.dispatch(P()),this.removeFileListener()}render(){const{files:e,filesCount:t,pending:n,selectedFile:i}=this.props,a=`\n            padding-bottom: ${i?"70px":0};\n        `;return _.createElement(k,{stickyHeader:this.renderStickyHeader(),wrapperStyle:a,scrollElementRef:this.listRef},n?_.createElement(y.a,null):_.createElement(_.Fragment,null,t?_.createElement(_.Fragment,null,e.length?e.map(e=>_.createElement(R,{file:e,key:e.hashPath,onTagClick:this.onTagClick,selected:i&&i.hashPath===e.hashPath})):_.createElement(K,null,"No files are matching your search"),_.createElement(V,null,"+ Drag and drop a file to add it to your library")):_.createElement(f,null)))}},S(v,"propTypes",{_dataToMigrate:x.object,dispatch:x.func,files:x.array,filesCount:x.number,selectedFile:x.any,sortRule:x.string}),E=b))||E;var J;function Z(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Q=n(0),{connect:ee}=n(7),te=n(2).default,ne=n(68),ie=n(47),{removeFile:ae,replaceFile:se}=n(12),{addNotification:re}=n(56),{importFiles:oe}=n(57),le=n(9),{checkFiles:ce}=n(15),pe=n(1),de=te.div`
    margin-top: 20px;
    padding: 50px;
    text-align: center;
    border: 5px dashed ${e=>e.dragging?pe.colors.blueLight:pe.colors._blue};
    transition: border-color ease 0.2s;
`,he=te.div`
    margin-bottom: 20px;
    font-weight: 600;
`;let ue=ee((e,t)=>({file:Object(T.selectFileByHashPath)(e,{fileHashPath:t.fileHashPath}),files:Object(T._selectFiles)(e)}))(J=class extends Q.Component{constructor(...e){super(...e),Z(this,"dropRef",Q.createRef()),Z(this,"state",{dragging:!1,replace:!1}),Z(this,"checkFileAccess",()=>{ce(this.props.files)}),Z(this,"onClickReplace",()=>{this.setState({replace:!0})}),Z(this,"removeFile",()=>{this.props.close(),this.props.dispatch(ae(this.props.file.hashPath))}),Z(this,"replaceFile",e=>{oe(this.props.dispatch,e.slice(0,1),e=>{const t=e[Object.keys(e)[0]];t&&(this.props.close(),this.props.dispatch(se(this.props.file.hashPath,t)))})})}componentDidMount(){le.trackScreen("modalFileMissing")}componentDidUpdate(e,t){!t.replace&&this.state.replace&&(this.removeDrag=ne(this.dropRef.current,{onDrop:this.replaceFile,onDragOver:()=>{this.setState({dragging:!0})},onDragLeave:()=>{this.setState({dragging:!1})}})),e.file.missing&&!this.props.file.missing&&(this.props.dispatch(re("File successfully located")),this.props.close())}componentWillUmount(){this.removeDrag&&this.removeDrag()}render(){const{file:e}=this.props,{dragging:t,replace:n}=this.state;return Q.createElement("div",null,Q.createElement(he,null,"We could not locate the file ",e.name),n?Q.createElement(de,{ref:this.dropRef,dragging:t},"Drag and drop the file here to replace it"):Q.createElement("div",null,Q.createElement(ie,{onClick:this.checkFileAccess},"Check again"),Q.createElement(ie,{onClick:this.onClickReplace},"Replace it"),Q.createElement(ie,{onClick:this.removeFile,last:!0},"Remove it from my riff library")))}})||J;var me,ge,fe,Ee=n(12),ve=n(21),be=n(41);function ye(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Te=n(0),{connect:Se}=n(7),_e=n(5),Ce=n(47),{openInFinder:xe}=n(15),we=n(9),{selectFileByHashPath:Ae}=n(11),{selectUser:Re}=n(24),{colors:Le,modals:ke}=n(1);i.default.div`
    margin-bottom: 20px;
    font-weight: bold;
`;var Fe=Se((e,t)=>({file:Ae(e,{fileHashPath:t.file.hashPath}),user:Re(e)}))((fe=ge=class extends Te.Component{constructor(...e){super(...e),ye(this,"state",{downloadUrl:"",uploadError:!1,uploading:!1,uploadProgress:0,uploadSuccess:!1}),ye(this,"openInFinder",()=>{xe(this.props.file.path),we.trackEvent("file","open-in-finder"),this.props.close()}),ye(this,"toggleFileArchive",()=>{l.a.updateFile(this.props.user,this.props.file.hashPath,{archived:!this.props.file.archived}),this.props.close()}),ye(this,"removeFile",()=>{this.props.close(),this.props.dispatch(Object(Ee.removeFile)(this.props.file.hashPath))}),ye(this,"onUploadProgress",e=>{this.setState({uploadProgress:e})}),ye(this,"onUploadError",e=>{console.error("Error uploading",e),this.setState({uploadError:!0,uploading:!1})}),ye(this,"onUploadSuccess",()=>{this.setState({uploading:!1,uploadSuccess:!0}),console.log("## success"),this.props.dispatch(Object(Ee.setFileUploadedStatus)(this.props.file.hashPath,!0)),this.setDownloadUrl()}),ye(this,"onUploadRunning",()=>{this.setState({uploading:!0})}),ye(this,"handleUploadFile",()=>{this.props.file.uploaded?l.a.deleteFile(this.props.user,this.props.file.name).then(()=>{console.log("### deleted"),this.props.dispatch(Object(Ee.setFileUploadedStatus)(this.props.file.hashPath,!1))}).catch(e=>{console.log("#### error deleting"),console.log(e)}):fetch(this.props.file.escapedPath).then(e=>e.blob()).then(e=>{l.a.uploadFile(this.props.user,this.props.file.name,e,{onError:this.onUploadError,onProgress:this.onUploadProgress,onRunning:this.onUploadRunning,onSuccess:this.onUploadSuccess})})}),ye(this,"openPublicLinkModal",()=>{this.props.dispatch(Object(ve.openModal)(ke.publicLink,{file:this.props.file}))})}setDownloadUrl(){l.a.getFileDownloadUrl(this.props.user,this.props.file.name).then(e=>this.setState({downloadUrl:e}))}renderUploadButton(){const{uploadError:e,uploading:t,uploadProgress:n}=this.state;return t?Te.createElement("span",null,"Uploading... ",n.toFixed(0),"%"):e?Te.createElement("span",null,"Error uploading"):this.props.file.uploaded?"Remove file from cloud":"Upload file"}componentDidMount(){we.trackScreen("modalFileOptions"),this.props.file.uploaded&&this.setDownloadUrl()}render(){const{file:e,user:t}=this.props,{downloadUrl:n}=this.state;return Te.createElement(Te.Fragment,null,Object(be.hasUpload)(t)?e.missing&&!e.uploaded?null:Te.createElement(Ce,{onClick:this.handleUploadFile,first:!0},this.renderUploadButton()):null,e.uploaded?Te.createElement(Ce,{onClick:this.openPublicLinkModal},"Share"):null,e.uploaded?Te.createElement(Ce.ModalLink,{href:n,download:!0},"Download"):null,e.missing?null:Te.createElement(Ce,{onClick:this.openInFinder},"Open in ","darwin"===window.__songRiffer.platform?"Finder":"File Explorer"),Te.createElement(Ce,{onClick:this.toggleFileArchive},e.archived?"Unarchive":"Archive"," file"),Te.createElement(Ce,{onClick:this.removeFile},"Remove from my riff library"))}},ye(ge,"propTypes",{close:_e.func,dispatch:_e.func,file:_e.object.isRequired}),me=fe))||me,De=n(7);const Pe={margin:"auto",background:"none",display:"block"};var Ie,Me=({size:e=100})=>r.a.createElement("svg",{style:Pe,width:`${e}px`,height:`${e}px`,viewBox:"0 0 100 100",preserveAspectRatio:"xMidYMid"},r.a.createElement("circle",{cx:"50",cy:"50",fill:"none",stroke:c.colors.blueLight,strokeWidth:"3",r:"29",strokeDasharray:"136.659280431156 47.553093477052",transform:"rotate(194.885 50 50)"},r.a.createElement("animateTransform",{attributeName:"transform",type:"rotate",repeatCount:"indefinite",dur:"1.1235955056179776s",values:"0 50 50;360 50 50",keyTimes:"0;1"}))),Oe=n(31),Ue=n.n(Oe),Ne=n(15),$e=n(17);function He(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const je=n(66),Be=n(47),{selectFileByHashPath:Ge}=n(11),{selectUser:Ve}=n(24),ze=n(9),We=n(25),Ke=i.default.div`
    max-width: 340px;
`,Ye=i.default.div`
    font-size: 18px;
`;var Xe,qe,Je,Ze=Object(De.connect)((e,t)=>({file:Ge(e,{fileHashPath:t.file.hashPath}),user:Ve(e)}))(Ie=class extends r.a.Component{constructor(...e){super(...e),He(this,"state",{copied:!1,loading:!1}),He(this,"createPublicLink",()=>{this.setState({loading:!0}),ze.trackEvent("share","create-link"),We("Share link created"),l.a.createFilePublicId(this.props.file.hashPath).then(e=>{this.setState({loading:!1})}).catch(e=>{console.error(e),this.setState({loading:!1})})}),He(this,"copyLink",()=>{ze.trackEvent("share","copy-link"),We("Share link copied");const e=Object($e.getShareLink)(this.props.user.uid,this.props.file.publicId);Object(Ne.copyToClipboard)(e),this.setState({copied:!0})}),He(this,"disableLink",()=>{ze.trackEvent("share","disable-link"),this.setState({loading:!0}),l.a.deleteFilePublicId(this.props.file.hashPath).then(e=>{this.setState({loading:!1}),console.log(e)}).catch(e=>{this.setState({loading:!1}),console.error(e)})})}componentDidMount(){ze.trackScreen("modalPublicLink")}render(){const{file:e}=this.props,{copied:t,loading:n}=this.state;return r.a.createElement(Ke,null,r.a.createElement(Ye,null,"Share a link to this file"),r.a.createElement(Ue.a,{size:"md"},"Everyone who will have the link created will be able to listen to your file but won't be able to edit it."),n?r.a.createElement(Me,{size:50}):e.public&&e.publicId?r.a.createElement(r.a.Fragment,null,r.a.createElement(Be,{onClick:this.copyLink,first:!0},t?r.a.createElement(r.a.Fragment,null,"Copied to clipboard ",r.a.createElement(je,{width:"15"})):r.a.createElement(r.a.Fragment,null,"Copy Link")),r.a.createElement(Be,{onClick:this.disableLink},"Disable link")):r.a.createElement(Be,{onClick:this.createPublicLink,first:!0},"Create public link"))}})||Ie,Qe=n(13);function et(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const tt=n(0),nt=n(2).default,{connect:it}=n(7),at=n(5),st=n(37),{removeFile:rt}=n(12),{selectFileByHashPath:ot}=n(11),{unlinkFile:lt}=n(15),ct=n(9),pt=n(1),dt=nt.div`
    max-width: 300px;
`,ht=nt.div`
    margin-bottom: 25px;
    font-size: 16px;
    line-height: 1.4;
`,ut=nt.span`
    color: ${pt.colors.bluePastel};
`,mt=nt.div`
    display: flex;
    justify-content: space-between;
`,gt=nt(st)`
    padding: 10px 25px;
`;var ft,Et=it((e,t)=>({file:ot(e,{fileHashPath:t.fileHashPath})}))((Je=qe=class extends tt.Component{constructor(...e){super(...e),et(this,"removeFile",()=>{this.props.close(),this.props.dispatch(rt(this.props.file.hashPath,!0))}),et(this,"deleteFile",()=>{this.props.close(),this.props.dispatch(rt(this.props.file.hashPath,!0)),lt(this.props.file.path),ct.trackEvent("file","delete-file",this.props.file.source)})}componentDidMount(){ct.trackScreen("modalRemoveFile")}render(){const{file:e}=this.props;let t;return e.source===Qe.b.RECORD&&(t="recorded with the Recorder"),e.source===Qe.b.TRANSFER&&(t="transfered from your phone"),tt.createElement(dt,null,tt.createElement(ht,null,tt.createElement(ut,null,e.name)," was ",t,". Do you want to delete the file as well as remove it from your library?"),tt.createElement(mt,null,tt.createElement(gt,{onClick:this.removeFile},"No"),tt.createElement(gt,{onClick:this.deleteFile},"Yes")))}},et(qe,"propTypes",{dispatch:at.func,file:at.object}),Xe=Je))||Xe;function vt(){return(vt=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e}).apply(this,arguments)}function bt(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const yt=n(0),Tt=n(2).default,{connect:St}=n(7),_t=n(132),Ct=n(133),xt=n(134),wt=n(136),At=n(137),Rt=n(138),{closeModal:Lt}=n(21),kt=n(1),Ft=Tt.div`
    display: flex;
    position: fixed;
    top: 0;
    left: 0;
...
`,Dt=Tt.div`
    ...
    background: ${kt.colors._greyDark};
    border-radius: 3px;
...
`;let It=St(e=>({modal:e.modal}))(ft=class extends yt.Component{constructor(...e){super(...e),bt(this,"dimmerRef",yt.createRef()),bt(this,"onDimmerClick",e=>{e.target===this.dimmerRef.current&&this.props.dispatch(Lt())}),bt(this,"close",()=>{this.props.dispatch(Lt())})}getModal(){const{name:e}=this.props.modal,t={[kt.modals.comment]:_t,[kt.modals.fileMissing]:ue,[kt.modals.fileOptions]:Fe,[kt.modals.invalidFile]:Ct,[kt.modals.publicLink]:Ze,[kt.modals.removeFile]:Et,[kt.modals.tabs]:xt,[kt.modals.tags]:wt,[kt.modals.text]:At,[kt.modals.updateAvailable]:Rt};if(!t[e])return null;const n=t[e];return yt.createElement(n,vt({},this.props.modal.props,{close:this.close}))}getRootStyle(){const{name:e}=this.props.modal;switch(e){case kt.modals.updateAvailable:return Rt.rootStyle;default:return""}}render(){const{modal:e}=this.props;if(!e.name)return null;const t=e.name===kt.modals.updateAvailable&&e.props.mandatory;return yt.createElement(Ft,{onClick:this.onDimmerClick,ref:this.dimmerRef,darker:t},yt.createElement(Dt,{additionalStyle:this.getRootStyle()},this.getModal(),t?null:yt.createElement(Pt,{onClick:this.close},"X")))}})||ft;var Mt=n(27),Ot=n(32),Ut=n.n(Ot),Nt=n(84);const $t=i.default.div`
    display: flex;
    align-items: center;
    height: 35px;
...
`,jt=i.default.div`
    ...
    margin-left: 10px;
    padding: 7px;
`;class Bt extends s.Component{render(){const{song:e}=this.props;return s.createElement($t,null,s.createElement(Ht,null,e.position),s.createElement(jt,null,e.name))}}function Gt(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Vt=n(43),zt=i.default.div`
    display: flex;
    position: sticky;
    top: 0;
...
`,Yt=i.default.div`
    width: 50%;
    height: 100%;
`;class Xt extends s.Component{constructor(...e){super(...e),Gt(this,"removeListener",void 0),Gt(this,"state",{newSongName:"",project:null}),Gt(this,"onChangeNewSongName",e=>{this.setState({newSongName:e.target.value})}),Gt(this,"addNewSong",e=>{if(e.preventDefault(),!this.state.newSongName.length)return;const t=Ut()(this.state.project,"songs",[]).length;l.a.addSongToProject(this.state.project.id,{position:t,name:this.state.newSongName}),this.setState({newSongName:""})})}listenProjectUpdate(){console.log(this.props),this.removeListener=l.a.listenForProjectUpdate(this.props.match.params.projectId,e=>{this.setState({project:e})})}componentDidMount(){this.listenProjectUpdate()}componentWillUnmount(){"function"==typeof this.removeListener&&this.removeListener()}renderHeader(){const{project:e}=this.state;return s.createElement(zt,null,s.createElement("div",null,s.createElement(Mt.Link,{to:c.routes.projects},"List of projects")),s.createElement(Wt,null,e.name))}render(){const{project:e}=this.state;return e?(console.log(e),s.createElement(Vt,{stickyHeader:this.renderHeader()},s.createElement(Kt,null,s.createElement(Yt,null,s.createElement("div",null,"image here"),s.createElement("div",null,"Last updated: ",Object(Nt.a)(e.updatedAt,{addSuffix:!0}))),s.createElement(Yt,null,s.createElement(Wt,null,"Songs"),e.songs&&e.songs.length?s.createElement("div",null,e.songs.map(e=>s.createElement(Bt,{song:e,key:`song-${e.position}`}))):s.createElement("div",null,"Add the first song to your project:"),s.createElement("form",{onSubmit:this.addNewSong},s.createElement("input",{type:"text",value:this.state.newSongName,onChange:this.onChangeNewSongName})))))):s.createElement(Vt,null,s.createElement(y.a,null))}}const qt=n(0),Jt=n(2).default,{colors:Zt}=n(1),Qt=Jt.svg`
    fill: ${Zt._white};
    opacity: 0.7;
    cursor: pointer;
...
`;var en=()=>qt.createElement(Qt,{version:"1.1",xmlns:"http://www.w3.org/2000/svg",width:"30",height:"30"},qt.createElement("path",{d:"M5 6.005c0-1.107 0.887-2.005 1.998-2.005h4.004c1.104 0 1.998 0.897 1.998 2.005v19.99c0 1.107-0.887 2.005-1.998 2.005h-4.004c-1.104 0-1.998-0.897-1.998-2.005v-19.99zM19 6.005c0-1.107 0.887-2.005 1.998-2.005h4.004c1.104 0 1.998 0.897 1.998 2.005v19.99c0 1.107-0.887 2.005-1.998 2.005h-4.004c-1.104 0-1.998-0.897-1.998-2.005v-19.99z"}));const tn=n(0),nn=n(2).default,{colors:an}=n(1),sn=nn.svg`
    fill: ${an._white};
    opacity: 0.7;
    cursor: pointer;
...
`;var rn,on,ln,cn=()=>tn.createElement(sn,{viewBox:"0 0 32 32",xmlns:"http://www.w3.org/2000/svg",width:"30",height:"30"},tn.createElement("path",{d:"M27.944 14.237c.18.1.316.2.436.314.143.138.267.297.368.48.027.046.05.094.073.142.124.275.18.553.18.828 0 .275-.056.553-.174.817-.092.205-.22.396-.378.563-.148.156-.32.285-.504.383L9.97 27.748c-.964.537-2.182.19-2.718-.777C6.998 26.516 7 25.24 7 25V6c0-1.1.826-1.932 1.87-1.996.107-.007.213-.006.32.005.364.03.7.158.98.352l17.774 9.875z"}));function pn(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const dn=n(33),{connect:hn}=n(7),un=n(5),mn=n(141),gn=n(37),fn=n(66),En=n(38),vn=n(43),{addFiles:bn}=(n(31),n(12)),{reset:yn}=n(76),{pausePlayer:Tn}=n(40),Sn=n(9),{getFilesDurationAndBPM:_n}=n(57),{checkFileExists:Cn,saveMedia:xn}=n(15),wn=i.default.div`
    display: flex;
    position: absolute;
    width: 100%;
    height: 100%;
...
`,Un=i.default.div`
    ...
    width: 100%;
    justify-content: center;
`;function Nn(e){for(var t,n=e.inputBuffer.getChannelData(0),i=n.length,a=0,s=0;s<i;s++)t=n[s],Math.abs(t)>=this.clipLevel&&(this.clipping=!0,this.lastClip=window.performance.now()),a+=t*t;var r=Math.sqrt(a/i);this.volume=Math.max(r,this.volume*this.averaging)}var $n=hn(e=>({recorder:e.recorder}))((ln=on=class extends r.a.Component{constructor(...e){super(...e),pn(this,"chunks",void 0),pn(this,"volumeMeter",void 0),pn(this,"stream",void 0),pn(this,"state",{audio:null,fileDuration:0,fileSize:0,name:"",playing:!1,recording:!1}),pn(this,"recorder",null),pn(this,"inputRef",r.a.createRef()),pn(this,"player",r.a.createRef()),pn(this,"recordButton",r.a.createRef()),pn(this,"toggleRecording",()=>{this.state.recording?this.stopRecording():this.startRecording()}),pn(this,"startRecording",()=>{this.props.dispatch(Tn(!0)),Sn.trackEvent("recorder","start-recording"),this.setState({recording:!0}),this.getAudio()}),pn(this,"pad",e=>1===`${e}`.length?`0${e}`:`${e}`),pn(this,"stopRecording",()=>{Sn.trackEvent("recorder","stop-recording");const{day:e,hours:t,minutes:n,month:i,seconds:a,year:s}=this.getDate();this.setState({name:`SongRiffer-idea-${s}-${i}-${e}-${t}${n}${a}`}),null!==this.recorder&&this.recorder.stop()}),pn(this,"onDataAvailable",e=>{this.chunks.push(e.data)}),pn(this,"onRecorderStop",()=>{const e=new Blob(this.chunks,{type:"audio/webm;codecs=opus"});this.setState({audio:URL.createObjectURL(e),recording:!1}),this.inputRef.current.focus(),cancelAnimationFrame(this.raf),this.recordButton.current.style.boxShadow=""}),pn(this,"drawVolume",()=>{const e=Math.max(0,1e3*this.volumeMeter.volume);this.recordButton.current.style.boxShadow=`\n            10px 10px ${e+40}px 3px ${c.colors.bluePastel},\n            -10px -10px ${e+40}px 3px ${c.colors._purpleLight}\n        `,this.raf=requestAnimationFrame(this.drawVolume)}),pn(this,"onNameChange",e=>{this.setState({name:e.target.value}),Cn(`${e.target.value}.wav`)}),pn(this,"onNameKeyDown",e=>{"Enter"===e.key&&this.save()}),pn(this,"save",()=>{const e=new AudioContext,t=new Blob(this.chunks,{type:"audio/webm"}),n=new FileReader;this.state.name;n.onload=()=>{e.decodeAudioData(n.result,e=>{const t=mn(e);this.setState({fileDuration:parseInt(e.duration,10),fileSize:t.byteLength}),xn(c.saveTypes.RECORDER,`${this.state.name}.wav`,new Uint8Array(t))})},n.readAsArrayBuffer(t)}),pn(this,"importFile",()=>{Sn.trackEvent("recorder","save",this.state.name),Sn.trackEvent("file","file-import","recorder",1);const e=`${this.state.name}.wav`,t=this.props.recorder.filePath,n={duration:this.state.fileDuration,name:e,path:t,size:this.state.fileSize,source:Qe.b.RECORD,type:"audio/wav"},i=new o.a(n);this.props.dispatch(bn({[Object($e.getFilePathHash)(t)]:i.toJSON()},!0)),_n(this.props.dispatch,[i])}),pn(this,"reset",()=>{this.chunks=[],this.setState({audio:null,playing:!1}),this.pausePlayer(),Sn.trackEvent("recorder","discard")}),pn(this,"togglePlay",()=>{this.setState({playing:!this.state.playing},()=>{this.state.playing?this.playPlayer():this.pausePlayer()})})}getDate(){const e=new Date;return{day:this.pad(e.getDate()),hours:e.getHours(),minutes:e.getMinutes(),month:this.pad(e.getMonth()+1),seconds:e.getSeconds(),year:e.getFullYear()}}getAudio(){navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(e=>{this.watchVolume(e),this.recordAudio(e)})}watchVolume(e){if(null===e)return;this.stream=e;const t=new AudioContext,n=t.createMediaStreamSource(this.stream);this.volumeMeter=function(e,t=.98,n=.95,i=750){var a=e.createScriptProcessor(512);return a.onaudioprocess=Nn,a.clipping=!1,a.lastClip=0,a.volume=0,a.clipLevel=t,a.averaging=n,a.clipLag=i,a.connect(e.destination),a.checkClipping=function(){return!!this.clipping&&(this.lastClip+this.clipLag<window.performance.now()&&(this.clipping=!1),this.clipping)},a.shutdown=function(){this.disconnect(),this.onaudioprocess=null},a}(t),n.connect(this.volumeMeter),this.drawVolume()}recordAudio(e){this.recorder=new MediaRecorder(e),this.chunks=[],this.recorder.ondataavailable=this.onDataAvailable,this.recorder.onstop=this.onRecorderStop,this.recorder.start()}playPlayer(){this.player.current.play()}pausePlayer(){this.player.current.pause()}componentDidMount(){Sn.trackScreen("record")}componentDidUpdate(e){!e.recorder.saveSuccess&&this.props.recorder.saveSuccess&&this.importFile()}componentWillUnmount(){cancelAnimationFrame(this.raf),this.props.dispatch(yn())}render(){const{recorder:e}=this.props,{audio:t,name:n,playing:i,recording:a}=this.state,s=!!e.fileAlreadyExists&&dn.basename(e.fileAlreadyExists,dn.extname(e.fileAlreadyExists))===n;return r.a.createElement(vn,{wrapperStyle:"\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    align-items: center;\n    height: 100%;\n    padding: 50px;\n    overflow: hidden;\n"},r.a.createElement(wn,{recording:a||!t},r.a.createElement(An,null,r.a.createElement(Rn,{onClick:this.toggleRecording,recording:a,ref:this.recordButton},a?"STOP":"START"))),r.a.createElement(Ln,{recording:a||!t},e.saveSuccess?r.a.createElement(Mn,null,r.a.createElement(fn,{width:"50"}),r.a.createElement(On,null,n," was successfully added to your library!"),r.a.createElement(Un,null,r.a.createElement(Mt.Link,{to:c.routes.home},r.a.createElement(In,null,"Go back to your file list")))):r.a.createElement(r.a.Fragment,null,r.a.createElement("div",null,r.a.createElement("audio",{src:t,ref:this.player}),r.a.createElement("div",{onClick:this.togglePlay},i?r.a.createElement(en,null):r.a.createElement(cn,null))),r.a.createElement(kn,null,r.a.createElement(Dn,{onChange:this.onNameChange,onKeyDown:this.onNameKeyDown,ref:this.inputRef,type:"text",value:n,error:s}),r.a.createElement(Pn,null,s?"This file already exists, please choose another name":r.a.createElement("span",null," ")),r.a.createElement(Fn,null,r.a.createElement(In,{onClick:this.reset,background:c.colors._grey},"Discard"),r.a.createElement(In,{onClick:this.save,disabled:s},"Save"))))))}},pn(on,"propTypes",{dispatch:un.func,recorder:un.object}),rn=ln))||rn;const Hn=i.default.div`
    height: 10px;
    border-radius: 10px;
...
`,jn=i.default.div`
    width: ${e=>e.width}%;
    height: 10px;
`,Bn=({percentage:e})=>r.a.createElement(Hn,null,r.a.createElement(jn,{width:e,style:{background:e>=90?c.colors.redLight:c.colors.bluePastel}}));var Gn,Vn,zn;function Wn(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Kn=n(0),{connect:Yn}=n(7),Xn=n(2).default,qn=n(5),Jn=n(47),Zn=n(43),Qn=n(31),{checkUpdate:ei}=n(35),{openModal:ti}=n(21),{signOut:ni}=n(42),{selectUser:ii}=n(24),ai=n(9),{hasUpload:si}=n(41),{formatFileSize:ri}=n(53),{openLink:oi,toggleDevTools:li}=n(15),ci=n(1),pi=Xn.div`
    width: 50%;
    padding: 0 40px;
`,di=Xn.div`
    margin-bottom: 25px;
...
`,hi=Xn(Jn)`
    text-align: center;
`,ui=Xn.span`
    color: ${ci.colors.redLight};
`,mi=Xn(Jn.ModalLink)`
    text-align: center;
`,gi=Xn.div`
    margin-top: 30px;
`;var fi,Ei=Yn(e=>({enableExperimental:e.application.enableExperimental,updateAvailable:e.application.updateAvailable,user:ii(e)}))((zn=Vn=class extends Kn.Component{constructor(...e){super(...e),Wn(this,"state",{storageSize:0,storageSizeLimit:0,storageSizeLoaded:!1}),Wn(this,"signOut",()=>{this.props.dispatch(ni())}),Wn(this,"checkUpdates",()=>{this.props.dispatch(ei(!0))})}renderDevMenu(){return Kn.createElement(gi,null,Kn.createElement(di,null,"Experimental Menu"),Kn.createElement(hi,{onClick:li,first:!0},"Toggle dev tools"))}getCloudStorageLimit(){return new Promise(async e=>{const{user:t}=this.props;if(void 0!==t.data.cloudStorageLimit)return e(t.data.cloudStorageLimit);e(await l.a.getRemoteConfigValue(`STORAGE_LIMIT_LEVEL_${t.data.cloudLevel}`,0))})}getUserStorageSize(){return new Promise(async e=>{const{user:t}=this.props;if(void 0!==t.data.storageSize)return e(t.data.storageSize);e(await l.a.getUserStorageSize(t.uid))})}async fetchStorageSize(){const{user:e}=this.props;if(si(e)){const e=await this.getUserStorageSize(),t=await this.getCloudStorageLimit();this.setState({storageSizeLoaded:!0,storageSize:e,storageSizeLimit:t})}}renderAccount(){if(si(this.props.user)){const{storageSize:e,storageSizeLimit:t,storageSizeLoaded:n}=this.state;if(!n)return Kn.createElement(Qn,null,Kn.createElement(Me,{size:40}));const i=100*e/t,a=isNaN(i)?0:i.toFixed(2);return Kn.createElement(Qn,null,Kn.createElement(Qn,{size:"xs"},"Total storage size used:"),Kn.createElement(Qn,{size:"xs"},ri(e)," / ",ri(t)," (",a,"%)"),Kn.createElement(Qn,{size:"s"},Kn.createElement(Bn,{percentage:a})),this.renderStorageFullMessage(a))}return null}renderStorageFullMessage(e){if(e<90)return null;const t=e>=100?"Your storage space is full!":"Your storage space is almost full!";return Kn.createElement(Qn,null,t," Visit ",Kn.createElement("a",{href:"https://songriffer.com"},"to increase your plan and be able to add more files"))}componentDidMount(){ai.trackScreen("settings"),this.fetchStorageSize()}render(){const{enableExperimental:e,updateAvailable:t,user:n}=this.props;return Kn.createElement(Zn,{wrapperStyle:"\n    display: flex;\n    height: 100%;\n    justify-content: space-between;\n    align-items: center;\n"},Kn.createElement(pi,null,Kn.createElement(hi,{onClick:this.checkUpdates,first:!0},"Check for updates ",t?Kn.createElement(ui,null,"•"):null),Kn.createElement(mi,{href:`mailto:${ci.email}`},"Contact Us"),Kn.createElement(hi,{onClick:()=>oi(ci.facebookUrl)},"Follow us on Facebook"),Kn.createElement(hi,{onClick:()=>oi(ci.instagramUrl)},"Follow us on Instagram"),Kn.createElement(hi,{onClick:()=>oi(ci.landingUrl)},"Visit us songriffer.com"),e&&this.renderDevMenu()),Kn.createElement(pi,null,Kn.createElement(di,null,"Hello ",n.email,"!"),this.renderAccount(),Kn.createElement(hi,{onClick:this.signOut,first:!0},"Sign out")))}},Wn(Vn,"propTypes",{dispatch:qn.func,enableExperimental:qn.bool,updateAvailable:qn.bool,user:qn.object}),Gn=zn))||Gn,vi=n(40);function bi(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const{extname:yi}=n(33),Ti=n(0),{connect:Si}=n(7),{selectSelectedFile:_i}=n(11),{selectUser:Ci}=n(24),{formatDuration:xi}=n(53),wi=n(9),Ai=n(25),Ri=n(142),Li=i.default.div`
    position: fixed;
    width: 100%;
    height: 50px;
...
`,Mi=Object(i.default)(Ii)`
    ...
    opacity: 1;
    pointer-events: none;
`,Oi=new AudioContext;var Ui=Si(e=>({file:_i(e),playing:e.player.playing,user:Ci(e)}))(fi=class extends Ti.Component{constructor(...e){super(...e),bi(this,"canvas",Ti.createRef()),bi(this,"canvasProgress",Ti.createRef()),bi(this,"player",Ti.createRef()),bi(this,"playerUI",Ti.createRef()),bi(this,"state",{audioBuffer:null,progress:null,progressPercent:0,waveformData:[]}),bi(this,"togglePlay",()=>{this.props.dispatch(Object(vi.togglePlay)())}),bi(this,"onWaveformCalculated",e=>{this.setState({waveformData:e.data}),this.canvasCtx.fillStyle=c.colors.purple;const t=this.canvas.current.height/2;e.data.forEach((e,n)=>{const i=1*n,a=(1+e.min)*t,s=Math.max(1,(e.max-e.min)*t);this.canvasCtx.fillRect(i,a,1,s)}),this.canvas.current.style.opacity=1}),bi(this,"onCanvasClick",e=>{const t=e.clientX-e.target.offsetParent.offsetLeft,n=Math.round(100*t/e.target.offsetWidth),i=this.props.file.duration*n/100;this.player.current.currentTime=i})}playFile(){const{file:e}=this.props,t=[];e.missing&&e.uploaded&&(wi.trackEvent("player","download-file"),Ai("Playing file from storage"),t.push(l.a.getFileDownloadUrl(this.props.user,e.name))),Promise.all(t).then(t=>{const n=t[0]||e.escapedPath;this.player.current.src=n,this.player.current.play(),this.eventInit||this.initEvents(),wi.trackEvent("player","play-file",yi(this.props.file.name)),this.canvasCtx.clearRect(0,0,this.canvas.current.width,this.canvas.current.height),this.canvasProgressCtx.clearRect(0,0,this.canvas.current.width,this.canvas.current.height),this.loadWaveform(n)})}initEvents(){this.eventInit=!0,this.player.current.addEventListener("timeupdate",e=>{let t=0,n=0;this.props.file&&(n=100*(t=parseInt(this.player.current.currentTime,10))/this.props.file.duration),t!==this.state.progress&&this.setState({progress:t,progressPercent:n})}),this.player.current.addEventListener("ended",e=>{this.togglePlay(),this.setState({progress:0,progressPercent:0})})}handlePlayingState(e){e&&this.player.current.paused&&(wi.trackEvent("player","play"),this.player.current.play()),e||this.player.current.paused||(wi.trackEvent("player","pause"),this.player.current.pause())}loadWaveform(e){fetch(e).then(e=>e.arrayBuffer()).then(e=>{Oi.decodeAudioData(e,async e=>{this.calculateWaveDataWorker.postMessage({channelData:e.getChannelData(0),width:this.canvas.current.width,pointWidth:1})})})}drawProgressWaveform(){if(!this.props.file)return;const e=this.state.waveformData.slice(0,Math.round(this.state.progressPercent*this.state.waveformData.length/100)),t=this.canvasProgress.current.height/2;this.canvasProgressCtx.fillStyle=c.colors._purpleLight,this.canvasProgressCtx.clearRect(0,0,this.canvas.current.width,this.canvas.current.height),e.forEach((e,n)=>{const i=1*n,a=(1+e.min)*t,s=Math.max(1,(e.max-e.min)*t);this.canvasProgressCtx.fillRect(i,a,1,s)})}componentDidMount(){this.canvasCtx=this.canvas.current.getContext("2d"),this.canvasProgressCtx=this.canvasProgress.current.getContext("2d"),this.calculateWaveDataWorker=new Ri,this.calculateWaveDataWorker.addEventListener("message",this.onWaveformCalculated)}componentDidUpdate(e,t){(!e.file&&this.props.file||e.file&&this.props.file&&e.file.path!==this.props.file.path)&&this.playFile(),e.playing!==this.props.playing&&this.handlePlayingState(this.props.playing),t.progress!==this.state.progress&&this.drawProgressWaveform()}render(){const{file:e}=this.props,{audioBuffer:t,progress:n,progressPercent:i}=this.state;return Ti.createElement(Ti.Fragment,null,Ti.createElement("audio",{ref:this.player}),Ti.createElement(Li,{visible:e,ref:this.playerUI},Ti.createElement(ki,null,Ti.createElement("div",{onClick:this.togglePlay},this.props.playing?Ti.createElement(en,null):Ti.createElement(cn,null)),Ti.createElement(Di,null,Ti.createElement(Pi,null,Ti.createElement(Mi,{ref:this.canvasProgress}),Ti.createElement(Ii,{ref:this.canvas,onClick:this.onCanvasClick})),e?Ti.createElement("span",null,xi(n)," / ",xi(e.duration)):null),e?Ti.createElement(Fi,{to:`${c.routes.home}#file-${this.props.file.hashPath}`,title:e.name},e.name):null)))}})||fi,Ni=n(14);function $i(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const Hi=n(0),ji=(n(5),n(2).default),Bi=n(37),Gi=n(88),Vi=n(25),zi=n(1),Wi=ji.div`
    margin-bottom: 25px;
    color: ${zi.colors._white};
`,Ki=ji.form`
    width: 100%;
    max-width: 480px;
    margin-bottom: 50px;
...
`,Ji=ji.div`
    margin: 5px 0 25px;
    color: ${zi.colors.redLight};
`,Zi={"auth/user-not-found":"We could not find your account, please check your information or create a new account.","auth/wrong-password":"Invalid password."};var Qi=class extends Hi.Component{constructor(...e){super(...e),$i(this,"state",{authForm:"signin",confirmPassword:"",email:"",error:null,password:"",pending:!1,renderPasswordForgotten:!1,resetEmailSent:!1}),$i(this,"_mounted",!0),$i(this,"emailInputRef",Hi.createRef()),$i(this,"signIn",e=>{e.preventDefault(),this.setState({pending:!0}),l.a.signInWithEmailPassword(this.state.email,this.state.password).then(()=>{this._mounted&&this.setState({email:"",password:"",pending:!1})}).catch(e=>{this.setState({error:Zi[e.code]?Zi[e.code]:e.message,pending:!1})})}),$i(this,"signUp",e=>{e.preventDefault(),this.setState({pending:!0});const{confirmPassword:t,email:n,password:i}=this.state;i===t?l.a.signUpWithEmailPassword(n,i).then(e=>{Vi(`New user sign up - ${e.user.email}`),this._mounted&&this.setState({email:"",password:"",pending:!1})}).catch(e=>{this.setState({error:e,pending:!1})}):this.setState({error:"Your confirmation and your password must match"})}),$i(this,"switchForm",()=>{this.setState({authForm:"signin"===this.state.authForm?"signup":"signin",error:null}),this.focusInput()}),$i(this,"onChangeEmail",e=>{this.setState({email:e.target.value,error:null})}),$i(this,"onChangePassword",e=>{this.setState({password:e.target.value,error:null})}),$i(this,"onChangeConfirmPassword",e=>{this.setState({confirmPassword:e.target.value,error:null})}),$i(this,"sendResetPassword",e=>{e.preventDefault(),this.state.email.length&&l.a.sendResetPasswordEmail(this.state.email).then(()=>{this.setState({resetEmailSent:!0})})}),$i(this,"switchPasswordForgotten",()=>{this.setState({renderPasswordForgotten:!this.state.renderPasswordForgotten,resetEmailSent:!1})})}focusInput(){this.emailInputRef.current.focus()}renderPasswordForgotten(){return Hi.createElement(Ki,{onSubmit:this.sendResetPassword},this.state.resetEmailSent?Hi.createElement(Wi,null,"An email has been sent to reset your password."):null,this.renderEmailInput(),Hi.createElement(qi,null,"Send email to reset your password"),Hi.createElement(Yi,{onClick:this.switchPasswordForgotten},"Return to login"))}renderEmailInput(){return Hi.createElement(Wi,null,Hi.createElement(Gi,{type:"email",placeholder:"Email",onChange:this.onChangeEmail,value:this.state.email,ref:this.emailInputRef}))}componentDidMount(){this.focusInput()}componentWillUnmount(){this._mounted=!1}render(){const{authForm:e,error:t,pending:n,renderPasswordForgotten:i}=this.state;return i?this.renderPasswordForgotten():Hi.createElement(Ki,{onSubmit:"signin"===e?this.signIn:this.signUp},this.renderEmailInput(),Hi.createElement(Wi,null,Hi.createElement(Gi,{type:"password",placeholder:"Password",onChange:this.onChangePassword,value:this.state.password})),"signup"===e?Hi.createElement(Wi,null,Hi.createElement(Gi,{type:"password",placeholder:"Confirm Password",onChange:this.onChangeConfirmPassword,value:this.state.confirmPassword})):null,Hi.createElement(qi,{pending:n},"Sign ","signin"===e?"in":"up"),t?Hi.createElement(Ji,null,t):null,Hi.createElement(Yi,{onClick:this.switchForm},"signin"===e?"Create an account":"I already have an account"),Hi.createElement(Xi,{onClick:this.switchPasswordForgotten},"Forgot your password?"))}};function ea(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const ta=n(0),na=n(58),ia=n(9),aa=i.default.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
    height: 100%;
`;var sa,ra,oa,la=class extends ta.Component{constructor(...e){super(...e),ea(this,"state",{animationDone:!1}),ea(this,"onAnimationDone",()=>{this.setState({animationDone:!0}),this.props.onAnimationDone()})}componentDidMount(){const e=Math.round(performance.now());ia.trackTiming("app","app-ready",e)}render(){const{authLoading:e,isAuthenticated:t}=this.props,{animationDone:n}=this.state,i=!e&&!t,a=[{component:ta.createElement(Ni.Spring,{from:{angle:"-70deg",opacity:0},to:{angle:"0deg",opacity:1},config:Ni.config.slow},e=>ta.createElement(na,{opacity:e.opacity,angle:e.angle})),key:"logo"},{component:ta.createElement(Ni.Spring,{from:{opacity:0},to:{opacity:i?1:0},config:Ni.config.slow},e=>ta.createElement("div",{style:{opacity:e.opacity}},ta.createElement(Qi,null))),key:"authform"}];return ta.createElement(aa,null,ta.createElement(Ni.Trail,{items:a,keys:e=>e.key,from:{transform:"translate3d(0, 40px, 0)"},to:{transform:"translate3d(0, 0, 0)"},config:Ni.config.slow,onRest:this.onAnimationDone},e=>t=>ta.createElement("div",{style:t},e.component)))}},ca=n(42);function pa(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}const da=n(0),{connect:ha}=n(7),ua=n(5),ma=n(68),ga=n(100),fa=n(106),Ea=n(107),va=n(130),ba=n(131),ya=n(139),Ta=n(143),Sa=n(145),_a=n(150),{toggleAdvanced:Ca}=n(39),{closeModalEsc:xa}=n(21),{checkUpdate:wa,closeContextMenu:Aa,resize:Ra}=n(35),{togglePlay:La}=n(40),{recorderFileAlreadyExists:ka,recorderSaveSuccess:Fa}=n(76),{transferSaveSuccess:Da}=n(89),{setMXML:Pa}=n(151),{getFilesDurationAndBPM:Ia,importFiles:Ma}=n(57),Oa=n(9),Ua=n(25),Na=n(34),{isAuthenticated:$a,isUserFullyLoaded:Ha,selectUser:ja}=n(24),{checkFilesDBExists:Ba,getAppConfig:Ga,onMissingFiles:Va,setCallback:za}=n(15),Wa=n(1),Ka=(i.default.div`
    height: 100%;
    min-height: 100%;
    display: flex;
    flex-direction: column;
...
`,qa=i.default.div`
    ...
    height: 100%;
    pointer-events: none;
    color: ${Wa.colors.blueLight};
    border: 20px dashed ${Wa.colors.blueLight};
    font-size: 200px;
    justify-content: center;
    align-items: center;
    z-index: 100;
...
`,Za=i.default.div`
    ...
    display: flex;
    align-items: center;
`,Qa=da.lazy(()=>n.e(2).then(n.bind(null,233))),es=()=>da.createElement(da.Suspense,{fallback:null},da.createElement(Qa,null)),ts=da.lazy(()=>n.e(1).then(n.bind(null,234))),ns=()=>da.createElement(da.Suspense,{fallback:null},da.createElement(ts,null)),is=da.lazy(()=>n.e(0).then(n.bind(null,235))),as=()=>da.createElement(da.Suspense,{fallback:null},da.createElement(is,null));var ss=ha(e=>({advancedSearchVisible:Na(e).displayAdvanced,allowFileDragging:e.application.allowFileDragging,appReady:Ha(e),appWidth:e.application.appWidth,authLoading:e.auth.authLoading,contextMenu:e.application.contextMenu,enableExperimental:e.application.enableExperimental,isAuthenticated:$a(e),modalOpen:!!e.modal.name,user:ja(e)}))((oa=ra=class extends da.Component{constructor(...e){super(...e),pa(this,"state",{dragging:!1,hasError:!1,splashAnimationDone:!1}),pa(this,"onSplashAnimationDone",()=>{this.setState({splashAnimationDone:!0})}),pa(this,"importFiles",e=>{this.props.isAuthenticated&&Ma(this.props.dispatch,e,e=>{for(let t in e)e[t].newImport=!0;this.props.dispatch(Object(Ee.addFiles)(e,!0))})}),pa(this,"getDataFromMain",(e,t)=>{switch(e){case Wa.mainConsts.events.CHECK_FILES_DB:t.exists&&this.props.dispatch({type:Wa.actionTypes.SET_MIGRATION_DATA,data:t.data,_winBackup:t._winBackup});break;case Wa.mainConsts.events.DATA_FETCHED:if(t.db===Wa.db.files){this.props.dispatch(Object(Ee.addFiles)(t.data));const e=[];return Object.values(t.data).forEach(t=>{t.bpm&&t.duration||e.push(t)}),void(e.length&&Ia(this.props.dispatch,e))}t.db===Wa.db.app&&t.data.displayAdvanced&&this.props.dispatch(Ca());break;case Wa.mainConsts.events.FILE_ALREADY_EXISTS:this.props.dispatch(ka(t));break;case Wa.mainConsts.events.FILE_SYSTEM_ERROR:console.log(t);break;case Wa.mainConsts.events.FILE_SAVE_SUCCESS:t.saveType===Wa.saveTypes.RECORDER?this.props.dispatch(Fa(t.filePath)):t.saveType===Wa.saveTypes.TRANSFER&&this.props.dispatch(Da(t.fileName,t.filePath));break;case Wa.mainConsts.events.GET_MXLM_SUCCESS:this.props.dispatch(Pa(t.filePath,t.mxml));break;case Wa.mainConsts.events.OPEN_DEEPLINK:this.handleDeeplink(t.url)}}),pa(this,"handleDeeplink",e=>{try{const t=e.replace("songriffer://songriffer.com?deeplink=",""),n=JSON.parse(decodeURIComponent(t));switch(n.type){case Wa.deeplinkTypes.LOGIN_FACEBOOK:l.a.signInWithFacebookToken(n.params.token);break;case Wa.deeplinkTypes.LOGIN_GOOGLE:l.a.signInWithGoogleToken(n.params.token);break;default:Ua(`Unsupported deeplink type ${n.type} - raw deeplink: ${t}`)}}catch(t){const n=`Could not parse deeplink args: ${e}`;console.error(n),Oa.exception(n),Ua(`*Error* ${n}`)}}),pa(this,"onMissingFiles",e=>{this.props.dispatch(Object(Ee.setMissingFiles)(e.files))}),pa(this,"onKeyDown",e=>{if("Escape"===e.key&&this.props.dispatch(xa()),32===e.keyCode&&e.target===document.body&&(this.props.dispatch(La()),e.preventDefault()),!this.props.modalOpen&&e.target&&"INPUT"!==e.target.tagName&&/^[a-zA-Z]{1}$/.test(e.key)){let e=null;e=this.props.advancedSearchVisible?"#advanced-search-input":"#basic-search-input";const t=document.querySelector(e);t&&t.focus()}}),pa(this,"onResize",()=>{window.innerWidth!==this.props.appWidth&&this.props.dispatch(Ra(window.innerWidth))}),pa(this,"setFullUser",e=>{this.props.dispatch(Object(ca.setFullUserData)(e))}),pa(this,"onAuthChange",e=>{e?(this.props.dispatch(Object(ca.signIn)(e)),l.a.getFullUser(e.uid).then(this.setFullUser)):this.props.dispatch(Object(ca.notLogged)())}),pa(this,"closeContextMenu",()=>{this.props.dispatch(Aa())}),pa(this,"catchError",e=>{this.setState({hasError:!0});try{const t=`${e.message} \n \`\`\`${e.error.stack}\`\`\``;Oa.exception(e.message),Ua(`*Error* ${t}`)}catch(e){Ua("*Error* unavailable message"),Oa.exception("Error - unavailable message")}})}detectDragDrop(){this.dragDropActivated=!0,this.removeDragDrop=ma(document.body,{onDrop:this.importFiles,onDragOver:()=>{this.setState({dragging:!0})},onDragLeave:()=>{this.setState({dragging:!1})}})}listenForFullUserUpdate(){l.a.listenForFullUserUpdate(this.props.user.uid,this.setFullUser).then(e=>{this.fullUserListener=e})}removeFullUserListener(){"function"==typeof this.fullUserListener&&this.fullUserListener()}checkUpdate(){clearTimeout(this.updateTimeout),this.props.dispatch(wa(!1)),this.updateTimeout=setTimeout(()=>{this.checkUpdate()},Wa.updateInterval)}componentDidCatch(){this.setState({hasError:!0})}componentDidMount(){Ba(),window.addEventListener("error",this.catchError,{passive:!0}),this.detectDragDrop(),Va(this.onMissingFiles),za(this.getDataFromMain),l.a.onAuthChange(this.onAuthChange),Oa.trackEvent("app","app-start",window.__songRiffer.platform),Oa.trackEvent("app",`platform-${window.__songRiffer.platform}`,window.__songRiffer.release),Oa.trackEvent("app","appVersion","1.4.2"),document.addEventListener("keydown",this.onKeyDown),window.addEventListener("resize",this.onResize,{passive:!0}),this.onResize(),this.updateTimeout=setTimeout(()=>{this.checkUpdate()},3e3)}componentDidUpdate(e){!this.props.modalOpen&&this.props.allowFileDragging||!this.dragDropActivated||(this.removeDragDrop(),this.dragDropActivated=!1),this.props.modalOpen||!this.props.allowFileDragging||this.dragDropActivated||this.detectDragDrop(),!e.appReady&&this.props.appReady&&Ga(),!e.isAuthenticated&&this.props.isAuthenticated?this.listenForFullUserUpdate():e.isAuthenticated&&!this.props.isAuthenticated&&this.removeFullUserListener()}componentWillUnmount(){clearTimeout(this.updateTimeout),this.removeFullUserListener()}render(){const{appReady:e,authLoading:t,contextMenu:n,enableExperimental:i,isAuthenticated:s}=this.props,{dragging:r,hasError:o,splashAnimationDone:l}=this.state;return e&&l?o?da.createElement(Ea,null):da.createElement(a.a,null,da.createElement(Ja,null,da.createElement(fa,null),da.createElement(va,null),da.createElement(Ka,null,da.createElement(Za,null,da.createElement(ba,{style:"margin-left: 3px;"})),da.createElement(a.g,null,da.createElement(a.d,{exact:!0,path:Wa.routes.home,component:Ta}))),da.createElement(Ya,null,da.createElement(Sa,null),da.createElement(qa,{dragging:r},"+"),da.createElement(Xa,{dragging:r},da.createElement(a.g,null,da.createElement(a.d,{path:Wa.routes.project,component:Xt}),da.createElement(a.d,{path:Wa.routes.projects,component:as}),da.createElement(a.d,{path:Wa.routes.recorder,component:$n}),da.createElement(a.d,{path:Wa.routes.settings,component:Ei}),da.createElement(a.d,{path:Wa.routes.stats,component:ns}),da.createElement(a.d,{path:Wa.routes.transfer,component:es}),da.createElement(a.d,{exact:!0,path:Wa.routes.home,component:q}))),da.createElement(ga,null),da.createElement(It,null),da.createElement(ya,null),da.createElement(Ui,null)),n.active?da.createElement(_a,{close:this.closeContextMenu,positionX:n.positionX,positionY:n.positionY,props:n.props}):null)):da.createElement(la,{authLoading:t,isAuthenticated:s,onAnimationDone:this.onSplashAnimationDone})}},pa(ra,"propTypes",{advancedSearchVisible:ua.bool,allowFileDragging:ua.bool,appReady:ua.bool,appStartTime:ua.number,appWidth:ua.number,authLoading:ua.bool,contextMenu:ua.object,dispatch:ua.func,isAuthenticated:ua.bool,modalOpen:ua.bool}),sa=oa))||sa;const rs={allowFileDragging:!1,appWidth:0,contextMenu:{},dbLoaded:!1,enableExperimental:!1,updateAvailable:!1},os={authLoading:!0,data:{createdAt:null,cloudLevel:0,updatedAt:null},user:null},ls=e=>({email:e.email,emailVerified:e.emailVerified,uid:e.uid}),{getFilePathHash:cs}=n(17),ps={_dataToMigrate:null,_winBackup:!1,files:{},pending:!0,sortRule:null,selectedFile:null},ds=(e,t)=>{const n={...e};for(let e in t)n[e]?n[e]={...n[e],added:t[e].added,size:t[e].size}:n[e]=t[e];return n},hs=(e,t)=>{if(!t.length)return e;const n={...e};return Object.keys(n).forEach(e=>{t.includes(e)?n[e]={...n[e],missing:!0}:n[e].missing&&(n[e]={...n[e],missing:!1})}),n},us=(e,t,n)=>{const i={...e};return delete i[t],i[cs(n.path)]=n,i},ms=(e,t,n)=>{if(!e[t])return e;const i=e[t];return Object.keys(i.tags).map(e=>e.toLowerCase()).includes(n.toLowerCase())?e:{...e,[t]:{...i,tags:{...e[t].tags,[n]:!0}}}},gs={name:null,props:null},fs={filePath:null,mxml:null},Es=n(1),{displayUpdateAvailableModal:vs}=n(35),{openModal:bs}=n(21),ys={notification:{active:!1}};let Ts=0;const Ss=()=>Ts++,_s={fileAlreadyExists:"",filePath:null,saveSuccess:!1},Cs={advancedTransitionDone:!0,archived:c.searchArchived.NON_ARCHIVED,basicTerm:"",bpm:"",bpmDelta:10,displayAdvanced:!1,tags:{},term:""},{combineReducers:xs}=n(48),ws=xs({application:(e=rs,t)=>{switch(t.type){case c.actionTypes.ADD_FILES:return{...e,dbLoaded:!0};case c.actionTypes.UPDATE_AVAILABLE:return{...e,updateAvailable:!0};case c.actionTypes.APP_RESIZE:return{...e,appWidth:t.width};case c.actionTypes.DISPLAY_TAG_CONTEXT_MENU:return{...e,contextMenu:{active:!0,positionX:t.positionX,positionY:t.positionY,props:t.props}};case c.actionTypes.CLOSE_CONTEXT_MENU:return{...e,contextMenu:rs.contextMenu};case c.actionTypes.SEARCH_BASIC:return t.term.toLowerCase()===c.DEBUG_KEY_SEQUENCE?{...e,enableExperimental:!0}:e;case c.actionTypes.SET_ALLOW_FILE_DRAGGING:return{...e,allowFileDragging:t.allowFileDragging};default:return e}},auth:(e=os,t)=>{switch(t.type){case c.actionTypes.AUTH_SET_USER:return{...e,authLoading:!1,user:ls(t.user)};case c.actionTypes.AUTH_SIGN_OUT:return os;case c.actionTypes.AUTH_SET_FULL_USER_DATA:return{...e,data:t.data};case c.actionTypes.AUTH_NOT_LOGGED:return{...e,authLoading:!1};default:return e}},files:(e=ps,t)=>{switch(t.type){case c.actionTypes.SET_FILES:return{...e,files:t.files,pending:!1};case c.actionTypes.SET_MIGRATION_DATA:return{...e,_dataToMigrate:t.data,_winBackup:t._winBackup};case c.actionTypes.ADD_TAG:return{...e,files:ms(e.files,t.hashPath,t.tag)};case c.actionTypes.REMOVE_TAG:const n=e.files[t.hashPath],i={...n.tags};return delete i[t.tag],{...e,files:{...e.files,[t.hashPath]:{...n,tags:i}}};case c.actionTypes.EDIT_FILE:let a;return a=!t.automaticEdit&&t.edit.bpm||t.automaticEdit&&t.edit.bpm&&!e.files[t.hashPath].bpm?t.edit.bpm:e.files[t.hashPath].bpm,{...e,files:{...e.files,[t.hashPath]:{...e.files[t.hashPath],...t.edit,bpm:a}}};case c.actionTypes.ADD_FILES:return{...e,_dataToMigrate:null,files:ds(e.files,t.files),pending:!1};case c.actionTypes.REMOVE_FILE:const s={...e.files};return delete s[t.hashPath],{...e,files:s,selectedFile:e.selectedFile===t.hashPath?null:e.selectedFile};case c.actionTypes.PLAY_FILE:return{...e,selectedFile:t.hashPath};case c.actionTypes.REPLACE_FILE:return{...e,files:us(e.files,t.oldFileHashPath,t.newFile)};case c.actionTypes.SET_MISSING_FILES:return{...e,files:hs(e.files,t.filesHashPath)};case c.actionTypes.SET_SORT_RULE:return{...e,sortRule:t.sortRule};case c.actionTypes.PAUSE_PLAYER:return t.unsetSelectedFile?{...e,selectedFile:null}:e;case c.actionTypes.DISABLE_NEW_IMPORTS:const r={...e.files};for(const e of t.files)r[e]={...r[e],newImport:!1};return{...e,files:r};case c.actionTypes.SET_FILE_UPLOAD_STATUS:return{...e,files:{...e.files,[t.hashPath]:{...e.files[t.hashPath],uploaded:t.uploaded}}};case c.actionTypes.AUTH_SIGN_OUT:return ps;default:return e}},modal:(e=gs,t)=>{switch(t.type){case c.actionTypes.OPEN_MODAL:return{name:t.name,props:t.props};case c.actionTypes.CLOSE_MODAL:return gs;default:return e}},mxml:(e=fs,t)=>{switch(t.type){case c.actionTypes.SET_MXML:return{...e,filePath:t.filePath,mxml:t.mxml};default:return e}},notifications:(e=ys,t)=>{switch(t.type){case Es.actionTypes.ADD_NOTIFICATION:return{notification:{...t.notification,active:!0,id:Ss()}};case Es.actionTypes.REMOVE_NOTIFICATION:return{notification:{...e.notification,active:!1}};case Es.actionTypes.ADD_FILES:if(!t.newImports)return e;const n=Object.values(t.files).filter(e=>e.source!==Qe.b.RECORD&&e.source!==Qe.b.TRANSFER).length;return n?{notification:{title:`Imported ${n} file${n>1?"s":""}`,status:"success",active:!0,id:Ss()}}:e;case Es.actionTypes.REMOVE_FILE:return{notification:{title:"File removed",status:"success",active:!0,id:Ss()}};case Es.actionTypes.REPLACE_FILE:return{notification:{title:"File successfully replaced",status:"success",active:!0,id:Ss()}};case Es.actionTypes.NOTIFY_MISSING_FILE:return{notification:{title:`We could not locate the file ${t.file.name}. Click here to fix this`,status:"error",active:!0,id:Ss(),onClick:()=>bs(Es.modals.fileMissing,{fileHashPath:t.file.hashPath}),timeout:5e3}};case Es.actionTypes.UPDATE_AVAILABLE:return{notification:{title:"New version available!",status:"success",active:!0,id:Ss(),onClick:()=>e=>{e(vs(t.url,t.changelog))},timeout:5e3}};case Es.actionTypes.SEARCH_BASIC:return t.term.toLowerCase()===Es.DEBUG_KEY_SEQUENCE?{notification:{title:"Experimental mode activated",status:"success",active:!0,id:Ss()}}:e;default:return e}},player:n(153),recorder:(e=_s,t)=>{switch(t.type){case c.actionTypes.RECORDER_FILE_ALREADY_EXISTS:return{...e,fileAlreadyExists:t.fileName};case c.actionTypes.RECORDER_SAVE_SUCCESS:return{...e,filePath:t.filePath,saveSuccess:!0};case c.actionTypes.RECORDER_RESET:return _s;default:return e}},search:(e=Cs,t)=>{switch(t.type){case c.actionTypes.SEARCH_BASIC:return{...e,basicTerm:t.term};case c.actionTypes.SET_SEARCH:return{...e,term:t.term,basicTerm:""};case c.actionTypes.TOGGLE_ADVANCED_SEARCH:return{...Cs,displayAdvanced:!e.displayAdvanced,advancedTransitionDone:!1};case c.actionTypes.ADVANCED_TRANSITION_DONE:return{...e,advancedTransitionDone:!0};case c.actionTypes.SEARCH_TAG:return{...e,advancedTransitionDone:!1,displayAdvanced:!0,basicTerm:"",tags:{...e.tags,[t.tag]:!0}};case c.actionTypes.REMOVE_SEARCH_TAG:const n={...e.tags};return delete n[t.tag],{...e,basicTerm:"",tags:n};case c.actionTypes.SEARCH_BPM:return{...e,basicTerm:"",bpm:isNaN(parseInt(t.bpm,10))?"":parseInt(t.bpm,10)};case c.actionTypes.SEARCH_BPM_DELTA:return{...e,bpmDelta:isNaN(parseInt(t.bpmDelta,10))?10:parseInt(t.bpmDelta,10)};case c.actionTypes.CLEAR_SEARCH:return{...Cs,displayAdvanced:e.displayAdvanced};case c.actionTypes.SET_SEARCH_ARCHIVED:return{...e,archived:t.archived};default:return e}},transfer:n(154)}),As=n(1),{saveApp:Rs}=n(15),{selectFilesForStorage:Ls}=n(11),ks=n(34),{selectUser:Fs}=n(24);var Ds=e=>t=>n=>{if(t(n),n.__saveToDB__){const t=e.getState();switch(n.__db){case As.db.files:const e=!{[As.actionTypes.REMOVE_FILE]:!0,[As.actionTypes.REPLACE_FILE]:!0}[n.type],i=Ls(t),a=Fs(t);l.a.saveFullFilesData(a.uid,i,e);break;case As.db.app:Rs({displayAdvanced:ks(t).displayAdvanced});break;default:throw new Error("Error trying to save data, unknow db",n.__db)}}};const{createStore:Ps,applyMiddleware:Is}=n(48),Ms=Ps(ws,Is(n(152).default,Ds,n(155))),Os=n(0),{Provider:Us}=n(7),{render:Ns}=n(44);Ns(Os.createElement(Us,{store:Ms},Os.createElement(ss,null)),document.querySelector("#root"))}],[[157,3,5]]]);