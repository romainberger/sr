...
`;e.exports=()=>n.createElement(r,{viewBox:"0 0 32 32"},n.createElement("use",{xlinkHref:"#playIcon"}))},function(e,t,a){function n(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const i=a(0),s=a(12),r=a(4).default,o=a(167),l=r.div`
    cursor: pointer;
...
`;var v=d.forwardRef((e,t)=>{const{additionalStyle:a,children:n,deleteTitle:i,onDelete:s}=e,r=Object(c.getTagColor)(n),o={...e};return delete o.onDelete,d.createElement(g,p({},o,{color:r,additionalStyle:a,ref:t}),d.createElement(f,null,n),s?d.createElement(E,{title:i,onClick:s,color:r},"x"):null)}),b=a(22),y=a(3);const T=a(110),S=()=>({type:y.actionTypes.TOGGLE_ADVANCED_SEARCH,__saveToDB__:!0,__db:y.db.app}),_=e=>(T.start("search"),{type:y.actionTypes.SEARCH_TAG,tag:e.trim()}),x=e=>({type:y.actionTypes.SET_SEARCH_ARCHIVED,archived:e});var C,w,A;function R(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const F=a(0),{connect:k}=a(7),D=a(12),P=a(51),L=a(52),O=a(76),I=a(161),{selectTags:M}=a(14),N=a(3),U=o.default.div`
    position: relative;
    display: flex;
    flex-direction: column;
...
`;var K=k(e=>({allTags:M(e),search:Object(b.a)(e),visible:Object(b.a)(e).displayAdvanced}))((A=w=class extends F.Component{constructor(...e){super(...e),R(this,"state",{autocompleteTag:null,newTag:""}),R(this,"rootRef",F.createRef()),R(this,"nameInputRef",F.createRef()),R(this,"searchName",e=>{this.props.dispatch((e=>(T.start("search"),{type:y.actionTypes.SET_SEARCH,term:e}))(e.target.value))}),R(this,"onBPMChange",e=>{this.props.dispatch((e=>(T.start("search"),{type:y.actionTypes.SEARCH_BPM,bpm:e}))(e.target.value))}),R(this,"onBPMDeltaChange",e=>{this.props.dispatch((e=>(T.start("search"),{type:y.actionTypes.SEARCH_BPM_DELTA,bpmDelta:e}))(e.target.value))}),R(this,"onTagChange",e=>{const t=Object.keys(this.props.search.tags);this.setState({autocompleteTag:Object(c.getTagAutocomplete)(this.props.allTags,e.target.value,t),newTag:e.target.value})}),R(this,"onTagKeyDown",e=>{if("Tab"===e.key&&this.state.autocompleteTag)return this.props.dispatch(_(this.state.autocompleteTag)),e.preventDefault(),void this.quitTagEdit();"Enter"===e.key&&this.state.newTag.length&&(this.props.dispatch(_(this.state.newTag)),this.quitTagEdit())}),R(this,"clearSearch",()=>{this.props.dispatch((()=>({type:y.actionTypes.CLEAR_SEARCH}))())}),R(this,"removeTag",e=>{this.props.dispatch((e=>(T.start("search"),{type:y.actionTypes.REMOVE_SEARCH_TAG,tag:e}))(e))}),R(this,"onTransitionEnd",()=>{this.props.dispatch((()=>({type:y.actionTypes.ADVANCED_TRANSITION_DONE}))())}),R(this,"onSwitchArchived",e=>{e.target.checked?this.props.dispatch(x(N.searchArchived.ALL)):this.props.dispatch(x(N.searchArchived.NON_ARCHIVED))})}quitTagEdit(){this.setState({autocompleteTag:null,newTag:""})}shouldComponentUpdate(e){return this.props.visible||e.visible}componentDidMount(){this.rootRef.current.addEventListener("transitionend",this.onTransitionEnd,{passive:!0})}componentWillUnmout(){this.rootRef.current.removeEventListener("transitionend",this.onTransitionEnd)}render(){const{search:e,visible:t}=this.props,{autocompleteTag:a,newTag:n}=this.state,i=e.term.length||e.bpm||Object.keys(e.tags).length,s=t?void 0:-1;return F.createElement(U,{visible:t,ref:this.rootRef},F.createElement($,null,F.createElement(j,null,F.createElement(H,null,"Name"),F.createElement(L,{isFullWidth:!0,type:"text",onChange:this.searchName,value:e.term,tabIndex:s,id:"advanced-search-input",ref:this.nameInputRef})),F.createElement(j,null,F.createElement(H,null,"Tags"),F.createElement(O,{isFullWidth:!0,autocomplete:a,autocompleteStyle:"\n    top: 3px;\n    left: 2px;\n",onChange:this.onTagChange,onKeyDown:this.onTagKeyDown,value:n,tabIndex:s}),Object.keys(e.tags).length?F.createElement(V,null,Object.keys(e.tags).map(e=>F.createElement(v,{key:e,onDelete:()=>this.removeTag(e),deleteTitle:"Remove this tag from the search",additionalStyle:"\n    margin-bottom: 5px;\n"},e))):null),F.createElement(j,null,F.createElement(H,null,"Tempo"),F.createElement(G,null,F.createElement(W,{type:"number",onChange:this.onBPMChange,value:e.bpm,min:1,tabIndex:s}),F.createElement("span",null,"bpm + / - "),F.createElement(W,{type:"number",onChange:this.onBPMDeltaChange,value:e.bpmDelta,title:e.bpm?`Results will include riffs that have a tempo between ${e.bpm-10} and ${e.bpm+10}`:null,min:0,tabIndex:s}))),F.createElement(B,null,F.createElement(z,null,"Show archived files"),F.createElement(I,{onChange:this.onSwitchArchived,checked:e.archived===N.searchArchived.ALL})),i?F.createElement(P,{onClick:this.clearSearch,tabIndex:s},"Clear search"):null))}},R(w,"propTypes",{allTags:D.any,dispatch:D.func,search:D.object,visible:D.bool}),C=A))||C;const Y=o.default.div`
    position: absolute;
    width: 100%;
    height: 20px;
...
`,ve=o.default.span`
    color: #777;
`;var be=({name:e})=>{const t=Object(fe.extname)(e),a=e.replace(t,"");return i.a.createElement(Ee,{title:e},a,i.a.createElement(ve,null,t))},ye=a(131),Te=a(132),Se=a(133),_e=a(134);function xe(){return(xe=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e}).apply(this,arguments)}let Ce;!function(e){e.FontAwesome="FontAwesome",e.Foundation="Foundation",e.Ionicons="Ionicons",e.MaterialCommunityIcons="MaterialCommunityIcons"}(Ce||(Ce={}));const we={[Ce.FontAwesome]:ye,[Ce.Foundation]:Te,[Ce.Ionicons]:Se,[Ce.MaterialCommunityIcons]:_e};var Ae=({className:e,font:t,onClick:a,name:n,style:s={}})=>{let r=n?we[t][n]||"?":"";"number"==typeof r&&(r=String.fromCharCode(r));const o={fontSize:18,color:ce.colors._white,fontFamily:t,fontWeight:400,fontStyle:"normal",...s},l={};return"function"==typeof a&&(l.onClick=a,o.cursor="pointer"),i.a.createElement("span",xe({className:e,style:o},l),r)};const Re=o.default.div`
    display: flex;
    justify-content: center;
    align-items: center;
    opacity: 0.5;
...
`;var Fe,ke,De,Pe=({onClick:e})=>i.a.createElement(Re,null,i.a.createElement(Ae,{font:Ce.MaterialCommunityIcons,name:"dots-vertical",onClick:e,style:{fontSize:25}}));function Le(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const Oe=a(0),{connect:Ie}=a(7),Me=a(12),Ne=a(76),{selectTags:Ue}=a(14);var $e,je,He,Be=Ie(e=>({allTags:Ue(e)}))((De=ke=class extends Oe.Component{constructor(...e){super(...e),Le(this,"state",{autocompleteTag:null,newTag:""}),Le(this,"onTagKeyDown",e=>{"Enter"===e.key&&this.state.newTag.length&&(this.resetTagWrite(),this.props.addTag(this.state.newTag)),"Tab"===e.key&&(this.state.autocompleteTag&&(this.resetTagWrite(),this.props.addTag(this.state.autocompleteTag)),e.preventDefault()),"Escape"===e.key&&(this.props.quitTagEdit(),e.preventDefault())}),Le(this,"resetTagWrite",()=>{this.setState({autocompleteTag:null,newTag:""},this.calculateVisibleTags)}),Le(this,"writeTag",e=>{this.setState({autocompleteTag:Object(c.getTagAutocomplete)(this.props.allTags,e.target.value,this.props.blacklist),newTag:e.target.value})})}render(){const{autocompleteTag:e,newTag:t}=this.state,{inputWidth:a,quitTagEdit:n}=this.props;return Oe.createElement(Ne,{autocomplete:e,autoFocus:!0,onBlur:n,onChange:this.writeTag,onKeyDown:this.onTagKeyDown,value:t,style:{width:a,height:22}})}},Le(ke,"propTypes",{addTag:Me.func,allTags:Me.any,blacklist:Me.array,quitTagEdit:Me.func}),Fe=De))||Fe;function ze(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const Ve=a(0),Ge=a(4).default,We=a(12),{connect:Ke}=a(7),Ye=a(109),{colors:Xe}=a(3),qe=Ge.div`
    position: relative;
    display: flex;
    align-items: center;
    overflow-x: hidden;
...
`,Je=Ge(Ye)`
    padding: 0;
    text-align: center;
    border: 2px solid ${Xe._white};

    :hover {
        background: ${Xe._white};
        color: ${Xe._black};
    }
`,Ze=Ge(Ye)`
    border: 2px solid ${Xe._white};
...
`;var Qe=Ke(e=>({advancedTransitionDone:Object(b.a)(e).advancedTransitionDone,appWidth:e.application.appWidth}))((He=je=class extends Ve.PureComponent{constructor(...e){super(...e),ze(this,"state",{editTag:!1,firstVisibleTag:!1,fitInput:!0,limitedLayout:!1,sliceTags:!1,visibleTags:this.props.tags.length}),ze(this,"rootRef",Ve.createRef()),ze(this,"tagsRef",{}),ze(this,"startEditTag",()=>{this.setState({editTag:!0},this.calculateVisibleTags)}),ze(this,"onTagContextMenu",(e,t)=>{this.props.onTagContextMenu(t,e.clientX,e.clientY)}),ze(this,"onTagClick",e=>{this.props.onTagClick(e)}),ze(this,"addTag",e=>{this.props.addTag(e)}),ze(this,"quitTagEdit",()=>{this.setState({editTag:!1},this.calculateVisibleTags)}),ze(this,"calculateVisibleTags",()=>{if(!this.props.limitedLayout||!this.props.tags.length)return;const e=this.rootRef.current.offsetWidth,t=Object.values(this.tagsRef).filter(Boolean),{tagsTotalWidth:a,visibleTags:n}=t.reduce((t,a)=>(t.tagsTotalWidth+=a.offsetWidth+3,t.tagsTotalWidth<e-26&&t.visibleTags++,t),{tagsTotalWidth:0,visibleTags:0});if(n!==t.length&&(this.setState({visibleTags:n-1}),this.state.editTag||this.setState({sliceTags:!0})),this.state.editTag&&a+100>e){const{firstVisibleTag:a}=t.reverse().reduce((a,n,i)=>(a.tagsTotalWidth+=n.offsetWidth+3,a.tagsTotalWidth>e&&!a.firstVisibleTag&&(a.firstVisibleTag=t.length-(i+1)),a),{firstVisibleTag:!1,tagsTotalWidth:100});this.setState({firstVisibleTag:a,fitInput:!1})}else this.setState({fitInput:!0})})}componentDidMount(){this.calculateVisibleTags()}componentDidUpdate(e){(e.tags.length||this.props.tags.length)&&(e.tags!==this.props.tags||e.appWidth!==this.props.appWidth||!e.advancedTransitionDone&&this.props.advancedTransitionDone)&&this.setState({sliceTags:!1,visibleTags:this.props.tags.length},this.calculateVisibleTags)}render(){const{limitedLayout:e,openTagModal:t,tags:a}=this.props,{editTag:n,firstVisibleTag:i,fitInput:s,sliceTags:r,visibleTags:o}=this.state;return Ve.createElement(qe,{ref:this.rootRef,additionalStyle:this.props.rootStyle,limitedLayout:e,editTag:n,moveForInput:!s},a.slice(0,r?o:a.length).map((e,t)=>Ve.createElement(v,{key:e,onContextMenu:t=>this.onTagContextMenu(t,e),onClick:()=>this.props.onTagClick(e),title:`Click to search all files with the tag "${e}"`,ref:t=>this.tagsRef[e]=t,additionalStyle:n&&!s&&!1!==i&&t===i?"\n    -webkit-mask-image: linear-gradient(to right, rgba(0, 0, 0, 0) 50%, rgba(0, 0, 0, 0.8) 100%);\n":""},e)),r?Ve.createElement(Ze,{onClick:t,title:`${a.length-o} tags hidden, click to see them and add more`},a.length-Math.max(0,o),"+"):Ve.createElement(Ve.Fragment,null,n?Ve.createElement(Be,{addTag:this.addTag,blacklist:a,inputWidth:100,quitTagEdit:this.quitTagEdit}):Ve.createElement(Je,{className:"add-tag",onClick:this.startEditTag,style:{width:26,height:22}},"+")))}},ze(je,"propTypes",{advancedTransitionDone:We.bool,appWidth:We.number,dispatch:We.func,limitedLayout:We.bool,openTagModal:We.func,onTagClick:We.func,onTagContextMenu:We.func,tags:We.array}),ze(je,"defaultProps",{onTagContextMenu:()=>{}}),$e=He))||$e,et=a(229);function tt(){return(tt=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e}).apply(this,arguments)}const at=o.default.div`
    padding: 7px;
    background: red;
    background: #222222FF;
    ...
    z-index: 20;
    border-radius: 3px;
    border: 1px solid ${ce.colors._grey};
...
`,it=o.default.div`
    ...
    height: 12px;
    background: #222222FF;
    border: ${ce.colors._grey} 1px solid;
    border-left-color: ${ce.colors._grey};
    border-top-color: ${ce.colors._grey};
...
`,st=o.default.div`
    cursor: pointer;
`;var rt=({children:e,handler:t,isText:a=!1})=>{const[s,r]=Object(n.useState)(!1),[o,l]=Object(n.useState)(null),[c,p]=Object(n.useState)(null),[d,u]=Object(n.useState)(null),{styles:h,attributes:m}=Object(et.a)(o,c,{placement:"top",modifiers:[{name:"arrow",options:{element:d}}]}),g=m.popper?m.popper["data-popper-placement"]:"";return i.a.createElement(i.a.Fragment,null,i.a.createElement(st,{ref:l,onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1)},t),i.a.createElement(at,tt({ref:p,style:h.popper},m.popper,{isVisible:s,isText:a,placement:g}),i.a.createElement(nt,{ref:u,style:h.arrow,placement:g},i.a.createElement(it,{placement:g})),e))},ot=a(8);function lt(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const ct=a(165),pt=a(166),{formatDuration:dt}=a(74),{openModal:ut}=a(24),{addTag:ht,handleFileOpen:mt}=a(19),{displayTagContextMenu:gt}=a(44),{selectUser:ft}=a(30),Et=a(13),vt=a(3),bt=Object(o.default)(ge)`
    ...
    box-shadow: ${e=>e.uploaded?`inset 2px 0px 0 ${ce.colors.blueGreen}`:"none"};
`,yt=o.default.span`
    cursor: pointer;
`,Tt=o.default.div`
    display: flex;
...
`,_t=o.default.div`
    ...
    justify-content: center;
    align-items: center;
`;var xt=Object(s.connect)((e,t)=>({missingFiles:e.files.missingFiles,playing:t.selected&&e.player.playing,user:ft(e)}))(class extends i.a.PureComponent{constructor(...e){super(...e),lt(this,"onDoubleClick",()=>{this.props.dispatch(mt(this.props.file))}),lt(this,"addTag",e=>{this.props.dispatch(ht(this.props.file.hashPath,e))}),lt(this,"onTagContextMenu",(e,t,a)=>{this.props.dispatch(gt(this.props.file.hashPath,e,t,a))}),lt(this,"setRating",e=>{this.updateFile({rating:e}),Et.trackEvent("file","set-rating")}),lt(this,"onTagClick",e=>{this.props.onTagClick(e)}),lt(this,"updateFile",e=>{ot.a.updateFile(this.props.user,this.props.file.hashPath,e)}),lt(this,"saveBPM",e=>{parseInt(e,10)<0||(this.updateFile({bpm:e}),Et.trackEvent("file","set-bpm"))}),lt(this,"saveTimeSignature",e=>{this.updateFile({timeSignature:e}),Et.trackEvent("file","set-time-signature")}),lt(this,"onTimeSignatureFocus",e=>{const t=e.current.value.split("/");e.current.setSelectionRange(0,t[0].length)}),lt(this,"openOptionsModal",()=>{this.props.dispatch(ut(vt.modals.fileOptions,{file:this.props.file}))}),lt(this,"onClickMissing",()=>{this.props.dispatch(ut(vt.modals.fileMissing,{fileHashPath:this.props.file.hashPath}))}),lt(this,"openTagModal",()=>{this.props.dispatch(ut(vt.modals.tags,{fileHashPath:this.props.file.hashPath}))}),lt(this,"openCommentModal",()=>{this.props.dispatch(ut(vt.modals.comment,{fileHashPath:this.props.file.hashPath}))})}renderFile(e){return this.props.file.newImport?i.a.createElement(le.Spring,{from:{background:"rgba(255, 255, 255, 0.4)"},to:{background:"rgba(255, 255, 255, 0)"},config:{duration:3e3}},({background:t})=>i.a.createElement("div",{style:{background:t}},e)):e}render(){const{file:e,missingFiles:t,playing:a,selected:n}=this.props,s=t.includes(e.hashPath),r=!s||s&&(e.hasComment()||e.uploaded);return this.renderFile(i.a.createElement(bt,{archived:e.archived,hasComment:e.hasComment(),isPlayable:e.isPlayable(),onDoubleClick:this.onDoubleClick,selected:n,id:`file-${e.hashPath}`,uploaded:e.uploaded},i.a.createElement(Tt,null,i.a.createElement(yt,{className:"play-button",onClick:this.onDoubleClick},i.a.createElement(ct,null)),i.a.createElement(be,{name:e.name}),s&&!e.uploaded?i.a.createElement(rt,{handler:i.a.createElement(St,{onClick:this.onClickMissing},"!"),isText:!0},"We could not locate this file - click to replace it or remove it from your library"):null,r?i.a.createElement(Ae,{className:"comment-icon",font:Ce.MaterialCommunityIcons,name:"comment-text-outline",onClick:this.openCommentModal}):null),i.a.createElement(_t,null,e.duration?dt(e.duration):"--:--"),i.a.createElement(Qe,{addTag:this.addTag,limitedLayout:!0,openTagModal:this.openTagModal,onTagClick:this.onTagClick,onTagContextMenu:this.onTagContextMenu,tags:e.getTags()}),i.a.createElement(_t,null,i.a.createElement(me,{value:e.bpm,placeholder:"+",onSave:this.saveBPM,type:"number"})),i.a.createElement(_t,null,i.a.createElement(me,{onFocus:this.onTimeSignatureFocus,onSave:this.saveTimeSignature,value:e.timeSignature})),i.a.createElement(_t,null,i.a.createElement(pt,{onChange:this.setRating,rating:e.rating})),i.a.createElement(Pe,{onClick:this.openOptionsModal})))}}),Ct=a(137),wt=a.n(Ct),At=a(40);const{Trail:Rt,config:Ft}=a(20),kt=o.default.div`
    height: 100%;
    display: flex;
    position: relative;
    justify-content: center;
...
`,Pt=o.default.div`
    ...
    z-index: 2;
    font-size: 25px;
`;class Lt extends n.Component{render(){const e=wt.a.map(e=>new At.a(e));return n.createElement(kt,null,n.createElement(Dt,null,n.createElement(Rt,{items:e,keys:e=>e.path,from:{transform:"translate3d(0, 40px, 0)",opacity:0},to:{transform:"translate3d(0, 0, 0)",opacity:1}},(t,a)=>i=>{const s=Math.max(Math.min(1-a/e.length,i.opacity),0);return n.createElement("div",{key:`fake-${t.path}`,style:{...i,opacity:s}},n.createElement(xt,{file:t}))})),n.createElement(Pt,null,"Drag and drop files to start building your library"))}}var Ot,It,Mt,Nt=a(70),Ut=a(14);function $t(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const jt=a(0),{connect:Ht}=a(7),Bt=a(12),zt=a(4).default,Vt=a(164),Gt=a(59),{selectUser:Wt}=a(30),{addFiles:Kt,disableNewImports:Yt,migrateLegacyData:Xt,setSortRule:qt,setFiles:Jt}=a(19),{setAllowFileDragging:Zt}=a(44),Qt=a(110),ea=a(13),{checkFiles:ta}=a(21),{colors:aa,sortRules:na}=a(3),ia=zt.div`
    margin-top: 50px;
    color: #555;
`,sa=zt.div`
    position: sticky;
    top: 0;
    border-bottom: 1px solid ${aa.blueLight};
    z-index: 2;
`,ra=zt(ge)`
    color: ${aa.blueLight};
`,oa=zt.div`
...
`,ca=zt(la)`
    justify-content: center;
`;let pa=Ht((e,t)=>({_dataToMigrate:e.files._dataToMigrate,_winBackup:e.files._winBackup,files:Object(Ut.selectFiles)(e),filesCount:Object(Ut.selectFilesCount)(e),location:t.location,pending:e.files.pending,selectedFile:Object(Ut.selectSelectedFile)(e),sortRule:Object(Ut.selectSortRule)(e),user:Wt(e)}))((Mt=It=class extends jt.PureComponent{constructor(...e){super(...e),$t(this,"listRef",jt.createRef()),$t(this,"onTagClick",e=>{this.props.dispatch(_(e))}),$t(this,"sortByName",()=>{this._sort(na.NAME_ASC,na.NAME_DESC)}),$t(this,"sortByDuration",()=>{this._sort(na.DURATION_ASC,na.DURATION_DESC)}),$t(this,"sortByBPM",()=>{this._sort(na.BPM_ASC,na.BPM_DESC)}),$t(this,"sortByRating",()=>{this._sort(na.RATING_DESC,na.RATING_ASC)})}_sort(e,t){return this.props.sortRule!==e&&this.props.sortRule!==t?this.props.dispatch(qt(e)):this.props.sortRule===e?this.props.dispatch(qt(t)):void this.props.dispatch(qt(null))}scrollToFile(e){if(this.listRef.current)try{const t=document.querySelector(e);t&&(this.listRef.current.scrollTop=t.offsetTop-75)}catch(e){}}listenFilesUpdate(){this.removeFileListener=ot.a.listenForFilesUpdate(this.props.user.uid,e=>{this.props.dispatch(Jt(e)),ta(e)})}renderStickyHeader(){const{files:e,filesCount:t,sortRule:a}=this.props;return jt.createElement(sa,null,t?jt.createElement("div",null,"Showing ",e.length," of ",t," riffs"):jt.createElement("div",null," "),jt.createElement(ra,null,jt.createElement(la,{onClick:this.sortByName},"Name",a===na.NAME_ASC?jt.createElement(Vt,{rotate:!0}):null,a===na.NAME_DESC?jt.createElement(Vt,null):null),jt.createElement(ca,{onClick:this.sortByDuration},"Duration",a===na.DURATION_ASC?jt.createElement(Vt,{rotate:!0}):null,a===na.DURATION_DESC?jt.createElement(Vt,null):null),jt.createElement(la,null,"Tags"),jt.createElement(ca,{onClick:this.sortByBPM},"BPM",a===na.BPM_ASC?jt.createElement(Vt,{rotate:!0}):null,a===na.BPM_DESC?jt.createElement(Vt,null):null),jt.createElement(ca,null,"Time Signature"),jt.createElement(la,{onClick:this.sortByRating},"Rating",a===na.RATING_ASC?jt.createElement(Vt,{rotate:!0}):null,a===na.RATING_DESC?jt.createElement(Vt,null):null),jt.createElement(la,null)))}componentDidMount(){ea.trackScreen("home"),null!==this.props._dataToMigrate&&this.props.dispatch(Xt(this.props._dataToMigrate,this.props._winBackup)),this.listenFilesUpdate(),this.props.dispatch(Zt(!0)),this.props.location.hash&&this.scrollToFile(this.props.location.hash)}componentDidUpdate(e){e.files!==this.props.files&&Qt.end("search"),e.location.hash!==this.props.location.hash&&this.scrollToFile(this.props.location.hash)}componentWillUnmount(){this.props.dispatch(Zt(!1)),this.props.dispatch(Yt()),this.removeFileListener()}render(){const{files:e,filesCount:t,pending:a,selectedFile:n}=this.props,i=`\n            padding-bottom: ${n?"70px":0};\n        `;return jt.createElement(Gt,{stickyHeader:this.renderStickyHeader(),wrapperStyle:i,scrollElementRef:this.listRef},a?jt.createElement(Nt.a,null):jt.createElement(jt.Fragment,null,t?jt.createElement(jt.Fragment,null,e.length?e.map(e=>jt.createElement(xt,{file:e,key:e.hashPath,onTagClick:this.onTagClick,selected:n&&n.hashPath===e.hashPath})):jt.createElement(oa,null,"No files are matching your search"),jt.createElement(ia,null,"+ Drag and drop a file to add it to your library")):jt.createElement(Lt,null)))}},$t(It,"propTypes",{_dataToMigrate:Bt.object,dispatch:Bt.func,files:Bt.array,filesCount:Bt.number,selectedFile:Bt.any,sortRule:Bt.string}),Ot=Mt))||Ot;const da=o.default.path`
    fill: ${y.colors._white};
`;var ua=()=>i.a.createElement("div",{style:{display:"none"}},i.a.createElement("svg",null,i.a.createElement("symbol",{id:"playIcon",viewBox:"0 0 32 32"},i.a.createElement(da,{d:"M27.944 14.237c.18.1.316.2.436.314.143.138.267.297.368.48.027.046.05.094.073.142.124.275.18.553.18.828 0 .275-.056.553-.174.817-.092.205-.22.396-.378.563-.148.156-.32.285-.504.383L9.97 27.748c-.964.537-2.182.19-2.718-.777C6.998 26.516 7 25.24 7 25V6c0-1.1.826-1.932 1.87-1.996.107-.007.213-.006.32.005.364.03.7.158.98.352l17.774 9.875z"}))));const ha=o.default.svg`
    width: 225px;
    height: 41px;
    path {
        fill: ${y.colors._white};
...
`,Ra=o.default.div`
    ...
    justify-content: center;
    align-items: center;
`;var Fa=({centered:e,children:t,first:a=!1,icon:n,isNaked:s,onClick:r})=>i.a.createElement(Aa,{onClick:r,first:a,centered:!!e,isNaked:!!s},n?i.a.createElement(Ra,null,n):null,t);const ka=o.default.a`
    ${wa}
    ${e=>e.centered?"text-align: center;":""}
    display: block;
    text-decoration: none;
    ...
    ${e=>e.isNaked?"border: none;":""}
`,Da=({centered:e,icon:t,isNaked:a,text:n,...s})=>i.a.createElement(ka,xa({},s,{centered:!!e,isNaked:!!a}),t?i.a.createElement(Ra,null,t):null,n);function Pa(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const La=a(66),{removeFile:Oa,replaceFile:Ia}=a(19),{addNotification:Ma}=a(77),{importFiles:Na}=a(57),Ua=a(13),{checkFiles:$a}=a(21),ja=a(3),Ha=o.default.div`
    margin-top: 20px;
    padding: 50px;
    text-align: center;
    border: 5px dashed ${e=>e.dragging?ja.colors.blueLight:ja.colors._blue};
    transition: border-color ease 0.2s;
`,Ba=o.default.div`
    margin-bottom: 20px;
    font-weight: 600;
`;var za,Va=Object(s.connect)((e,t)=>({file:Object(Ut.selectFileByHashPath)(e,{fileHashPath:t.fileHashPath}),files:Object(Ut._selectFiles)(e),missingFiles:e.files.missingFiles}))(class extends i.a.Component{constructor(...e){super(...e),Pa(this,"dropRef",i.a.createRef()),Pa(this,"removeDrag",void 0),Pa(this,"state",{dragging:!1,replace:!1}),Pa(this,"checkFileAccess",()=>{$a(this.props.files)}),Pa(this,"onClickReplace",()=>{this.setState({replace:!0})}),Pa(this,"removeFile",()=>{this.props.close(),this.props.dispatch(Oa(this.props.file.hashPath))}),Pa(this,"replaceFile",e=>{Na(this.props.dispatch,e.slice(0,1),e=>{const t=e[Object.keys(e)[0]];t&&(this.props.close(),this.props.dispatch(Ia(this.props.file.hashPath,t)))})})}componentDidMount(){Ua.trackScreen("modalFileMissing")}componentDidUpdate(e,t){!t.replace&&this.state.replace&&(this.removeDrag=La(this.dropRef.current,{onDrop:this.replaceFile,onDragOver:()=>{this.setState({dragging:!0})},onDragLeave:()=>{this.setState({dragging:!1})}})),e.missingFiles.includes(e.file.hashPath)&&!this.props.missingFiles.includes(this.props.file.hashPath)&&(this.props.dispatch(Ma("File successfully located")),this.props.close())}componentWillUmount(){this.removeDrag&&this.removeDrag()}render(){const{file:e}=this.props,{dragging:t,replace:a}=this.state;return i.a.createElement("div",null,i.a.createElement(Ba,null,"We could not locate the file ",e.name),a?i.a.createElement(Ha,{ref:this.dropRef,dragging:t},"Drag and drop the file here to replace it"):i.a.createElement("div",null,i.a.createElement(Fa,{onClick:this.checkFileAccess},"Check again"),i.a.createElement(Fa,{onClick:this.onClickReplace},"Replace it"),i.a.createElement(Fa,{onClick:this.removeFile},"Remove it from my riff library")))}}),Ga=a(29),Wa=a(19),Ka=a(24),Ya=a(50);function Xa(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const{openInFinder:qa}=a(21),Ja=a(13),{selectFileByHashPath:Za}=a(14),{selectUser:Qa}=a(30),{modals:en}=a(3),tn=o.default.div`
    width: 360px;
`;var an=Object(s.connect)((e,t)=>({file:Za(e,{fileHashPath:t.file.hashPath}),missingFiles:e.files.missingFiles,user:Qa(e)}))(za=class extends i.a.Component{constructor(...e){super(...e),Xa(this,"state",{downloadUrl:"",uploadError:!1,uploading:!1,uploadProgress:0,uploadSuccess:!1}),Xa(this,"openInFinder",()=>{qa(this.props.file.path),Ja.trackEvent("file","open-in-finder"),this.props.close()}),Xa(this,"toggleFileArchive",()=>{ot.a.updateFile(this.props.user,this.props.file.hashPath,{archived:!this.props.file.archived}),Ja.trackEvent("file",this.props.file.archived?"unarchive":"archive"),this.props.close()}),Xa(this,"removeFile",()=>{this.props.close(),this.props.dispatch(Object(Wa.removeFile)(this.props.file.hashPath))}),Xa(this,"onUploadProgress",e=>{this.setState({uploadProgress:e})}),Xa(this,"onUploadError",e=>{console.error("Error uploading",e),this.setState({uploadError:!0,uploading:!1})}),Xa(this,"onUploadSuccess",({uploadName:e})=>{this.setState({uploading:!1,uploadSuccess:!0}),console.log("## success"),ot.a.updateFile(this.props.user,this.props.file.hashPath,{uploaded:!0,uploadName:e}),this.setDownloadUrl()}),Xa(this,"onUploadRunning",()=>{this.setState({uploading:!0})}),Xa(this,"handleUploadFile",()=>{if(this.props.file.uploaded)ot.a.deleteFile(this.props.user,this.props.file).then(()=>{console.log("### deleted"),ot.a.updateFile(this.props.user,this.props.file.hashPath,{uploaded:!1,uploadName:null})}).catch(e=>{console.log("#### error deleting"),console.log(e)});else{if(!Object(Ga.canUpload)(this.props.user))return void this.props.dispatch(Object(Ka.openModal)(en.forbiddenAction,{type:Ya.a.UPLOAD_FILE}));fetch(this.props.file.escapedPath).then(e=>e.blob()).then(e=>{ot.a.uploadFile(this.props.user,this.props.file,e,{onError:this.onUploadError,onProgress:this.onUploadProgress,onRunning:this.onUploadRunning,onSuccess:this.onUploadSuccess})})}}),Xa(this,"openPublicLinkModal",()=>{this.props.dispatch(Object(Ka.openModal)(en.publicLink,{file:this.props.file}))})}setDownloadUrl(){ot.a.getFileDownloadUrl(this.props.user,this.props.file).then(e=>this.setState({downloadUrl:e}))}renderUploadButton(){const{uploadError:e,uploading:t,uploadProgress:a}=this.state;return t?i.a.createElement("span",null,"Uploading... ",a.toFixed(0),"%"):e?i.a.createElement("span",null,"Error uploading"):this.props.file.uploaded?"Remove file from cloud":"Upload file"}componentDidMount(){Ja.trackScreen("modalFileOptions"),this.props.file.uploaded&&this.setDownloadUrl()}render(){const{file:e,missingFiles:t,user:a}=this.props,{downloadUrl:n}=this.state,s=t.includes(e.hashPath),r=window.__songRiffer.platform;return i.a.createElement(tn,null,i.a.createElement(fa,null,e.name),Object(Ga.hasUpload)(a)?s&&!e.uploaded?null:i.a.createElement(Fa,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"md-cloud-upload"}),onClick:this.handleUploadFile,first:!0,isNaked:!0},this.renderUploadButton()):null,e.uploaded?i.a.createElement(Fa,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"md-share"}),onClick:this.openPublicLinkModal,isNaked:!0},"Share"):null,e.uploaded?i.a.createElement(Da,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"md-cloud-download"}),href:n,download:"download",text:"Download",isNaked:!0}):null,s?null:i.a.createElement(Fa,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"ios-folder-open"}),onClick:this.openInFinder,isNaked:!0},"Open in ","darwin"===r?"Finder":"File Explorer"),i.a.createElement(Fa,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"ios-archive"}),onClick:this.toggleFileArchive,isNaked:!0},e.archived?"Unarchive":"Archive"," file"),i.a.createElement(Fa,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"md-trash"}),onClick:this.removeFile,isNaked:!0},"Remove from my riff library"))}})||za;const nn={margin:"auto",background:"none",display:"block"};var sn,rn=({size:e=100})=>i.a.createElement("svg",{style:nn,width:`${e}px`,height:`${e}px`,viewBox:"0 0 100 100",preserveAspectRatio:"xMidYMid"},i.a.createElement("circle",{cx:"50",cy:"50",fill:"none",stroke:y.colors.blueLight,strokeWidth:"3",r:"29",strokeDasharray:"136.659280431156 47.553093477052",transform:"rotate(194.885 50 50)"},i.a.createElement("animateTransform",{attributeName:"transform",type:"rotate",repeatCount:"indefinite",dur:"1.1235955056179776s",values:"0 50 50;360 50 50",keyTimes:"0;1"}))),on=a(38),ln=a.n(on),cn=a(21);function pn(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const dn=a(107),{selectFileByHashPath:un}=a(14),{selectUser:hn}=a(30),mn=a(13),gn=a(31),fn=o.default.div`
    width: 360px;
`;var En=Object(s.connect)((e,t)=>({file:un(e,{fileHashPath:t.file.hashPath}),user:hn(e)}))(sn=class extends i.a.Component{constructor(...e){super(...e),pn(this,"state",{copied:!1,loading:!1}),pn(this,"createPublicLink",()=>{this.setState({loading:!0}),mn.trackEvent("share","create-link"),gn("Share link created"),ot.a.createFilePublicId(this.props.file.hashPath).then(e=>{this.setState({loading:!1})}).catch(e=>{console.error(e),this.setState({loading:!1})})}),pn(this,"copyLink",()=>{mn.trackEvent("share","copy-link"),gn("Share link copied");const e=Object(fe.getShareLink)(this.props.user.uid,this.props.file.publicId);Object(cn.copyToClipboard)(e),this.setState({copied:!0})}),pn(this,"disableLink",()=>{mn.trackEvent("share","disable-link"),this.setState({loading:!0}),ot.a.deleteFilePublicId(this.props.file.hashPath).then(e=>{this.setState({loading:!1}),console.log(e)}).catch(e=>{this.setState({loading:!1}),console.error(e)})})}componentDidMount(){mn.trackScreen("modalPublicLink")}render(){const{file:e}=this.props,{copied:t,loading:a}=this.state;return i.a.createElement(fn,null,i.a.createElement(fa,null,"Share a link to this file"),i.a.createElement(ln.a,{size:"md"},"Everyone who will have the link created will be able to listen to your file but won't be able to edit it."),a?i.a.createElement(rn,{size:50}):e.public&&e.publicId?i.a.createElement(i.a.Fragment,null,i.a.createElement(Fa,{first:!0,icon:i.a.createElement(Ae,{font:Ce.MaterialCommunityIcons,name:"content-copy"}),isNaked:!0,onClick:this.copyLink},t?i.a.createElement(i.a.Fragment,null,"Copied to clipboard ",i.a.createElement(dn,{width:"15"})):i.a.createElement(i.a.Fragment,null,"Copy Link")),i.a.createElement(Fa,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"md-trash"}),isNaked:!0,onClick:this.disableLink},"Disable link")):i.a.createElement(Fa,{onClick:this.createPublicLink,first:!0,isNaked:!0},"Create public link"))}})||sn,vn=a(17);function bn(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const yn=a(51),{removeFile:Tn}=a(19),{selectFileByHashPath:Sn}=a(14),{unlinkFile:_n}=a(21),xn=a(13),Cn=a(3),wn=o.default.div`
    max-width: 300px;
`,An=o.default.div`
    margin-bottom: 25px;
    font-size: 16px;
    line-height: 1.4;
`,Rn=o.default.span`
    color: ${Cn.colors.bluePastel};
`,Fn=o.default.div`
    display: flex;
    justify-content: space-between;
`,kn=Object(o.default)(yn)`
    padding: 10px 25px;
`;var Dn=Object(s.connect)((e,t)=>({file:Sn(e,{fileHashPath:t.fileHashPath})}))(class extends i.a.Component{constructor(...e){super(...e),bn(this,"removeFile",()=>{this.props.close(),this.props.dispatch(Tn(this.props.file.hashPath,!0))}),bn(this,"deleteFile",()=>{this.props.close(),this.props.dispatch(Tn(this.props.file.hashPath,!0)),_n(this.props.file.path),xn.trackEvent("file","delete-file",this.props.file.source)})}componentDidMount(){xn.trackScreen("modalRemoveFile")}render(){const{file:e}=this.props;let t;return e.source===vn.b.RECORD&&(t="recorded with the Recorder"),e.source===vn.b.TRANSFER&&(t="transfered from your phone"),i.a.createElement(wn,null,i.a.createElement(An,null,i.a.createElement(Rn,null,e.name)," was ",t,". Do you want to delete the file as well as remove it from your library?"),i.a.createElement(Fn,null,i.a.createElement(kn,{onClick:this.removeFile},"No"),i.a.createElement(kn,{onClick:this.deleteFile},"Yes")))}}),Pn=a(138),Ln=a(25),On=a.n(Ln);var In;!function(e){e["16th"]="16",e["32nd"]="32",e["64th"]="64",e.Eighth="8",e.Half="h",e.Quarter="q",e.Whole="w"}(In||(In={}));const Mn={8:1/8,16:1/16,32:1/32,64:1/64,h:.5,q:.25,w:1},Nn=e=>1/(e/2*3),Un={8:Nn(8),16:Nn(16),32:Nn(32),64:Nn(64),h:Nn(2),q:Nn(4),w:Nn(1)},$n=(e,t,a)=>{let n=null;for(const t of e[0].Beat){if(t.Notes.includes(a)){n=t;break}if(t.Notes[0].split(" ").includes(a)){n=t;break}}return((e,t)=>{const a=On()(e,"[0].Rhythm",[]),n=On()(t,"Rhythm[0]['$'].ref");return a.find(e=>e.$.id===n)})(t,n)},jn=e=>[`tabstave notation=true\ntime=${e}\n`],Hn=e=>{const t=Kn(e);return[`${jn(t)}  notes`]},Bn=e=>{const t=[],{GPIF:{Beats:a,Notes:n,Rhythms:i}}=e,s=n[0].Note,r=s.length;let o=Hn(e),l=null,c=0,p=0,d=1;return s.forEach((n,s)=>{let u="";const h=n.$.id,m=(e=>{const t=On()(e,"Properties[0].Property",[]),a={};return t.forEach(e=>{e.Fret&&(a.fret=e.Fret[0]),e.String&&(a.string=6-e.String[0])}),a})(n),g=$n(a,i,h),{noteValue:f,isTuplet:E}=(e=>{const t=On()(e,"NoteValue[0]"),a=In[t],n=On()(e,"PrimaryTuplet[0]");return a||console.log("# undefined note map ",t),{noteValue:a,isTuplet:!!n}})(g);p+=E?Un[f]:Mn[f],f!==l&&(l=f,u+=`:${f} `),u+=`${m.fret}/${m.string} `,E&&3===++c&&(u+="^3^ ",c=0),p>=1&&r-1!==s&&(u+="|",p=0,d+=1,c=0),o.push(u),5===d&&(t.push(zn(o)),o=Hn(e),d=1,l=null)}),t.push(zn(o)),t},zn=e=>e.join(" "),Vn=e=>{const t=Object.keys(e);return t.length?`options ${t.map(t=>`${t}=${e[t]}`).join(" ")}\n`:""},Gn=e=>{const t=e.GPIF.Score[0],a={album:"",artist:"",title:""};return["Album","Artist","Title"].forEach(e=>{a[e.toLowerCase()]=t[e]?t[e][0]:""}),a},Wn=e=>{return e.GPIF.Tracks[0].Track.map(e=>({name:On()(e,"Name[0]","").trim(),tuning:On()(e,"Staves[0].Staff[0].Properties[0].Name[0]","").trim()}))},Kn=e=>{return e.GPIF.MasterBars[0].MasterBar[0].Time[0]};var Yn;function Xn(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const qn=a(185),Jn=qn.VexTab,Zn=qn.Artist,Qn=qn.Flow.Renderer;Zn.NOLOGO=!0;const ei=a(53),ti=(a(38),a(21)),ai=a(13),ni=a(31),ii=o.default.div`
    display: flex;
    flex-direction: column;
    justify-content: center;
    align-items: center;
...
`;var di=Object(s.connect)((e,t)=>({file:t.file,mxml:e.mxml}))(Yn=class extends i.a.Component{constructor(...e){super(...e),Xn(this,"state",{error:!1,infos:{album:"",artist:"",title:""},loading:!0,tracks:[]}),Xn(this,"scoreRef",i.a.createRef())}async displayScore(e){const t=new Qn(this.scoreRef.current,Qn.Backends.SVG),a=new Zn(10,10,600,{scale:.8}),n=new Jn(a);try{((e,t={options:{}})=>new Promise((a,n)=>{Object(Pn.parseString)(e,(e,i)=>{if(e)return console.error(e),void n(e);const s=Bn(i);a({firstTimeSignature:Kn(i),getFullNotation:()=>s.join("\n").trim(),infos:Gn(i),options:Vn(t.options),notations:s,tracks:Wn(i)})})}))(e,{options:{width:1100}}).then(e=>{this.setState({loading:!1,infos:e.infos,tracks:e.tracks}),n.parse(e.getFullNotation()),a.render(t)})}catch(e){ni(`Error parsing guitar pro file - ${e.toString()}`),this.setState({error:!0})}}componentDidMount(){ai.trackScreen("modalTabs"),this.props.mxml.mxml&&this.props.mxml.filePath===this.props.file.path||ti.getMXML(this.props.file.path),this.props.mxml.filePath===this.props.file.path&&this.props.mxml.mxml&&setTimeout(()=>{this.displayScore(this.props.mxml.mxml)},0)}componentDidUpdate(e){e.mxml.mxml!==this.props.mxml.mxml&&this.displayScore(this.props.mxml.mxml)}render(){const{error:e,infos:t,loading:a,tracks:n}=this.state;return e?i.a.createElement(ii,null,i.a.createElement(si,null,"It looks like something went wrong, sorry about that!"),i.a.createElement(si,null,"Support for Guitar Pro files is in beta so it may break anytime (like right now)."),i.a.createElement(si,null,"Feel free to contact us at ",i.a.createElement(ei,{href:`mailto:${y.email}`},y.email)," so we can see how we can improve it.")):i.a.createElement(ii,null,a?i.a.createElement(rn,{size:50}):i.a.createElement(i.a.Fragment,null,i.a.createElement(ri,null,i.a.createElement(oi,null,t.title),i.a.createElement(li,null,t.artist),i.a.createElement("div",null,t.album)),n.length?i.a.createElement(ci,null,i.a.createElement("div",null,n[0].name),i.a.createElement("div",null,n[0].tuning)):null),i.a.createElement(pi,{ref:this.scoreRef,loading:a}))}})||Yn,ui=a(44);function hi(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const mi=o.default.div`
    width: 650px;
`,gi="\n    display: flex;\n    flex-wrap: wrap;\n\n    > * {\n        margin-bottom: 15px;\n    }\n";var fi=Object(s.connect)((e,t)=>({file:Object(Ut.selectFileByHashPath)(e,{fileHashPath:t.fileHashPath})}))(class extends i.a.Component{constructor(...e){super(...e),hi(this,"addTag",e=>{this.props.dispatch(Object(Wa.addTag)(this.props.file.hashPath,e))}),hi(this,"onTagClick",()=>{}),hi(this,"onTagContextMenu",(e,t,a)=>{this.props.dispatch(Object(ui.displayTagContextMenu)(this.props.file.hashPath,e,t,a))}),hi(this,"removeTag",e=>{this.props.dispatch(Object(Wa.removeTag)(this.props.file.hashPath,e))})}render(){const{file:e}=this.props;return i.a.createElement(mi,null,i.a.createElement(fa,null,"Tags for ",e.name),i.a.createElement(Qe,{addTag:this.addTag,onTagClick:this.onTagClick,onTagContextMenu:this.onTagContextMenu,removeTag:this.removeTag,rootStyle:gi,tags:e.getTags()}))}});function Ei(){return(Ei=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e}).apply(this,arguments)}function vi(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const bi=a(184),yi=a(211),Ti=a(212),Si=o.default.div`
    display: flex;
    position: fixed;
    top: 0;
    left: 0;
...
`;var Ci=Object(s.connect)(e=>({modal:e.modal}))(class extends i.a.Component{constructor(...e){super(...e),vi(this,"dimmerRef",i.a.createRef()),vi(this,"onDimmerClick",e=>{e.target===this.dimmerRef.current&&this.props.dispatch(Object(Ka.closeModal)())}),vi(this,"close",()=>{this.props.dispatch(Object(Ka.closeModal)())})}getModal(){const{name:e}=this.props.modal,t={[y.modals.comment]:_a,[y.modals.fileMissing]:Va,[y.modals.fileOptions]:an,[y.modals.forbiddenAction]:Ya.b,[y.modals.invalidFile]:bi,[y.modals.publicLink]:En,[y.modals.removeFile]:Dn,[y.modals.tabs]:di,[y.modals.tags]:fi,[y.modals.text]:yi,[y.modals.updateAvailable]:Ti};if(!t[e])return null;const a=t[e];return i.a.createElement(a,Ei({},this.props.modal.props,{close:this.close}))}getRootStyle(){const{name:e}=this.props.modal;switch(e){case y.modals.updateAvailable:return Ti.rootStyle;default:return""}}render(){const{modal:e}=this.props;if(!e.name)return null;const t=e.name===y.modals.updateAvailable&&e.props.mandatory;return i.a.createElement(Si,{onClick:this.onDimmerClick,ref:this.dimmerRef,darker:t},i.a.createElement(_i,{additionalStyle:this.getRootStyle()},this.getModal(),t?null:i.a.createElement(xi,null,i.a.createElement(Ae,{font:Ce.Ionicons,name:"md-close",onClick:this.close}))))}});function wi(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const{removeNotification:Ai}=a(77),Ri=o.default.div`
    position: fixed;
    padding: 10px 25px;
...
`;var Fi=Object(s.connect)(e=>({notification:e.notifications.notification}))(class extends i.a.Component{constructor(...e){super(...e),wi(this,"timeout",void 0),wi(this,"close",()=>{this.props.dispatch(Ai())}),wi(this,"onClick",()=>{"function"==typeof this.props.notification.onClick&&this.props.dispatch(this.props.notification.onClick())}),wi(this,"onMouseEnter",()=>{this.props.notification.onClick&&this.clearTimeout()}),wi(this,"onMouseLeave",()=>{this.props.notification.onClick&&this.startTimeout()})}startTimeout(){clearTimeout(this.timeout),this.timeout=setTimeout(this.close,this.props.notification.timeout||3e3)}clearTimeout(){clearTimeout(this.timeout)}componentDidMount(){void 0!==this.props.notification.id&&this.startTimeout()}componentDidUpdate(e){e.notification.id!==this.props.notification.id&&this.startTimeout()}componentWillUmount(){this.clearTimeout()}render(){const{notification:e}=this.props;return i.a.createElement(Ri,{active:e.active,status:e?e.status:null,hasClickAction:"function"==typeof this.props.notification.onClick,onClick:this.onClick,onMouseEnter:this.onMouseEnter,onMouseLeave:this.onMouseLeave},e?e.title:null)}}),ki=a(36),Di=a(69),Pi=a(66),Li=a.n(Pi);const Oi=o.default.div`
    display: flex;
    align-items: center;
    height: 35px;
    margin-bottom: 7px;
...
`,Ii=o.default.div`
    flex: 1;
    padding: 7px;
`;var Mi=({song:e})=>n.createElement(Oi,null,e.position," • ",n.createElement(Ii,null,e.name));const Ni=o.default.div`
    display: grid;
...
`,Yi=o.default.div`
    ...
    height: 100%;
    padding: 0 10px;
`;var Xi=Object(s.connect)()(class extends n.Component{constructor(...e){super(...e),ji(this,"removeDragDrop",void 0),ji(this,"removeListener",void 0),ji(this,"state",{dragging:!1,newSongName:"",project:null}),ji(this,"onChangeNewSongName",e=>{this.setState({newSongName:e.target.value})}),ji(this,"addNewSong",e=>{if(e.preventDefault(),!this.state.newSongName.length)return;const t=On()(this.state.project,"songs",[]).length;ot.a.addSongToProject(this.state.project.id,{position:t,name:this.state.newSongName,files:[]}),this.setState({newSongName:""})}),ji(this,"importFiles",e=>{console.log("import files",e),Object($i.importFiles)(this.props.dispatch,e,e=>{ot.a.addFilesToProject(this.state.project.id,Object.values(e))},!0)})}listenProjectUpdate(){this.removeListener=ot.a.listenForProjectUpdate(this.props.match.params.projectId,e=>{this.setState({project:e})})}componentDidMount(){this.listenProjectUpdate(),this.removeDragDrop=Li()(document.body,{onDrop:this.importFiles,onDragOver:()=>{this.setState({dragging:!0})},onDragLeave:()=>{this.setState({dragging:!1})}})}componentWillUnmount(){"function"==typeof this.removeListener&&this.removeListener(),"function"==typeof this.removeDragDrop&&this.removeDragDrop()}renderHeader(){const{project:e}=this.state;return n.createElement(Bi,null,n.createElement(zi,null,n.createElement(ki.a,{to:y.routes.projects},n.createElement(Ae,{font:Ce.Ionicons,name:"ios-arrow-back",style:{marginRight:10}}),"Projects")),n.createElement(Vi,null,n.createElement(Wi,null,e.name),n.createElement(Gi,null,"Last updated: ",Object(Di.a)(e.updatedAt,{addSuffix:!0}))))}render(){const{project:e}=this.state;return e?n.createElement(Hi,{stickyHeader:this.renderHeader()},n.createElement(Ki,null,n.createElement(Yi,null,n.createElement(Wi,null,"Songs"),e.songs&&e.songs.length?n.createElement("div",null,e.songs.map(e=>n.createElement(Mi,{song:e,key:`song-${e.position}`}))):n.createElement("div",null,"Add the first song to your project:"),n.createElement("form",{onSubmit:this.addNewSong},n.createElement("input",{type:"text",value:this.state.newSongName,onChange:this.onChangeNewSongName}))),n.createElement(Yi,null,n.createElement(Wi,null,"Files"),n.createElement(Ui,{files:e.files})))):n.createElement(Hi,null,n.createElement(Nt.a,null))}}),qi=a(98);const Ji=a(0),Zi=a(4).default,{colors:Qi}=a(3),es=Zi.svg`
    fill: ${Qi._white};
    opacity: 0.7;
    cursor: pointer;
...
`;var ts=()=>Ji.createElement(es,{version:"1.1",xmlns:"http://www.w3.org/2000/svg",width:"30",height:"30"},Ji.createElement("path",{d:"M5 6.005c0-1.107 0.887-2.005 1.998-2.005h4.004c1.104 0 1.998 0.897 1.998 2.005v19.99c0 1.107-0.887 2.005-1.998 2.005h-4.004c-1.104 0-1.998-0.897-1.998-2.005v-19.99zM19 6.005c0-1.107 0.887-2.005 1.998-2.005h4.004c1.104 0 1.998 0.897 1.998 2.005v19.99c0 1.107-0.887 2.005-1.998 2.005h-4.004c-1.104 0-1.998-0.897-1.998-2.005v-19.99z"}));const as=a(0),ns=a(4).default,{colors:is}=a(3),ss=ns.svg`
    fill: ${is._white};
    opacity: 0.7;
    cursor: pointer;
...
`;var rs,os=()=>as.createElement(ss,{viewBox:"0 0 32 32",xmlns:"http://www.w3.org/2000/svg",width:"30",height:"30"},as.createElement("path",{d:"M27.944 14.237c.18.1.316.2.436.314.143.138.267.297.368.48.027.046.05.094.073.142.124.275.18.553.18.828 0 .275-.056.553-.174.817-.092.205-.22.396-.378.563-.148.156-.32.285-.504.383L9.97 27.748c-.964.537-2.182.19-2.718-.777C6.998 26.516 7 25.24 7 25V6c0-1.1.826-1.932 1.87-1.996.107-.007.213-.006.32.005.364.03.7.158.98.352l17.774 9.875z"}));function ls(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const cs=a(214),ps=a(51),ds=a(107),us=a(52),hs=a(59),{addFiles:ms}=(a(38),a(19)),{reset:gs}=a(124),{pausePlayer:fs}=a(56),Es=a(13),{getFilesDurationAndBPM:vs}=a(57),{checkFileExists:bs,saveMedia:ys}=a(21),Ts=o.default.div`
    display: flex;
    position: absolute;
    width: 100%;
    height: 100%;
...
`,Ls=o.default.div`
    ...
    width: 100%;
    justify-content: center;
`;var Os=Object(s.connect)(e=>({recorder:e.recorder}))(rs=class extends i.a.Component{constructor(...e){super(...e),ls(this,"chunks",void 0),ls(this,"stream",void 0),ls(this,"state",{audio:null,fileDuration:0,fileSize:0,name:"",playing:!1,recording:!1}),ls(this,"recorder",null),ls(this,"inputRef",i.a.createRef()),ls(this,"player",i.a.createRef()),ls(this,"recordButton",i.a.createRef()),ls(this,"toggleRecording",()=>{this.state.recording?this.stopRecording():this.startRecording()}),ls(this,"startRecording",()=>{this.props.dispatch(fs(!0)),Es.trackEvent("recorder","start-recording"),this.setState({recording:!0}),this.getAudio()}),ls(this,"pad",e=>1===`${e}`.length?`0${e}`:`${e}`),ls(this,"stopRecording",()=>{Es.trackEvent("recorder","stop-recording");const{day:e,hours:t,minutes:a,month:n,seconds:i,year:s}=this.getDate();this.setState({name:`SongRiffer-idea-${s}-${n}-${e}-${t}${a}${i}`}),null!==this.recorder&&this.recorder.stop()}),ls(this,"onDataAvailable",e=>{this.chunks.push(e.data)}),ls(this,"onRecorderStop",()=>{const e=new Blob(this.chunks,{type:"audio/webm;codecs=opus"});this.setState({audio:URL.createObjectURL(e),recording:!1}),this.inputRef.current.focus()}),ls(this,"recordAudio",e=>{this.recorder=new MediaRecorder(e),this.chunks=[],this.recorder.ondataavailable=this.onDataAvailable,this.recorder.onstop=this.onRecorderStop,this.recorder.start()}),ls(this,"onNameChange",e=>{this.setState({name:e.target.value}),bs(`${e.target.value}.wav`)}),ls(this,"onNameKeyDown",e=>{"Enter"===e.key&&this.save()}),ls(this,"save",()=>{const e=new AudioContext,t=new Blob(this.chunks,{type:"audio/webm"}),a=new FileReader;this.state.name;a.onload=()=>{e.decodeAudioData(a.result,e=>{const t=cs(e);this.setState({fileDuration:parseInt(e.duration,10),fileSize:t.byteLength}),ys(y.saveTypes.RECORDER,`${this.state.name}.wav`,new Uint8Array(t))})},a.readAsArrayBuffer(t)}),ls(this,"importFile",()=>{Es.trackEvent("recorder","save",this.state.name),Es.trackEvent("file","file-import","recorder",1);const e=`${this.state.name}.wav`,t=this.props.recorder.filePath,a={duration:this.state.fileDuration,name:e,path:t,size:this.state.fileSize,source:vn.b.RECORD,type:"audio/wav"},n=new At.a(a);this.props.dispatch(ms({[Object(fe.getFilePathHash)(t)]:n.toJSON()},!0)),vs(this.props.dispatch,[n])}),ls(this,"reset",()=>{this.chunks=[],this.setState({audio:null,playing:!1}),this.pausePlayer(),Es.trackEvent("recorder","discard")}),ls(this,"togglePlay",()=>{this.setState({playing:!this.state.playing},()=>{this.state.playing?this.playPlayer():this.pausePlayer()})})}getDate(){const e=new Date;return{day:this.pad(e.getDate()),hours:e.getHours(),minutes:e.getMinutes(),month:this.pad(e.getMonth()+1),seconds:e.getSeconds(),year:e.getFullYear()}}getAudio(){navigator.mediaDevices.getUserMedia({audio:!0,video:!1}).then(this.recordAudio)}playPlayer(){this.player.current.play()}pausePlayer(){this.player.current.pause()}componentDidMount(){Es.trackScreen("record")}componentDidUpdate(e){!e.recorder.saveSuccess&&this.props.recorder.saveSuccess&&this.importFile()}componentWillUnmount(){this.props.dispatch(gs())}render(){const{recorder:e}=this.props,{audio:t,name:a,playing:n,recording:s}=this.state,r=!!e.fileAlreadyExists&&Object(qi.basename)(e.fileAlreadyExists,Object(fe.extname)(e.fileAlreadyExists))===a;return i.a.createElement(hs,{wrapperStyle:"\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    align-items: center;\n    height: 100%;\n    padding: 50px;\n    overflow: hidden;\n"},i.a.createElement(Ts,{recording:s||!t},i.a.createElement(Ss,null,i.a.createElement(_s,{onClick:this.toggleRecording,recording:s,ref:this.recordButton},s?"Stop":"Record"),s?i.a.createElement(xs,null):null)),i.a.createElement(Cs,{recording:s||!t},e.saveSuccess?i.a.createElement(Ds,null,i.a.createElement(ds,{width:"50"}),i.a.createElement(Ps,null,a," was successfully added to your library!"),i.a.createElement(Ls,null,i.a.createElement(ki.a,{to:y.routes.home},i.a.createElement(ks,null,"Go back to your file list")))):i.a.createElement(i.a.Fragment,null,i.a.createElement("div",null,i.a.createElement("audio",{src:t,ref:this.player}),i.a.createElement("div",{onClick:this.togglePlay},n?i.a.createElement(ts,null):i.a.createElement(os,null))),i.a.createElement(ws,null,i.a.createElement(Rs,{onChange:this.onNameChange,onKeyDown:this.onNameKeyDown,ref:this.inputRef,type:"text",value:a,error:r}),i.a.createElement(Fs,null,r?"This file already exists, please choose another name":i.a.createElement("span",null," ")),i.a.createElement(As,null,i.a.createElement(ks,{onClick:this.reset,background:y.colors._grey},"Discard"),i.a.createElement(ks,{onClick:this.save,disabled:r},"Save"))))))}})||rs;const Is=o.default.div`
    height: 10px;
    border-radius: 10px;
...
`,Ms=o.default.div`
    width: ${e=>e.width}%;
    height: 10px;
`,Ns=({percentage:e})=>i.a.createElement(Is,null,i.a.createElement(Ms,{width:e,style:{background:e>=90?y.colors.redLight:y.colors.bluePastel}}));function Us(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const $s=a(59),js=a(38),{checkUpdate:Hs}=a(44),{openModal:Bs}=a(24),{signOut:zs}=a(58),{selectUser:Vs}=a(30),Gs=a(13),{formatFileSize:Ws}=a(74),{openLink:Ks,toggleDevTools:Ys}=a(21),Xs=a(3),qs="\n    display: flex;\n    height: 100%;\n    justify-content: space-between;\n    align-items: center;\n",Js=o.default.div`
    width: 50%;
    padding: 0 40px;
`,Zs=o.default.div`
    margin-bottom: 25px;
...
`,er=o.default.div`
    margin-top: 30px;
`;var tr=Object(s.connect)(e=>({enableExperimental:e.application.enableExperimental,updateAvailable:e.application.updateAvailable,user:Vs(e)}))(class extends i.a.Component{constructor(...e){super(...e),Us(this,"state",{storageSize:0,storageSizeLimit:0,storageSizeLoaded:!1}),Us(this,"signOut",()=>{this.props.dispatch(zs())}),Us(this,"checkUpdates",()=>{this.props.dispatch(Hs(!0))})}renderDevMenu(){return i.a.createElement(er,null,i.a.createElement(Zs,null,"Experimental Menu"),i.a.createElement(Fa,{onClick:Ys,first:!0,centered:!0},"Toggle dev tools"))}getUserStorageSize(){return new Promise(async e=>{const{user:t}=this.props;if(void 0!==t.data.storageSize)return e(t.data.storageSize);e(await ot.a.getUserStorageSize(t.uid))})}async fetchStorageSize(){const{user:e}=this.props;if(Object(Ga.hasUpload)(e)){const t=await this.getUserStorageSize(),a=Object(Ga.getUserStorageLimit)(e);this.setState({storageSizeLoaded:!0,storageSize:t,storageSizeLimit:a})}}renderAccount(){if(Object(Ga.hasUpload)(this.props.user)){const{storageSize:e,storageSizeLimit:t,storageSizeLoaded:a}=this.state;if(!a)return i.a.createElement(js,null,i.a.createElement(rn,{size:40}));const n=100*e/t,s=isNaN(n)?0:parseFloat(n.toFixed(2));return i.a.createElement(js,null,i.a.createElement(js,{size:"xs"},"Total storage size used:"),i.a.createElement(js,{size:"xs"},Ws(e)," / ",Ws(t)," (",s,"%)"),i.a.createElement(js,{size:"s"},i.a.createElement(Ns,{percentage:s})),this.renderStorageFullMessage(s))}return null}renderStorageFullMessage(e){if(e<90)return null;const t=e>=100?"Your storage space is full!":"Your storage space is almost full!";return i.a.createElement(js,null,t," Visit ",i.a.createElement("a",{href:"https://songriffer.com"},"to increase your plan and be able to add more files"))}componentDidMount(){Gs.trackScreen("settings"),this.fetchStorageSize()}render(){const{enableExperimental:e,updateAvailable:t,user:a}=this.props;return i.a.createElement($s,{wrapperStyle:qs},i.a.createElement(Js,null,i.a.createElement(Fa,{onClick:this.checkUpdates,first:!0,centered:!0},"Check for updates ",t?i.a.createElement(Qs,null,"•"):null),i.a.createElement(Da,{href:`mailto:${Xs.email}`,centered:!0,text:"Contact Us"}),i.a.createElement(Fa,{onClick:()=>Ks(Xs.facebookUrl),centered:!0},"Follow us on Facebook"),i.a.createElement(Fa,{onClick:()=>Ks(Xs.instagramUrl),centered:!0},"Follow us on Instagram"),i.a.createElement(Fa,{onClick:()=>Ks(Xs.landingUrl),centered:!0},"Visit us songriffer.com"),e&&this.renderDevMenu()),i.a.createElement(Js,null,i.a.createElement(Zs,null,"Hello ",a.email,"!"),this.renderAccount(),i.a.createElement(Fa,{icon:i.a.createElement(Ae,{font:Ce.Ionicons,name:"ios-log-out"}),onClick:this.signOut,first:!0,centered:!0},"Sign out")))}}),ar=a(56);function nr(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const{selectSelectedFile:ir}=a(14),{selectUser:sr}=a(30),{formatDuration:rr}=a(74),or=a(13),lr=a(31),cr=a(215),pr=o.default.div`
    position: fixed;
    width: 100%;
    height: 50px;
...
`;var Dr=xr(e=>{const t=Object(b.a)(e);return{advancedSearchVisible:t.displayAdvanced,search:t}})((yr=br=class extends _r.PureComponent{constructor(...e){super(...e),Sr(this,"search",e=>{this.props.dispatch((e=>(T.start("search"),{type:y.actionTypes.SEARCH_BASIC,term:e}))(e.target.value))}),Sr(this,"toggleAdvanced",()=>{this.props.dispatch(S())})}componentWillUnmount(){this.props.advancedSearchVisible&&this.props.dispatch(S())}render(){const{advancedSearchVisible:e,search:t}=this.props;return _r.createElement(Fr,null,_r.createElement(kr,{type:"text",onChange:this.search,value:t.basicTerm,name:"search",placeholder:"Search",visible:!e,id:"basic-search-input"}),_r.createElement(Rr,{displayAdvanced:e,onClick:this.toggleAdvanced}))}},Sr(br,"propTypes",{advancedSearchVisible:Cr.bool,dispatch:Cr.func,search:Cr.object}),vr=yr))||vr;const Pr=a(145),Lr=a(38),Or=a(217),Ir=o.default.div`
    display: flex;
    flex-direction: column;
    width: 75px;
    padding-right: 15px;
    ...
    margin-right: 15px;
    font-size: 13px;
    border-right: 1px solid ${ce.colors.blueLight};
`,Mr=o.default.div`
    flex: 1;
`,Nr=o.default.div``,Ur=Object(o.default)(ki.a)`
    display: block;
    position: relative;
    text-decoration: none;
    ...
    :after {
        ...
        top: 0;
        left: -15px;
        background: ${ce.colors.blueLight};
...
`,$r=o.default.div`
    ...
    :hover {
        color: ${ce.colors.blueLight};
    }
`;var jr=Object(s.connect)(e=>({enableExperimental:e.application.enableExperimental,selectedFile:Object(Ut.selectSelectedFile)(e),updateAvailable:e.application.updateAvailable}))(class extends i.a.Component{renderItem(e,t){return i.a.createElement(l.b,{path:e,children:({match:a})=>i.a.createElement(Ur,{to:e,isActive:a&&a.isExact},i.a.createElement($r,null,t))})}render(){const{enableExperimental:e,selectedFile:t,updateAvailable:a}=this.props;return i.a.createElement(Ir,{playerOpen:!!t},i.a.createElement(Mr,null,this.renderItem(y.routes.home,i.a.createElement(i.a.Fragment,null,i.a.createElement(Lr,{size:"s"},i.a.createElement(Ae,{font:Ce.Foundation,name:"list",style:{fontSize:28,color:ce.colors.blueLight}})),i.a.createElement("div",null,"Riffs"))),this.renderItem(y.routes.transfer,i.a.createElement(i.a.Fragment,null,i.a.createElement(Lr,{size:"s"},i.a.createElement(Pr,null)),i.a.createElement("div",null,"Mobile Transfer"))),this.renderItem(y.routes.recorder,i.a.createElement(i.a.Fragment,null,i.a.createElement(Lr,{size:"s"},i.a.createElement(Ae,{font:Ce.FontAwesome,name:"circle-thin",style:{fontSize:28,color:ce.colors.blueLight}})),i.a.createElement("div",null,"Recorder"))),this.renderItem(y.routes.stats,i.a.createElement(i.a.Fragment,null,i.a.createElement(Lr,{size:"s"},i.a.createElement(Or,null)),i.a.createElement("div",null,"Stats"))),e?this.renderItem(y.routes.projects,i.a.createElement(i.a.Fragment,null,i.a.createElement(Lr,{size:"s"},i.a.createElement(Ae,{font:Ce.Foundation,name:"list",style:{fontSize:28,color:ce.colors.blueLight}})),i.a.createElement("div",null,"Projects"))):null),i.a.createElement(Nr,null,this.renderItem(y.routes.account,i.a.createElement(i.a.Fragment,null,i.a.createElement(Lr,{size:"s"},i.a.createElement(Ae,{font:Ce.Ionicons,name:"md-person",style:{fontSize:28,color:ce.colors.blueLight}})),a?i.a.createElement("div",null,"Update available"):null))))}});function Hr(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const Br=a(51),zr=a(146),Vr=a(31),Gr=a(3),Wr=o.default.div`
    margin-bottom: 25px;
...
`;var Zr;!function(e){e["auth/user-not-found"]="We could not find your account, please check your information or create a new account.",e["auth/wrong-password"]="Invalid password.",e["sr/password-mismatch"]="Your confirmation and your password must match"}(Zr||(Zr={}));var Qr=class extends i.a.Component{constructor(...e){super(...e),Hr(this,"state",{authForm:"signin",confirmPassword:"",email:"",error:null,password:"",pending:!1,renderPasswordForgotten:!1,resetEmailSent:!1}),Hr(this,"_mounted",!0),Hr(this,"emailInputRef",i.a.createRef()),Hr(this,"signIn",e=>{e.preventDefault(),this.setState({pending:!0}),ot.a.signInWithEmailPassword(this.state.email,this.state.password).then(()=>{this._mounted&&this.setState({email:"",password:"",pending:!1})}).catch(e=>{this.setState({error:Zr[e.code]?Zr[e.code]:e.message,pending:!1})})}),Hr(this,"signUp",e=>{e.preventDefault(),this.setState({pending:!0});const{confirmPassword:t,email:a,password:n}=this.state;n===t?ot.a.signUpWithEmailPassword(a,n).then(e=>{Vr(`New user sign up - ${e.user.email}`),this._mounted&&this.setState({email:"",password:"",pending:!1})}).catch(e=>{this.setState({error:e,pending:!1})}):this.setState({error:Zr["sr/password-mismatch"]})}),Hr(this,"switchForm",()=>{this.setState({authForm:"signin"===this.state.authForm?"signup":"signin",error:null}),this.focusInput()}),Hr(this,"onChangeEmail",e=>{this.setState({email:e.target.value,error:null})}),Hr(this,"onChangePassword",e=>{this.setState({password:e.target.value,error:null})}),Hr(this,"onChangeConfirmPassword",e=>{this.setState({confirmPassword:e.target.value,error:null})}),Hr(this,"sendResetPassword",e=>{e.preventDefault(),this.state.email.length&&ot.a.sendResetPasswordEmail(this.state.email).then(()=>{this.setState({resetEmailSent:!0})})}),Hr(this,"switchPasswordForgotten",()=>{this.setState({renderPasswordForgotten:!this.state.renderPasswordForgotten,resetEmailSent:!1})})}focusInput(){this.emailInputRef.current.focus()}renderPasswordForgotten(){return i.a.createElement(Kr,{onSubmit:this.sendResetPassword},this.state.resetEmailSent?i.a.createElement(Wr,null,"An email has been sent to reset your password."):null,this.renderEmailInput(),i.a.createElement(qr,null,"Send email to reset your password"),i.a.createElement(Yr,{onClick:this.switchPasswordForgotten},"Return to login"))}renderEmailInput(){return i.a.createElement(Wr,null,i.a.createElement(zr,{type:"email",placeholder:"Email",onChange:this.onChangeEmail,value:this.state.email,ref:this.emailInputRef}))}componentDidMount(){this.focusInput()}componentWillUnmount(){this._mounted=!1}render(){const{authForm:e,error:t,pending:a,renderPasswordForgotten:n}=this.state;return n?this.renderPasswordForgotten():i.a.createElement(Kr,{onSubmit:"signin"===e?this.signIn:this.signUp},this.renderEmailInput(),i.a.createElement(Wr,null,i.a.createElement(zr,{type:"password",placeholder:"Password",onChange:this.onChangePassword,value:this.state.password})),"signup"===e?i.a.createElement(Wr,null,i.a.createElement(zr,{type:"password",placeholder:"Confirm Password",onChange:this.onChangeConfirmPassword,value:this.state.confirmPassword})):null,i.a.createElement(qr,{pending:a},"Sign ","signin"===e?"in":"up"),t?i.a.createElement(Jr,null,t):null,i.a.createElement(Yr,{onClick:this.switchForm},"signin"===e?"Create an account":"I already have an account"),i.a.createElement(Xr,{onClick:this.switchPasswordForgotten},"Forgot your password?"))}};function eo(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const to=a(99),ao=a(13),no=o.default.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
    height: 100%;
`;var io,so,ro,oo=class extends i.a.Component{constructor(...e){super(...e),eo(this,"state",{animationDone:!1}),eo(this,"onAnimationDone",()=>{this.setState({animationDone:!0}),this.props.onAnimationDone()})}componentDidMount(){const e=Math.round(performance.now());ao.trackTiming("app","app-ready",e)}render(){const{authLoading:e,isAuthenticated:t}=this.props,{animationDone:a}=this.state,n=!e&&!t,s=[{component:i.a.createElement(le.Spring,{from:{angle:"-70deg",opacity:0},to:{angle:"0deg",opacity:1},config:le.config.slow},e=>i.a.createElement(to,{opacity:e.opacity,angle:e.angle})),key:"logo"},{component:i.a.createElement(le.Spring,{from:{opacity:0},to:{opacity:n?1:0},config:le.config.slow},e=>i.a.createElement("div",{style:{opacity:e.opacity}},i.a.createElement(Qr,null))),key:"authform"}];return i.a.createElement(no,null,i.a.createElement(le.Trail,{items:s,keys:e=>e.key,from:{transform:"translate3d(0, 40px, 0)"},to:{transform:"translate3d(0, 0, 0)"},config:le.config.slow,onRest:this.onAnimationDone},e=>t=>i.a.createElement("div",{style:t},e.component)))}};function lo(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const co=a(0),po=a(4).default,uo=a(12),{connect:ho}=a(7),{removeTag:mo}=a(19),go=a(3),fo=po.div`
    position: absolute;
    padding: 5px 0;
    top: ${e=>e.top-10}px;
    left: ${e=>e.left-10}px;
...
`,Eo=po.div`
    ...
    :hover {
        background: ${go.colors.blueLight};
        color: ${go.colors._white};
    }
`;var vo,bo=ho()((ro=so=class extends co.Component{constructor(...e){super(...e),lo(this,"rootRef",co.createRef()),lo(this,"onDocumentClick",e=>{this.rootRef.current.contains(e.target)||this.props.close()}),lo(this,"removeTag",()=>{this.props.dispatch(mo(this.props.props.fileHashPath,this.props.props.tag)),this.props.close()}),lo(this,"searchTag",()=>{this.props.dispatch(_(this.props.props.tag)),this.props.close()})}componentDidMount(){document.addEventListener("click",this.onDocumentClick,{passive:!0})}componentWillUnmount(){document.removeEventListener("click",this.onDocumentClick)}render(){const{positionX:e,positionY:t}=this.props;return co.createElement(fo,{top:t,left:e,ref:this.rootRef},co.createElement(Eo,{onClick:this.removeTag},"Remove Tag"),co.createElement(Eo,{onClick:this.searchTag},"Search all files with this tag"))}},lo(so,"propTypes",{close:uo.func,dispatch:uo.func,positionX:uo.number,positionY:uo.number,props:uo.object}),io=ro))||io,yo=a(58);function To(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const So=a(66),{closeModalEsc:_o}=a(24),{checkUpdate:xo,closeContextMenu:Co,resize:wo}=a(44),{togglePlay:Ao}=a(56),{recorderFileAlreadyExists:Ro,recorderSaveSuccess:Fo}=a(124),{transferSaveSuccess:ko}=a(147),{setMXML:Do}=a(218),{getFilesDurationAndBPM:Po,importFiles:Lo}=a(57),Oo=a(13),Io=a(31),{isAuthenticated:Mo,isUserFullyLoaded:No,selectUser:Uo}=a(30),{checkFilesDBExists:$o,getAppConfig:jo,onMissingFiles:Ho,setCallback:Bo}=a(21),zo=a(3),Vo=(o.default.div`
    height: 100%;
    min-height: 100%;
    display: flex;
    flex-direction: column;
...
`,Ko=o.default.div`
    ...
    height: 100%;
    pointer-events: none;
    color: ${zo.colors.blueLight};
    border: 20px dashed ${zo.colors.blueLight};
    font-size: 200px;
    justify-content: center;
    align-items: center;
    z-index: 100;
...
`,Xo=o.default.div`
    ...
    display: flex;
    align-items: center;
`,qo=i.a.lazy(()=>a.e(2).then(a.bind(null,231))),Jo=()=>i.a.createElement(i.a.Suspense,{fallback:null},i.a.createElement(qo,null)),Zo=i.a.lazy(()=>a.e(1).then(a.bind(null,232))),Qo=()=>i.a.createElement(i.a.Suspense,{fallback:null},i.a.createElement(Zo,null)),el=i.a.lazy(()=>a.e(0).then(a.bind(null,233))),tl=()=>i.a.createElement(i.a.Suspense,{fallback:null},i.a.createElement(el,null));var al=Object(s.connect)(e=>({advancedSearchVisible:Object(b.a)(e).displayAdvanced,allowFileDragging:e.application.allowFileDragging,appReady:No(e),appWidth:e.application.appWidth,authLoading:e.auth.authLoading,contextMenu:e.application.contextMenu,isAuthenticated:Mo(e),modalOpen:!!e.modal.name,user:Uo(e)}))(vo=class extends i.a.Component{constructor(...e){super(...e),To(this,"dragDropActivated",!1),To(this,"updateTimeout",void 0),To(this,"fullUserListener",void 0),To(this,"removeDragDrop",void 0),To(this,"state",{dragging:!1,hasError:!1,splashAnimationDone:!1}),To(this,"onSplashAnimationDone",()=>{this.setState({splashAnimationDone:!0})}),To(this,"importFiles",e=>{Lo(this.props.dispatch,e,e=>{for(let t in e)e[t].newImport=!0;this.props.dispatch(Object(Wa.addFiles)(e,!0))})}),To(this,"getDataFromMain",(e,t)=>{switch(e){case zo.mainConsts.events.CHECK_FILES_DB:t.exists&&this.props.dispatch({type:zo.actionTypes.SET_MIGRATION_DATA,data:t.data,_winBackup:t._winBackup});break;case zo.mainConsts.events.DATA_FETCHED:if(t.db===zo.db.files){this.props.dispatch(Object(Wa.addFiles)(t.data));const e=[];return Object.values(t.data).forEach(t=>{t.bpm&&t.duration||e.push(t)}),void(e.length&&Po(this.props.dispatch,e))}t.db===zo.db.app&&t.data.displayAdvanced&&this.props.dispatch(S());break;case zo.mainConsts.events.FILE_ALREADY_EXISTS:this.props.dispatch(Ro(t));break;case zo.mainConsts.events.FILE_SYSTEM_ERROR:console.log(t);break;case zo.mainConsts.events.FILE_SAVE_SUCCESS:t.saveType===zo.saveTypes.RECORDER?this.props.dispatch(Fo(t.filePath)):t.saveType===zo.saveTypes.TRANSFER&&this.props.dispatch(ko(t.fileName,t.filePath));break;case zo.mainConsts.events.GET_MXLM_SUCCESS:this.props.dispatch(Do(t.filePath,t.mxml));break;case zo.mainConsts.events.OPEN_DEEPLINK:this.handleDeeplink(t.url)}}),To(this,"handleDeeplink",e=>{try{const t=e.replace("songriffer://songriffer.com?deeplink=",""),a=JSON.parse(decodeURIComponent(t));a.type,Io(`Unsupported deeplink type ${a.type} - raw deeplink: ${t}`)}catch(t){const a=`Could not parse deeplink args: ${e}`;console.error(a),Oo.exception(a),Io(`*Error* ${a}`)}}),To(this,"onMissingFiles",e=>{this.props.dispatch(Object(Wa.setMissingFiles)(e.files))}),To(this,"onKeyDown",e=>{if("Escape"===e.key&&this.props.dispatch(_o()),32===e.keyCode&&e.target===document.body&&(this.props.dispatch(Ao()),e.preventDefault()),!this.props.modalOpen&&e.target&&"INPUT"!==e.target.tagName&&/^[a-zA-Z]{1}$/.test(e.key)){let e=null;e=this.props.advancedSearchVisible?"#advanced-search-input":"#basic-search-input";const t=document.querySelector(e);t&&t.focus()}}),To(this,"onResize",()=>{window.innerWidth!==this.props.appWidth&&this.props.dispatch(wo(window.innerWidth))}),To(this,"setFullUser",e=>{this.props.dispatch(Object(yo.setFullUserData)(e))}),To(this,"onAuthChange",e=>{e?(this.props.dispatch(Object(yo.signIn)(e)),ot.a.getFullUser(e.uid).then(this.setFullUser)):this.props.dispatch(Object(yo.notLogged)())}),To(this,"closeContextMenu",()=>{this.props.dispatch(Co())}),To(this,"catchError",e=>{this.setState({hasError:!0});try{const t=`${e.message} \n \`\`\`${e.error.stack}\`\`\``;Oo.exception(e.message),Io(`*Error* ${t}`)}catch(e){Io("*Error* unavailable message"),Oo.exception("Error - unavailable message")}})}detectDragDrop(){this.dragDropActivated=!0,this.removeDragDrop=So(document.body,{onDrop:this.importFiles,onDragOver:()=>{this.setState({dragging:!0})},onDragLeave:()=>{this.setState({dragging:!1})}})}listenForFullUserUpdate(){ot.a.listenForFullUserUpdate(this.props.user.uid,this.setFullUser).then(e=>{this.fullUserListener=e})}removeFullUserListener(){"function"==typeof this.fullUserListener&&this.fullUserListener()}checkUpdate(){clearTimeout(this.updateTimeout),this.props.dispatch(xo(!1)),this.updateTimeout=setTimeout(()=>{this.checkUpdate()},zo.updateInterval)}componentDidCatch(e,t){this.setState({hasError:!0});try{const a=`${e.message} \n \`\`\`${t.componentStack}\`\`\``;Io(`*Error* ${a}`)}catch(e){Io("*Did catch error* could not stringify error")}}componentDidMount(){$o(),window.addEventListener("error",this.catchError,{passive:!0}),this.detectDragDrop(),Ho(this.onMissingFiles),Bo(this.getDataFromMain),ot.a.onAuthChange(this.onAuthChange),Oo.trackEvent("app","app-start",window.__songRiffer.platform),Oo.trackEvent("app",`platform-${window.__songRiffer.platform}`,window.__songRiffer.release),Oo.trackEvent("app","appVersion","1.11.0"),document.addEventListener("keydown",this.onKeyDown),window.addEventListener("resize",this.onResize,{passive:!0}),this.onResize(),this.updateTimeout=setTimeout(()=>{this.checkUpdate()},3e3)}componentDidUpdate(e){!this.props.modalOpen&&this.props.allowFileDragging||!this.dragDropActivated||(this.removeDragDrop(),this.dragDropActivated=!1),this.props.modalOpen||!this.props.allowFileDragging||this.dragDropActivated||this.detectDragDrop(),!e.appReady&&this.props.appReady&&jo(),!e.isAuthenticated&&this.props.isAuthenticated?this.listenForFullUserUpdate():e.isAuthenticated&&!this.props.isAuthenticated&&this.removeFullUserListener()}componentWillUnmount(){clearTimeout(this.updateTimeout),this.removeFullUserListener()}render(){const{appReady:e,authLoading:t,contextMenu:a,isAuthenticated:n}=this.props,{dragging:s,hasError:r,splashAnimationDone:o}=this.state;return e&&o?r?i.a.createElement(oe,null):i.a.createElement(l.a,null,i.a.createElement(Yo,null,i.a.createElement(X,null),i.a.createElement(ua,null),i.a.createElement(Vo,null,i.a.createElement(Xo,null,i.a.createElement(ma,{style:"margin-left: 3px;"})),i.a.createElement(l.d,null,i.a.createElement(l.b,{exact:!0,path:zo.routes.home,component:Dr}))),i.a.createElement(Go,null,i.a.createElement(jr,null),i.a.createElement(Ko,{dragging:s},"+"),i.a.createElement(Wo,{dragging:s},i.a.createElement(l.d,null,i.a.createElement(l.b,{path:zo.routes.project,component:Xi}),i.a.createElement(l.b,{path:zo.routes.projects,component:tl}),i.a.createElement(l.b,{path:zo.routes.recorder,component:Os}),i.a.createElement(l.b,{path:zo.routes.account,component:tr}),i.a.createElement(l.b,{path:zo.routes.stats,component:Qo}),i.a.createElement(l.b,{path:zo.routes.transfer,component:Jo}),i.a.createElement(l.b,{exact:!0,path:zo.routes.home,component:pa}))),i.a.createElement(K,null),i.a.createElement(Ci,null),i.a.createElement(Fi,null),i.a.createElement(Tr,null)),a.active?i.a.createElement(bo,{close:this.closeContextMenu,positionX:a.positionX,positionY:a.positionY,props:a.props}):null)):i.a.createElement(oo,{authLoading:t,isAuthenticated:n,onAnimationDone:this.onSplashAnimationDone})}})||vo;const nl={allowFileDragging:!1,appWidth:0,contextMenu:{},dbLoaded:!1,enableExperimental:!1,updateAvailable:!1},il={authLoading:!0,data:{createdAt:null,cloudLevel:0,updatedAt:null},user:null},sl=e=>({email:e.email,emailVerified:e.emailVerified,uid:e.uid}),rl={_dataToMigrate:null,_winBackup:!1,files:{},missingFiles:[],pending:!0,sortRule:null,selectedFile:null},ol=(e,t)=>{const a={...e};for(let e in t)a[e]?a[e]={...a[e],added:t[e].added,size:t[e].size}:a[e]=t[e];return a},ll=(e,t,a)=>{const n={...e};return delete n[t],n[Object(fe.getFilePathHash)(a.path)]=a,n},cl=(e,t,a)=>{if(!e[t])return e;const n=e[t];return Object.keys(n.tags).map(e=>e.toLowerCase()).includes(a.toLowerCase())?e:{...e,[t]:{...n,tags:{...e[t].tags,[a]:!0}}}},pl={name:null,props:null},dl={filePath:null,mxml:null},{displayUpdateAvailableModal:ul}=a(44),{openModal:hl}=a(24),ml={notification:{active:!1}};let gl=0;const fl=()=>gl++,El={fileHashPath:void 0,playing:!1},vl={fileAlreadyExists:"",filePath:null,saveSuccess:!1},bl={advancedTransitionDone:!0,archived:y.searchArchived.NON_ARCHIVED,basicTerm:"",bpm:"",bpmDelta:10,displayAdvanced:!1,tags:{},term:""},{combineReducers:yl}=a(65),Tl=yl({application:(e=nl,t)=>{switch(t.type){case y.actionTypes.ADD_FILES:return{...e,dbLoaded:!0};case y.actionTypes.UPDATE_AVAILABLE:return{...e,updateAvailable:!0};case y.actionTypes.APP_RESIZE:return{...e,appWidth:t.width};case y.actionTypes.DISPLAY_TAG_CONTEXT_MENU:return{...e,contextMenu:{active:!0,positionX:t.positionX,positionY:t.positionY,props:t.props}};case y.actionTypes.CLOSE_CONTEXT_MENU:return{...e,contextMenu:nl.contextMenu};case y.actionTypes.SEARCH_BASIC:return t.term.toLowerCase()===y.DEBUG_KEY_SEQUENCE?{...e,enableExperimental:!0}:e;case y.actionTypes.SET_ALLOW_FILE_DRAGGING:return{...e,allowFileDragging:t.allowFileDragging};default:return e}},auth:(e=il,t)=>{switch(t.type){case y.actionTypes.AUTH_SET_USER:return{...e,authLoading:!1,user:sl(t.user)};case y.actionTypes.AUTH_SIGN_OUT:return il;case y.actionTypes.AUTH_SET_FULL_USER_DATA:return{...e,data:t.data};case y.actionTypes.AUTH_NOT_LOGGED:return{...e,authLoading:!1};default:return e}},files:(e=rl,t)=>{switch(t.type){case y.actionTypes.SET_FILES:return{...e,files:t.files,pending:!1};case y.actionTypes.SET_MIGRATION_DATA:return{...e,_dataToMigrate:t.data,_winBackup:t._winBackup};case y.actionTypes.ADD_TAG:return{...e,files:cl(e.files,t.hashPath,t.tag)};case y.actionTypes.REMOVE_TAG:const a=e.files[t.hashPath],n={...a.tags};return delete n[t.tag],{...e,files:{...e.files,[t.hashPath]:{...a,tags:n}}};case y.actionTypes.EDIT_FILE:let i;return i=!t.automaticEdit&&t.edit.bpm||t.automaticEdit&&t.edit.bpm&&!e.files[t.hashPath].bpm?t.edit.bpm:e.files[t.hashPath].bpm,{...e,files:{...e.files,[t.hashPath]:{...e.files[t.hashPath],...t.edit,bpm:i}}};case y.actionTypes.ADD_FILES:return{...e,_dataToMigrate:null,files:ol(e.files,t.files),pending:!1};case y.actionTypes.REMOVE_FILE:const s={...e.files};return delete s[t.hashPath],{...e,files:s,selectedFile:e.selectedFile===t.hashPath?null:e.selectedFile};case y.actionTypes.PLAY_FILE:return{...e,selectedFile:t.hashPath};case y.actionTypes.REPLACE_FILE:return{...e,files:ll(e.files,t.oldFileHashPath,t.newFile)};case y.actionTypes.SET_MISSING_FILES:return{...e,missingFiles:t.filesHashPath};case y.actionTypes.SET_SORT_RULE:return{...e,sortRule:t.sortRule};case y.actionTypes.PAUSE_PLAYER:return t.unsetSelectedFile?{...e,selectedFile:null}:e;case y.actionTypes.DISABLE_NEW_IMPORTS:const r={...e.files};for(const e of t.files)r[e]={...r[e],newImport:!1};return{...e,files:r};case y.actionTypes.AUTH_SIGN_OUT:return rl;default:return e}},modal:(e=pl,t)=>{switch(t.type){case y.actionTypes.OPEN_MODAL:return{name:t.name,props:t.props};case y.actionTypes.CLOSE_MODAL:return pl;default:return e}},mxml:(e=dl,t)=>{switch(t.type){case y.actionTypes.SET_MXML:return{...e,filePath:t.filePath,mxml:t.mxml};default:return e}},notifications:(e=ml,t)=>{switch(t.type){case y.actionTypes.ADD_NOTIFICATION:return{notification:{...t.notification,active:!0,id:fl()}};case y.actionTypes.REMOVE_NOTIFICATION:return{notification:{...e.notification,active:!1}};case y.actionTypes.ADD_FILES:if(!t.newImports)return e;const a=Object.values(t.files).filter(e=>e.source!==vn.b.RECORD&&e.source!==vn.b.TRANSFER).length;return a?{notification:{title:`Imported ${a} file${a>1?"s":""}`,status:"success",active:!0,id:fl()}}:e;case y.actionTypes.REMOVE_FILE:return{notification:{title:"File removed",status:"success",active:!0,id:fl()}};case y.actionTypes.REPLACE_FILE:return{notification:{title:"File successfully replaced",status:"success",active:!0,id:fl()}};case y.actionTypes.NOTIFY_MISSING_FILE:return{notification:{title:`We could not locate the file ${t.file.name}. Click here to fix this`,status:"error",active:!0,id:fl(),onClick:()=>hl(y.modals.fileMissing,{fileHashPath:t.file.hashPath}),timeout:5e3}};case y.actionTypes.UPDATE_AVAILABLE:return{notification:{title:"New version available!",status:"success",active:!0,id:fl(),onClick:()=>e=>{e(ul(t.url,t.changelog))},timeout:5e3}};case y.actionTypes.SEARCH_BASIC:return t.term.toLowerCase()===y.DEBUG_KEY_SEQUENCE?{notification:{title:"Experimental mode activated",status:"success",active:!0,id:fl()}}:e;default:return e}},player:(e=El,t)=>{switch(t.type){case y.actionTypes.PLAY_FILE:return{...e,fileHashPath:t.hashPath,playing:!0};case y.actionTypes.TOGGLE_PLAY:return{...e,playing:!e.playing};case y.actionTypes.PAUSE_PLAYER:return{...e,playing:!1};case y.actionTypes.REMOVE_FILE:return t.hashPath===e.fileHashPath?El:e;default:return e}},recorder:(e=vl,t)=>{switch(t.type){case y.actionTypes.RECORDER_FILE_ALREADY_EXISTS:return{...e,fileAlreadyExists:t.fileName};case y.actionTypes.RECORDER_SAVE_SUCCESS:return{...e,filePath:t.filePath,saveSuccess:!0};case y.actionTypes.RECORDER_RESET:return vl;default:return e}},search:(e=bl,t)=>{switch(t.type){case y.actionTypes.SEARCH_BASIC:return{...e,basicTerm:t.term};case y.actionTypes.SET_SEARCH:return{...e,term:t.term,basicTerm:""};case y.actionTypes.TOGGLE_ADVANCED_SEARCH:return{...bl,displayAdvanced:!e.displayAdvanced,advancedTransitionDone:!1};case y.actionTypes.ADVANCED_TRANSITION_DONE:return{...e,advancedTransitionDone:!0};case y.actionTypes.SEARCH_TAG:return{...e,advancedTransitionDone:!1,displayAdvanced:!0,basicTerm:"",tags:{...e.tags,[t.tag]:!0}};case y.actionTypes.REMOVE_SEARCH_TAG:const a={...e.tags};return delete a[t.tag],{...e,basicTerm:"",tags:a};case y.actionTypes.SEARCH_BPM:return{...e,basicTerm:"",bpm:isNaN(parseInt(t.bpm,10))?"":parseInt(t.bpm,10)};case y.actionTypes.SEARCH_BPM_DELTA:return{...e,bpmDelta:isNaN(parseInt(t.bpmDelta,10))?10:parseInt(t.bpmDelta,10)};case y.actionTypes.CLEAR_SEARCH:return{...bl,displayAdvanced:e.displayAdvanced};case y.actionTypes.SET_SEARCH_ARCHIVED:return{...e,archived:t.archived};default:return e}},transfer:a(220)}),Sl=a(3),{saveApp:_l}=a(21),{selectFilesForStorage:xl}=a(14),{selectUser:Cl}=a(30);var wl=e=>t=>a=>{if(t(a),a.__saveToDB__){const t=e.getState();switch(a.__db){case Sl.db.files:const e=!{[Sl.actionTypes.REMOVE_FILE]:!0,[Sl.actionTypes.REPLACE_FILE]:!0}[a.type],n=xl(t),i=Cl(t);ot.a.saveFullFilesData(i.uid,n,e);break;case Sl.db.app:_l({displayAdvanced:Object(b.a)(t).displayAdvanced});break;default:throw new Error("Error trying to save data, unknow db",a.__db)}}};const{createStore:Al,applyMiddleware:Rl}=a(65),Fl=Al(Tl,Rl(a(219).default,wl,a(221)));var kl=a(141),Dl=a(142),Pl=a(143),Ll=a(144);const Ol=(e,t)=>{const a=`@font-face {\n        src: url(${t});\n        font-family: ${e};\n    }`,n=document.createElement("style");n.type="text/css",n.appendChild(document.createTextNode(a)),document.head.appendChild(n)};Ol("FontAwesome",kl.a),Ol("Foundation",Dl.a),Ol("Ionicons",Pl.a),Ol("MaterialCommunityIcons",Ll.a),Object(r.render)(i.a.createElement(s.Provider,{store:Fl},i.a.createElement(al,null)),document.querySelector("#root"))}],[[224,3,5]]]);