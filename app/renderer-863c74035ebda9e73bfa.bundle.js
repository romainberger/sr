...
`,o=s.div`
    ...
    font-weight: bold;
    text-align: center;
`,l=n.memo(({message:e,title:t})=>n.createElement(r,null,n.createElement(o,null,t),n.createElement("div",null,e)));l.propTypes={message:i.node,title:i.string},e.exports=l},function(e,t,a){function n(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const i=a(0),s=a(9),r=a(4).default,o=a(54),l=a(36),c=a(12),p=a(30),{openLink:d}=a(20),u=a(3),h=r.div`
    max-width: 700px;
`,m=r.div`
    padding: 45px;
...
`;var W=k(e=>({allTags:I(e),search:Object(v.a)(e),visible:Object(v.a)(e).displayAdvanced}))((C=w=class extends R.Component{constructor(...e){super(...e),A(this,"state",{autocompleteTag:null,newTag:""}),A(this,"rootRef",R.createRef()),A(this,"nameInputRef",R.createRef()),A(this,"searchName",e=>{this.props.dispatch((e=>(y.start("search"),{type:b.actionTypes.SET_SEARCH,term:e}))(e.target.value))}),A(this,"onBPMChange",e=>{this.props.dispatch((e=>(y.start("search"),{type:b.actionTypes.SEARCH_BPM,bpm:e}))(e.target.value))}),A(this,"onBPMDeltaChange",e=>{this.props.dispatch((e=>(y.start("search"),{type:b.actionTypes.SEARCH_BPM_DELTA,bpmDelta:e}))(e.target.value))}),A(this,"onTagChange",e=>{const t=Object.keys(this.props.search.tags);this.setState({autocompleteTag:Object(l.getTagAutocomplete)(this.props.allTags,e.target.value,t),newTag:e.target.value})}),A(this,"onTagKeyDown",e=>{if("Tab"===e.key&&this.state.autocompleteTag)return this.props.dispatch(S(this.state.autocompleteTag)),e.preventDefault(),void this.quitTagEdit();"Enter"===e.key&&this.state.newTag.length&&(this.props.dispatch(S(this.state.newTag)),this.quitTagEdit())}),A(this,"clearSearch",()=>{this.props.dispatch((()=>({type:b.actionTypes.CLEAR_SEARCH}))())}),A(this,"removeTag",e=>{this.props.dispatch((e=>(y.start("search"),{type:b.actionTypes.REMOVE_SEARCH_TAG,tag:e}))(e))}),A(this,"onTransitionEnd",()=>{this.props.dispatch((()=>({type:b.actionTypes.ADVANCED_TRANSITION_DONE}))())}),A(this,"onSwitchArchived",e=>{e.target.checked?this.props.dispatch(_(M.searchArchived.ALL)):this.props.dispatch(_(M.searchArchived.NON_ARCHIVED))})}quitTagEdit(){this.setState({autocompleteTag:null,newTag:""})}shouldComponentUpdate(e){return this.props.visible||e.visible}componentDidMount(){this.rootRef.current.addEventListener("transitionend",this.onTransitionEnd,{passive:!0})}componentWillUnmout(){this.rootRef.current.removeEventListener("transitionend",this.onTransitionEnd)}render(){const{search:e,visible:t}=this.props,{autocompleteTag:a,newTag:n}=this.state,i=e.term.length||e.bpm||Object.keys(e.tags).length,s=t?void 0:-1;return R.createElement(N,{visible:t,ref:this.rootRef},R.createElement(U,null,R.createElement($,null,R.createElement(j,null,"Name"),R.createElement(L,{isFullWidth:!0,type:"text",onChange:this.searchName,value:e.term,tabIndex:s,id:"advanced-search-input",ref:this.nameInputRef})),R.createElement($,null,R.createElement(j,null,"Tags"),R.createElement(P,{isFullWidth:!0,autocomplete:a,autocompleteStyle:"\n    top: 3px;\n    left: 2px;\n",onChange:this.onTagChange,onKeyDown:this.onTagKeyDown,value:n,tabIndex:s}),Object.keys(e.tags).length?R.createElement(z,null,Object.keys(e.tags).map(e=>R.createElement(E,{key:e,onDelete:()=>this.removeTag(e),deleteTitle:"Remove this tag from the search",additionalStyle:"\n    margin-bottom: 5px;\n"},e))):null),R.createElement($,null,R.createElement(j,null,"Tempo"),R.createElement(G,null,R.createElement(V,{type:"number",onChange:this.onBPMChange,value:e.bpm,min:1,tabIndex:s}),R.createElement("span",null,"bpm + / - "),R.createElement(V,{type:"number",onChange:this.onBPMDeltaChange,value:e.bpmDelta,title:e.bpm?`Results will include riffs that have a tempo between ${e.bpm-10} and ${e.bpm+10}`:null,min:0,tabIndex:s}))),R.createElement(H,null,R.createElement(B,null,"Show archived files"),R.createElement(O,{onChange:this.onSwitchArchived,checked:e.archived===M.searchArchived.ALL})),i?R.createElement(D,{onClick:this.clearSearch,tabIndex:s},"Clear search"):null))}},A(w,"propTypes",{allTags:F.any,dispatch:F.func,search:F.object,visible:F.bool}),x=C))||x;const K=r.default.div`
    ...
    top: 0;
    left: 0;
`;var Y=Object(s.connect)(e=>({notification:e.notifications.notification}))(({notification:e})=>i.a.createElement(K,{hasNotification:e.active}));const X=a(51),q=a(54),J=a(36),{openLink:Z,reload:Q}=a(20),ee=a(30),te=r.default.div`
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
`;var Te,Se,_e,xe=({onClick:e,title:t})=>i.a.createElement(ye,{title:t,onClick:e},"•••");function we(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const Ce=a(0),{connect:Ae}=a(8),Re=a(9),ke=a(79),{selectTags:Fe}=a(14);var De,Le,Pe,Oe=Ae(e=>({allTags:Fe(e)}))((_e=Se=class extends Ce.Component{constructor(...e){super(...e),we(this,"state",{autocompleteTag:null,newTag:""}),we(this,"onTagKeyDown",e=>{"Enter"===e.key&&this.state.newTag.length&&(this.resetTagWrite(),this.props.addTag(this.state.newTag)),"Tab"===e.key&&(this.state.autocompleteTag&&(this.resetTagWrite(),this.props.addTag(this.state.autocompleteTag)),e.preventDefault()),"Escape"===e.key&&(this.props.quitTagEdit(),e.preventDefault())}),we(this,"resetTagWrite",()=>{this.setState({autocompleteTag:null,newTag:""},this.calculateVisibleTags)}),we(this,"writeTag",e=>{this.setState({autocompleteTag:Object(l.getTagAutocomplete)(this.props.allTags,e.target.value,this.props.blacklist),newTag:e.target.value})})}render(){const{autocompleteTag:e,newTag:t}=this.state,{inputWidth:a,quitTagEdit:n}=this.props;return Ce.createElement(ke,{autocomplete:e,autoFocus:!0,onBlur:n,onChange:this.writeTag,onKeyDown:this.onTagKeyDown,value:t,style:{width:a,height:22}})}},we(Se,"propTypes",{addTag:Re.func,allTags:Re.any,blacklist:Re.array,quitTagEdit:Re.func}),Te=_e))||Te;function Ie(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const Me=a(0),Ne=a(4).default,Ue=a(9),{connect:$e}=a(8),je=a(111),{colors:He}=a(3),Be=Ne.div`
    position: relative;
    display: flex;
    align-items: center;
    overflow-x: hidden;
...
`,Et=r.default.div`
    ...
    z-index: 2;
    font-size: 25px;
`;class vt extends n.Component{render(){const e=dt.a.map(e=>new ut.a(e));return n.createElement(gt,null,n.createElement(ft,null,n.createElement(ht,{items:e,keys:e=>e.path,from:{transform:"translate3d(0, 40px, 0)",opacity:0},to:{transform:"translate3d(0, 0, 0)",opacity:1}},(t,a)=>i=>{const s=Math.max(Math.min(1-a/e.length,i.opacity),0);return n.createElement("div",{key:`fake-${t.path}`,style:{...i,opacity:s}},n.createElement(ct,{file:t}))})),n.createElement(Et,null,"Drag and drop files to start building your library"))}}var bt,yt,Tt,St=a(72),_t=a(14);function xt(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const wt=a(0),{connect:Ct}=a(8),At=a(9),Rt=a(4).default,kt=a(156),Ft=a(59),{selectUser:Dt}=a(29),{addFiles:Lt,disableNewImports:Pt,migrateLegacyData:Ot,setSortRule:It,setFiles:Mt}=a(21),{setAllowFileDragging:Nt}=a(46),Ut=a(112),$t=a(12),{checkFiles:jt}=a(20),{colors:Ht,sortRules:Bt}=a(3),zt=Rt.div`
    margin-top: 50px;
    color: #555;
`,Gt=Rt.div`
    position: sticky;
...
`,Pi=r.default.div`
    flex: 1;
    padding: 7px;
`;var Oi=({song:e})=>n.createElement(Li,null,e.position," • ",n.createElement(Pi,null,e.name));const Ii=r.default.div`
    display: grid;
...
`,Ls=r.default.div`
    width: ${e=>e.width}%;
    height: 10px;
`,Ps=({percentage:e})=>i.a.createElement(Ds,null,i.a.createElement(Ls,{width:e,style:{background:e>=90?b.colors.redLight:b.colors.bluePastel}}));function Os(e,t,a){return t in e?Object.defineProperty(e,t,{value:a,enumerable:!0,configurable:!0,writable:!0}):e[t]=a,e}const Is=a(61),Ms=a(59),Ns=a(36),{checkUpdate:Us}=a(46),{openModal:$s}=a(27),{signOut:js}=a(58),{selectUser:Hs}=a(29),Bs=a(12),{formatFileSize:zs}=a(77),{openLink:Gs,toggleDevTools:Vs}=a(20),Ws=a(3),Ks="\n    display: flex;\n    height: 100%;\n    justify-content: space-between;\n    align-items: center;\n",Ys=r.default.div`
    width: 50%;
    padding: 0 40px;
`,Xs=r.default.div`
    margin-bottom: 25px;
