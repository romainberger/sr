(window.webpackJsonp=window.webpackJsonp||[]).push([[2],{233:function(e,t,r){"use strict";r.r(t),function(e){r.d(t,"default",function(){return P});r(29);var n,s,i,o=r(13);function a(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}r(33);const l=r(0),c=r(2).default,d=r(5),{connect:p}=r(7),f=r(66),h=r(43),u=r(31),m=r(87),{selectUser:g}=r(24),{copyToClipboard:y,saveMedia:b}=r(15),{addFiles:v}=r(12),{reset:E,setFileList:k,startTansfer:x}=r(89),w=r(9),S=r(1),R=c.div`
    display: flex;
    flex: 1;
