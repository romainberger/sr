...
`;var Za=({align:e="center",children:t,direction:a="row",justify:n="space-between"})=>i.a.createElement(Ja,{align:e,direction:a,justify:n},t);const Qa=s.default.div`
    padding: 0 10px 20px;
    margin-bottom: 20px;
    font-size: 13px;
    border-bottom: 1px solid ${c.colors._grey};
