(window.webpackJsonp=window.webpackJsonp||[]).push([[2],{223:function(e,t,r){"use strict";r.r(t),function(e){r.d(t,"default",function(){return P});r(39);var n,s,i,o=r(17);function a(e,t,r){return t in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}r(52);const l=r(0),c=r(4).default,d=r(9),{connect:p}=r(8),f=r(109),h=r(59),u=r(36),m=r(137),{selectUser:g}=r(29),{copyToClipboard:y,saveMedia:b}=r(20),{addFiles:v}=r(21),{reset:E,setFileList:k,startTansfer:x}=r(139),w=r(12),S=r(3),R=c.div`
    display: flex;
    flex: 1;
